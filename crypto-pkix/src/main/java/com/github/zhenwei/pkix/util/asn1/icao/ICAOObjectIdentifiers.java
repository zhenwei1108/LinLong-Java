...
public interface ICAOObjectIdentifiers {
  ...
  /**
   * LDS security object, see ICAO Doc 9303-Volume 2-Section IV-A3.2<p> 2.23.136.1.1.1
   */
  static final ASN1ObjectIdentifier id_icao_ldsSecurityObject = id_icao_mrtd_security.branch("1");

  /**
   * CSCA master list, see TR CSCA Countersigning and Master List issuance<p> 2.23.136.1.1.2
   */
  static final ASN1ObjectIdentifier id_icao_cscaMasterList = id_icao_mrtd_security.branch("2");
  /**
   * 2.23.136.1.1.3
   */
  static final ASN1ObjectIdentifier id_icao_cscaMasterListSigningKey = id_icao_mrtd_security.branch(
      "3");

  /**
   * document type list, see draft TR LDS and PKI Maintenance, par. 3.2.1 <p> 2.23.136.1.1.4
   */
   ...
   * 2.23.136.1.1.6.1
   */
  static final ASN1ObjectIdentifier id_icao_extensions_namechangekeyrollover = id_icao_extensions.branch(
      "1");
}