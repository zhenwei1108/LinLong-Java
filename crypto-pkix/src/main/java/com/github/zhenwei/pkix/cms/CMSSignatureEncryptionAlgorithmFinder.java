...
/**
 * Finder which is used to look up the algorithm identifiers representing the encryption algorithms
 * that are associated with a particular signature algorithm.
 */
public interface CMSSignatureEncryptionAlgorithmFinder {
   ...
   * @return the algorithm identifier to be associated with the encryption algorithm used in
   * signature creation.
   */
