...
public class CMSEnvelopedDataStreamGenerator
  ...
  private ASN1Integer getVersion(ASN1EncodableVector recipientInfos) {
    if (unprotectedAttributeGenerator != null) {
      ...
      return new ASN1Integer(
          EnvelopedData.calculateVersion(originatorInfo, new DLSet(recipientInfos), new DLSet()));
    }
    return new ASN1Integer(
        EnvelopedData.calculateVersion(originatorInfo, new DLSet(recipientInfos), null));
  }
  ...
  /**
   * generate an enveloped object that contains an CMS Enveloped Data object using the given
   * encryptor and marking the data as being of the passed in type.
   */
  public OutputStream open(
      ASN1ObjectIdentifier dataType,
      OutputStream out,
  ...
  private class CmsEnvelopedDataOutputStream
    ...
    public void close()
      ...
      if (unprotectedAttributeGenerator != null) {
        AttributeTable attrTable = unprotectedAttributeGenerator.getAttributes(
