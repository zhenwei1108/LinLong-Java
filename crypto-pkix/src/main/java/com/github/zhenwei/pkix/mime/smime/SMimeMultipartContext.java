...
import com.github.zhenwei.pkix.mime.CanonicalOutputStream;
import com.github.zhenwei.pkix.mime.Headers;
import com.github.zhenwei.pkix.mime.MimeContext;
import com.github.zhenwei.pkix.mime.MimeMultipartContext;
      ...
      public InputStream applyContext(Headers headers, InputStream contentStream)
        ...
        if (partNo == 0) {
          ...
          return new TeeInputStream(contentStream,
              new CanonicalOutputStream(parserContext, headers, digestOut));
        }
