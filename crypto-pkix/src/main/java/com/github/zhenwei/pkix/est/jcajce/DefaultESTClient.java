...
import com.github.zhenwei.pkix.est.ESTClientSourceProvider;
import com.github.zhenwei.pkix.est.ESTException;
import com.github.zhenwei.pkix.est.ESTRequest;
import com.github.zhenwei.pkix.est.ESTRequestBuilder;
import com.github.zhenwei.pkix.est.ESTResponse;
import com.github.zhenwei.pkix.est.Source;
...
class DefaultESTClient
        ...
        case 307:
          ...
          if ("".equals(loc)) {
            throw new ESTException(
                "Redirect status type: " + response.getStatusCode() + " but no location header");
          }
          ...
          if (loc.startsWith("http")) {
            ...
            redirectingRequest = requestBuilder.withURL(
                new URL(u.getProtocol(), u.getHost(), u.getPort(), loc)).build();
          }
          break;
        default:
          throw new ESTException(
              "Client does not handle http status code: " + response.getStatusCode());
      }
    }
  ...
  public ESTResponse performRequest(ESTRequest c)
    ...
    try {
      ...
      String req =
          c.getURL().getPath() + ((c.getURL().getQuery() != null) ? c.getURL().getQuery() : "");
