...
public class CertificateHolderAuthorization
  ...
  public static final ASN1ObjectIdentifier id_role_EAC = EACObjectIdentifiers.bsi_de.branch(
      "3.1.2.1");
   ...
   *
   * @param oid    Object Identifier : specifies the format and the rules for the evaluatioin of the
   *               authorization level.
  ...
  /**
   * create an Iso7816CertificateHolderAuthorization according to the {@link
