...
/**
 * Data piece of DVCRequest for CPD service (Certify Possession of Data). It contains CPD-specific
 * selector interface.
 * <p>
  ...
  private void initMessage()
    ...
    if (data.getMessage() == null) {
      throw new DVCSConstructionException(
          "DVCSRequest.data.message should be specified for CPD service");
    }
  }
