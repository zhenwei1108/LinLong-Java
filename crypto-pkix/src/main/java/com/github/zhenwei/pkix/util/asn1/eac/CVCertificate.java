...
public class CVCertificate
   ...
   * Iso7816CertificateBody.profileType or Iso7816CertificateBody.requestType. Any other value is
   * not valid.
   */
  ...
  /**
   * @return the bits corresponding the authorizations contained in the certificate See
   * Iso7816CertificateHolderAuthorization static int for values
   * @throws IOException
   */
