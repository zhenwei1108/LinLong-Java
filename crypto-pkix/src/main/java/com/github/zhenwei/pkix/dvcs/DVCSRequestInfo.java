...
/**
 * Information piece of DVCS requests. It is common for all types of DVCS requests.
 */
public class DVCSRequestInfo {
  ...
  /**
   * Get nonce if it is set. Note: this field can be set (if not present) or extended (if present)
   * by DVCS.
   *
  ...
  /**
   * Get data locations, where the copy of request Data can be obtained. Note: the exact meaning of
   * field is up to applications. Note: this field can be set by DVCS.
   *
  ...
  /**
   * Compares two DVCRequestInfo structures: one from DVCRequest, and one from DVCResponse. This
   * function implements RFC 3029, 9.1 checks of reqInfo.
   *
