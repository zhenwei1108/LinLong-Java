...
import com.github.zhenwei.core.asn1.x509.V1TBSCertificateGenerator;
...
public class X509v1CertificateBuilder {
   ...
   *                      certificate.
   */
  public X509v1CertificateBuilder(X500Name issuer, BigInteger serial, Date notBefore, Date notAfter,
  ...
  /**
   * Create a builder for a version 1 certificate. You may need to use this constructor if the
