...
/**
 * Channel Binding Provider provides a method of extracting the ChannelBinding that can be
 * customised specifically for the provider. Presently JSSE does not support RFC 5920.
 * <p>
