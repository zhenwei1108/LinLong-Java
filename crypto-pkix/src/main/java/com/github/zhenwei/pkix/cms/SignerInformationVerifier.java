...
public class SignerInformationVerifier {
  ...
  public SignerInformationVerifier(CMSSignatureAlgorithmNameGenerator sigNameGenerator,
      ...
      ContentVerifierProvider verifierProvider, DigestCalculatorProvider digestProvider) {
  ...
  public ContentVerifier getContentVerifier(AlgorithmIdentifier signingAlgorithm,
