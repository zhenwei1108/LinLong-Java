...
/**
 * Representation of data groups with more than 1 members according to the description provided in
 * RFC4998.
 * <p>
 ...
 * PartialHashtree so that the presence of the group can be checked for, as well as the individual
