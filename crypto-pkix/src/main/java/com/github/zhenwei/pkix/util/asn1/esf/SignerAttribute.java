...
public class SignerAttribute
  ...
  private SignerAttribute(
    ...
    for (Enumeration e = seq.getObjects(); e.hasMoreElements(); ) {
      ...
      if (taggedObject.getTagNo() == 0) {
        ...
        values[index] = AttributeCertificate.getInstance(
            ASN1Sequence.getInstance(taggedObject, true));
      } else {
  ...
  /**
   * Return the sequence of choices - the array elements will either be of type Attribute[] or
   * AttributeCertificate depending on what tag was used.
   *
