...
/**
 * DVCRequest is general request to DVCS (RFC 3029). It represents requests for all types of
 * services. Requests for different services differ in DVCData structure.
 */
public class DVCSRequest
    extends DVCSMessage {

  private com.github.zhenwei.pkix.util.asn1.dvcs.DVCSRequest asn1;
  ...
  public DVCSRequest(ContentInfo contentInfo)
    ...
    try {
      if (contentInfo.getContent().toASN1Primitive() instanceof ASN1Sequence) {
        this.asn1 = com.github.zhenwei.pkix.util.asn1.dvcs.DVCSRequest.getInstance(
   ...
   *
   * @return an com.github.zhenwei.pkix.util.asn1.dvcs.DVCSRequest object.
   */
  ...
  /**
   * Get data of DVCRequest. Depending on type of the request it could be different subclasses of
   * DVCRequestData.
   *
