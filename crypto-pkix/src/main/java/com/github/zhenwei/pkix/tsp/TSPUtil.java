...
import com.github.zhenwei.core.asn1.x509.ExtendedKeyUsage;
...
public class TSPUtil {
  ...
  static {
    ...
    digestLengths.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256.getId(),
        Integers.valueOf(32));
    digestLengths.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512.getId(),
        Integers.valueOf(64));
    ...
    digestNames.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256.getId(),
        "GOST3411-2012-256");
    digestNames.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512.getId(),
        "GOST3411-2012-512");
   ...
   */
  public static Collection getSignatureTimestamps(SignerInformation signerInfo,
  ...
  static void addExtension(ExtensionsGenerator extGenerator, ASN1ObjectIdentifier oid,
