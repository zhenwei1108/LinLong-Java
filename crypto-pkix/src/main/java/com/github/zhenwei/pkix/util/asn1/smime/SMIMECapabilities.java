...
public class SMIMECapabilities
  ...
  public static final ASN1ObjectIdentifier idea_CBC = new ASN1ObjectIdentifier(
      "1.3.6.1.4.1.188.7.1.1.2");
  public static final ASN1ObjectIdentifier cast5_CBC = new ASN1ObjectIdentifier(
  ...
  /**
   * returns a vector with 0 or more objects of all the capabilities matching the passed in
   * capability OID. If the OID passed is null the entire set is returned.
   */
