...
import com.github.zhenwei.pkix.est.ESTService;
import com.github.zhenwei.pkix.est.ESTServiceBuilder;
...
public class JsseESTServiceBuilder
   ...
   */
  public JsseESTServiceBuilder(String hostName, int portNo,
  ...
  public JsseESTServiceBuilder(String server) {
    super(server);
    sslSocketFactoryCreatorBuilder = new SSLSocketFactoryCreatorBuilder(
  ...
  public JsseESTServiceBuilder withChannelBindingProvider(
   ...
   *
   * @param filter true, supplied cipher suites will be filtered with supported before passing to
   *               the JSSE provider.
   * @return this;
   */
