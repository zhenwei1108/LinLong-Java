...
public class IEEE1609dot2 {
  ...
  /**
   * PduFunctionalType ::= INTEGER (0..255) tlsHandshake          PduFunctionalType ::= 1
  ...
  /**
   * HashedData::= CHOICE { sha256HashedData  OCTET STRING (SIZE(32)), ..., sha384HashedData  OCTET
   * STRING (SIZE(48)), reserved          OCTET STRING (SIZE(32)) }
   */
  ...
  /**
   * HeaderInfoContributorId ::= INTEGER (0..255) etsiHeaderInfoContributorId
   * HeaderInfoContributorId ::= 2
   */
   ...
   * &id({Ieee1609Dot2HeaderInfoContributedExtensions}), extns   SEQUENCE (SIZE(1..MAX)) OF
   * IEEE1609DOT2-HEADERINFO-CONTRIBUTED-EXTENSION. &Extn({Ieee1609Dot2HeaderInfoContributedExtensions}{@.contributorId})
   * }
   */
  ...
  /**
   * EncryptedDataEncryptionKey ::= CHOICE { eciesNistP256         EciesP256EncryptedKey,
  ...
  /**
   * RecipientInfo ::= CHOICE { pskRecipInfo         PreSharedKeyRecipientInfo, symmRecipInfo
   * SymmRecipientInfo, certRecipInfo        PKRecipientInfo, signedDataRecipInfo  PKRecipientInfo,
  ...
  /**
   * EncryptedData ::= SEQUENCE { recipients  SequenceOfRecipientInfo, ciphertext
   * SymmetricCiphertext }
   */
  ...
  public static final OERDefinition.Builder SubjectPermissions = OERDefinition.choice(
      Ieee1609Dot2BaseTypes.SequenceOfPsidSspRange, OERDefinition.nullValue(),
      OERDefinition.extension()
  ).label("SubjectPermissions");

  /**
   * VerificationKeyIndicator ::= CHOICE  { verificationKey         PublicVerificationKey,
  ...
  /**
   * PsidGroupPermissions ::= SEQUENCE  { subjectPermissions SubjectPermissions, minChainLength
   * INTEGER DEFAULT 1, chainLengthRange   INTEGER DEFAULT 0, eeType             EndEntityType
   * DEFAULT '00'H }
   */
   ...
   */
  public static final OERDefinition.Builder SequenceOfPsidGroupPermissions = OERDefinition.seqof(
      PsidGroupPermissions).label("SequenceOfPsidGroupPermissions");

  /**
   * LinkageData ::= SEQUENCE  { iCert                 IValue, linkage-value         LinkageValue,
  ...
  /**
   * CertificateId ::= CHOICE  { linkageData             LinkageData, name
   * Hostname, binaryId                OCTET STRING(SIZE(1..64)), none                    NULL, ...
   * }
   */
  ...
  /**
   * ToBeSignedCertificate ::= SEQUENCE  { id                     CertificateId, cracaId
   *    HashedId3, crlSeries              CrlSeries, validityPeriod         ValidityPeriod, region
   *               GeographicRegion OPTIONAL, assuranceLevel         SubjectAssurance OPTIONAL,
   * appPermissions         SequenceOfPsidSsp OPTIONAL, certIssuePermissions
   * SequenceOfPsidGroupPermissions OPTIONAL, certRequestPermissions SequenceOfPsidGroupPermissions
   * OPTIONAL, canRequestRollover     NULL OPTIONAL, encryptionKey          PublicEncryptionKey
   * OPTIONAL, verifyKeyIndicator     VerificationKeyIndicator, ... } (WITH COMPONENTS { ...,
   * appPermissions PRESENT} | WITH COMPONENTS { ..., certIssuePermissions PRESENT} | WITH
   * COMPONENTS { ..., certRequestPermissions PRESENT})
   */
  ...
  /**
   * IssuerIdentifier ::= CHOICE  { sha256AndDigest         HashedId8, self
   * HashAlgorithm, ..., sha384AndDigest         HashedId8 }
   */
  public static final OERDefinition.Builder IssuerIdentifier = OERDefinition.choice(
      Ieee1609Dot2BaseTypes.HashedId8, Ieee1609Dot2BaseTypes.HashAlgorithm,
      OERDefinition.extension(), Ieee1609Dot2BaseTypes.HashedId8).label("IssuerIdentifier");
  ...
  public static final OERDefinition.Builder CertificateType = OERDefinition.enumeration(
      OERDefinition.enumItem("explicit"), OERDefinition.enumItem("implicit"),
   ...
   * <p>
   * ExplicitCertificate ::= CertificateBase (WITH COMPONENTS {..., type(explicit), toBeSigned(WITH
   * COMPONENTS {..., verifyKeyIndicator(WITH COMPONENTS {verificationKey}) }), signature PRESENT
   * })
   * <p>
   * ImplicitCertificate ::= CertificateBase (WITH COMPONENTS {..., type(implicit), toBeSigned(WITH
   * COMPONENTS {..., verifyKeyIndicator(WITH COMPONENTS {reconstructionValue}) }), signature ABSENT
   * })
   * <p>
   * <p>
   * <p>
   * CertificateBase ::= SEQUENCE  { version                 Uint8(3), type
   * CertificateType, issuer                  IssuerIdentifier, toBeSigned
   * ToBeSignedCertificate, signature               Signature OPTIONAL }
   */

  public static final OERDefinition.Builder CertificateBase = OERDefinition.seq(
          Ieee1609Dot2BaseTypes.UINT8, CertificateType, IssuerIdentifier, ToBeSignedCertificate,
   ...
   */
  public static final OERDefinition.Builder Certificate = CertificateBase.copy()
      .label("Certificate(CertificateBase)");


  /**
   * SequenceOfCertificate ::= SEQUENCE OF Certificate
   */
  public static final OERDefinition.Builder SequenceOfCertificate = OERDefinition.seqof(
      Certificate);


  /**
   * HeaderInfo ::= SEQUENCE { psid                  Psid, generationTime        Time64 OPTIONAL,
   * expiryTime            Time64  OPTIONAL, generationLocation    ThreeDLocation OPTIONAL,
   * p2pcdLearningRequest  HashedId3 OPTIONAL, missingCrlIdentifier  MissingCrlIdentifier OPTIONAL,
   * encryptionKey         EncryptionKey OPTIONAL, ..., inlineP2pcdRequest    SequenceOfHashedId3
   * OPTIONAL, requestedCertificate  Certificate OPTIONAL, pduFunctionalType     PduFunctionalType
   * OPTIONAL, contributedExtensions ContributedExtensionBlocks OPTIONAL }
   */
  ...
  /**
   * SignerIdentifier ::= CHOICE { digest       HashedId8, certificate  SequenceOfCertificate, self
   * NULL, ... }
   */
  public static final OERDefinition.Builder SignerIdentifier = OERDefinition.choice(
      Ieee1609Dot2BaseTypes.HashedId8.label("digest"), SequenceOfCertificate,
      OERDefinition.nullValue().label("self"), OERDefinition.extension());

  public static final OERDefinition.Builder ToBeSignedData = new OERDefinition.MutableBuilder(
      OERDefinition.BaseType.SEQ);


  /**
   * SignedData ::= SEQUENCE { hashId     HashAlgorithm, tbsData    ToBeSignedData, signer
   * SignerIdentifier, signature  Signature }
   */
  ...
  /**
   * Ieee1609Dot2Content ::=  CHOICE { unsecuredData             Opaque, signedData
   * SignedData, encryptedData             EncryptedData, signedCertificateRequest  Opaque, ... }
   */
  ...
  /**
   * SignedDataPayload ::= SEQUENCE { data         Ieee1609Dot2Data OPTIONAL, extDataHash
   * HashedData OPTIONAL, ... } (WITH COMPONENTS {..., data PRESENT} | WITH COMPONENTS {...,
   * extDataHash PRESENT})
   */
...
//        HeaderInfo.label("headerInfo"));
  ...
  static {
    ((OERDefinition.MutableBuilder) ToBeSignedData).addItemsAndFreeze(
        SignedDataPayload.label("payload"),
        HeaderInfo.label("headerInfo"));
  }
}