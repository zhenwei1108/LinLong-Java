...
import com.github.zhenwei.pkix.util.asn1.crmf.Controls;
...
public class CertificateRequestMessage
  ...
  /**
   * Return whether or not the proof-of-possession (POP) is of the type popSigningKey and it has a
   * public key MAC associated with it.
   *
  ...
  public boolean isValidSigningKeyPOP(ContentVerifierProvider verifierProvider)
    ...
    if (pop.getType() == popSigningKey) {
      ...
      if (popoSign.getPoposkInput() != null
          && popoSign.getPoposkInput().getPublicKeyMAC() != null) {
   ...
   */
  public boolean isValidSigningKeyPOP(ContentVerifierProvider verifierProvider,
      PKMACBuilder macBuilder, char[] password)
      throws CRMFException, IllegalStateException {
    ProofOfPossession pop = certReqMsg.getPopo();
