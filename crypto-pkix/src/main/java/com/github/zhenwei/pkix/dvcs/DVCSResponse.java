...
/**
 * DVCResponse is general response to DVCS (RFC 3029). It represents responses for all types of
 * services.
 */
  ...
  public DVCSResponse(ContentInfo contentInfo)
    ...
    try {
      if (contentInfo.getContent().toASN1Primitive() instanceof ASN1Sequence) {
        this.asn1 = com.github.zhenwei.pkix.util.asn1.dvcs.DVCSResponse.getInstance(
