...
public class ERSEvidenceRecord {
  ...
  public ERSEvidenceRecord(EvidenceRecord evidenceRecord,
    ...
    this.lastArchiveTimeStamp = new ERSArchiveTimeStamp(
        archiveTimestamps[archiveTimestamps.length - 1], digestCalculatorProvider);
  }
