...
/**
 * Class for parsing OpenSSL PEM encoded streams containing X509 certificates, PKCS8 encoded keys
 * and PKCS7 objects.
 * <p>
 * In the case of PKCS7 objects the reader will return a CMS ContentInfo object. Public keys will be
 * returned as well formed SubjectPublicKeyInfo objects, private keys will be returned as well
 * formed PrivateKeyInfo objects. In the case of a private key a PEMKeyPair will normally be
 * returned if the encoding contains both the private and public key definition. CRLs, Certificates,
 * PKCS#10 requests, and Attribute Certificates will generate the appropriate BC holder class.
 * </p>
 */
    ...
    public PEMKeyPair parse(byte[] encoding)
      ...
      try {
        ...
        return new PEMKeyPair(
            new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa,
                new DSAParameter(p.getValue(), q.getValue(), g.getValue())), y),
            new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa,
  ...
  private class ECDSAKeyPairParser
    ...
    public PEMKeyPair parse(byte[] encoding)
      ...
      try {
        ...
        com.github.zhenwei.core.asn1.sec.ECPrivateKey pKey = com.github.zhenwei.core.asn1.sec.ECPrivateKey.getInstance(
            seq);
  ...
  private class RSAKeyPairParser
    ...
    public PEMKeyPair parse(byte[] encoding)
      ...
      try {
        ...
        com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey keyStruct = com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey.getInstance(
            seq);
        ...
        return new PEMKeyPair(new SubjectPublicKeyInfo(algId, pubSpec),
            new PrivateKeyInfo(algId, keyStruct));
      } catch (IOException e) {
        throw e;
      } catch (Exception e) {
        throw new PEMException(
