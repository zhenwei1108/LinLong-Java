...
public class CMPCertificate
  ...
  /**
   * Note: the addition of attribute certificates is a BC extension. If you use this constructor
   * they will be added with a tag value of 1.
   *
   ...
   *  }
   * </pre>
   * Note: the addition of the explicit tagging is a BC extension. We apologise for the warped
