...
public class KeyAgreeRecipientIdentifier
   ...
   * <li> {@link com.github.zhenwei.core.asn1.ASN1TaggedObject#getInstance(Object) ASN1TaggedObject} with tag value 0: a KeyAgreeRecipientIdentifier data structure
   * </ul>
   * <p>
   * Note: no byte[] input!
   *
  ...
  public static KeyAgreeRecipientIdentifier getInstance(
    ...
    throw new IllegalArgumentException(
        "Invalid KeyAgreeRecipientIdentifier: " + obj.getClass().getName());
  }
