...
import com.github.zhenwei.pkix.mime.encoding.Base64InputStream;
import com.github.zhenwei.pkix.mime.encoding.QuotedPrintableInputStream;
...
public class BasicMimeParser
  ...
  public BasicMimeParser(
    ...
    this.src = src;
    this.defaultContentTransferEncoding =
        (parserContext != null) ? parserContext.getDefaultContentTransferEncoding() : "7bit";
  }
