...
//    }
    ...
    {
        if (other == null || !(other instanceof org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey))
        {
            return false;
        }

        org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey otherKey = (org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey)other;
