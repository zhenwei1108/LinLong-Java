...
import com.github.zhenwei.core.asn1.x509.V3TBSCertificateGenerator;
 ...
 *
 * @deprecated use com.github.zhenwei.pkix.cert.X509v3CertificateBuilder.
 */
public class X509V3CertificateGenerator {
  ...
  /**
   * add a given extension field for the standard extensions tag (tag 3) The value parameter becomes
   * the contents of the octet string associated with the extension.
   */
  public void addExtension(
      String oid,
      boolean critical,
  ...
  public X509Certificate generateX509Certificate(
    ...
    try {
      return generateX509Certificate(key, "CHAOS", null);
  ...
  /**
   * generate an X509 certificate, based on the current issuer and subject using the default
   * provider "BC", and the passed in source of randomness (if required).
   *
  ...
  public X509Certificate generateX509Certificate(
      ...
      throws SecurityException, SignatureException, InvalidKeyException {
    try {
      return generateX509Certificate(key, "CHAOS", random);
    } catch (NoSuchProviderException e) {
      throw new SecurityException("BC provider not installed!");
    }
  }
