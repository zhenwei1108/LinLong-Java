    ...
    implements PublicKey
{
    ...
    {
        if (other instanceof org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePublicKey)
        {
            org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePublicKey otherKey = (org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePublicKey)other;
