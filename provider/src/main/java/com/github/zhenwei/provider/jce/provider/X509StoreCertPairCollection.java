 ...
 * {@link com.github.zhenwei.provider.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
...
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link com.github.zhenwei.provider.x509.X509CertificatePair}s. The selector must be
     * a {@link com.github.zhenwei.provider.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     * </p>
