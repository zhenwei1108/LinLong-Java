  ...
  public static class OAEP
    ...
    protected byte[] engineGetEncoded() {
      ...
      AlgorithmIdentifier maskGenAlgorithm = new AlgorithmIdentifier(
          ...
          new AlgorithmIdentifier(DigestFactory.getOID(mgfSpec.getDigestAlgorithm()),
              DERNull.INSTANCE));
      PSource.PSpecified pSource = (PSource.PSpecified) currentSpec.getPSource();
      AlgorithmIdentifier pSourceAlgorithm = new AlgorithmIdentifier(
          PKCSObjectIdentifiers.id_pSpecified, new DEROctetString(pSource.getValue()));
      RSAESOAEPparams oaepP = new RSAESOAEPparams(hashAlgorithm, maskGenAlgorithm,
          pSourceAlgorithm);
    ...
    protected void engineInit(
      ...
      try {
        ...
        currentSpec = new OAEPParameterSpec(
            ...
            new MGF1ParameterSpec(MessageDigestUtils.getDigestName(
  ...
  public static class PSS
    ...
    protected byte[] engineGetEncoded()
      ...
      if (mgfSpec != null) {
        ...
        AlgorithmIdentifier maskGenAlgorithm = new AlgorithmIdentifier(
            pssSpec.getMGFAlgorithm().equals("SHAKE128") ? NISTObjectIdentifiers.id_shake128
    ...
    protected void engineInit(
      ...
      try {
        ...
        } else if (mgfOid.equals(NISTObjectIdentifiers.id_shake128) || mgfOid.equals(
            NISTObjectIdentifiers.id_shake256)) {
          currentSpec = new PSSParameterSpec(
              MessageDigestUtils.getDigestName(pssP.getHashAlgorithm().getAlgorithm()),
