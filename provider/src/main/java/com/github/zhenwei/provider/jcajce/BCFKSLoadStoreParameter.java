...
/**
 * LoadStoreParameter to allow configuring of the PBKDF used to generate encryption keys for use in
 * the keystore.
 */
public class BCFKSLoadStoreParameter
  ...
  public static class Builder {
    ...
    /**
     * Base constructor for reading a KeyStore from an InputStream using a public key for
     * validation.
     *
    ...
    /**
     * Add a valid certificate chain where certs[0] is the end-entity matching the private key we
     * are using to sign the key store.
     *
