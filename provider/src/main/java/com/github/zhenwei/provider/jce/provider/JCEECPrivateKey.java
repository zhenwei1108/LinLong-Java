    ...
    implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    {
        if (!(o instanceof org.bouncycastle.jce.provider.JCEECPrivateKey))
        {
            return false;
        }

        org.bouncycastle.jce.provider.JCEECPrivateKey other = (org.bouncycastle.jce.provider.JCEECPrivateKey)o;
