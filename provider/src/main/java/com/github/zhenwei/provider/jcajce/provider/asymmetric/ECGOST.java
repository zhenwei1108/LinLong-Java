...
public class ECGOST
{
    private static final String PREFIX_COMMON = "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".ec.";
    private static final String PREFIX = "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".ecgost.";
    private static final String PREFIX_GOST_2012 = "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".ecgost12.";
