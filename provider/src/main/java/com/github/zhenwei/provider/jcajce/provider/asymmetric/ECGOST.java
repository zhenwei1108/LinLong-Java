...
import com.github.zhenwei.provider.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
...
public class ECGOST {
  ...
  private static final String PREFIX =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".ecgost.";
  private static final String PREFIX_GOST_2012 =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".ecgost12.";
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("Alg.Alias.KeyAgreement." + CryptoProObjectIdentifiers.gostR3410_2001,
          "ECGOST3410");
      provider.addAlgorithm("Alg.Alias.KeyAgreement.GOST-3410-2001", "ECGOST3410");

      provider.addAlgorithm(
          "Alg.Alias.KeyAgreement." + CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_ESDH,
          "ECGOST3410");

      provider.addAlgorithm("AlgorithmParameters.ECGOST3410",
          PREFIX_COMMON + "AlgorithmParametersSpi");
      provider.addAlgorithm("AlgorithmParameters.ECGOST3410-2012",
          PREFIX_COMMON + "AlgorithmParametersSpi");
      ...
      registerOid(provider, RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256,
          "ECGOST3410-2012",
          new com.github.zhenwei.provider.jcajce.provider.asymmetric.ecgost12.KeyFactorySpi());
      ...
      provider.addAlgorithm("KeyAgreement.ECGOST3410-2012-256",
          PREFIX_GOST_2012 + "KeyAgreementSpi$ECVKO256");
      provider.addAlgorithm("KeyAgreement.ECGOST3410-2012-512",
          PREFIX_GOST_2012 + "KeyAgreementSpi$ECVKO512");

      provider.addAlgorithm("Alg.Alias.KeyAgreement."
          + RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_256, "ECGOST3410-2012-256");
      provider.addAlgorithm("Alg.Alias.KeyAgreement."
          + RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_512, "ECGOST3410-2012-512");
      provider.addAlgorithm(
          "Alg.Alias.KeyAgreement." + RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256,
          "ECGOST3410-2012-256");
      provider.addAlgorithm(
          "Alg.Alias.KeyAgreement." + RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512,
          "ECGOST3410-2012-512");
    }
  }
}