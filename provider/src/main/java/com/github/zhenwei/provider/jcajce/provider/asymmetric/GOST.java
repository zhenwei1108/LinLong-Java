...
import com.github.zhenwei.provider.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST {
  ...
  private static final String PREFIX =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".gost.";
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("AlgorithmParameterGenerator.GOST3410",
          PREFIX + "AlgorithmParameterGeneratorSpi");

      registerOid(provider, CryptoProObjectIdentifiers.gostR3410_94, "GOST3410",
          new KeyFactorySpi());
      registerOidAlgorithmParameterGenerator(provider, CryptoProObjectIdentifiers.gostR3410_94,
          "GOST3410");
      ...
      provider.addAlgorithm(
          "Alg.Alias.Signature." + CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_94,
          "GOST3410");
