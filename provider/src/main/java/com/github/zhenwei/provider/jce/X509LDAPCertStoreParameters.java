    ...
    implements X509StoreParameters, CertStoreParameters
{
    ...
    public static class Builder
    {
        ...
        public org.bouncycastle.jce.X509LDAPCertStoreParameters build()
        {
            ...
            return new org.bouncycastle.jce.X509LDAPCertStoreParameters(this);
        }
    }
    ...
    public boolean equal(Object o)
    {
        ...
        if (!(o instanceof org.bouncycastle.jce.X509LDAPCertStoreParameters))
        {
            return false;
        }

        org.bouncycastle.jce.X509LDAPCertStoreParameters params = (org.bouncycastle.jce.X509LDAPCertStoreParameters)o;
    ...
    public static org.bouncycastle.jce.X509LDAPCertStoreParameters getInstance(LDAPCertStoreParameters params)
    {
        String server = "ldap://" + params.getServerName() + ":" + params.getPort();
        org.bouncycastle.jce.X509LDAPCertStoreParameters _params = new Builder(server, "").build();
        return _params;
    }
}