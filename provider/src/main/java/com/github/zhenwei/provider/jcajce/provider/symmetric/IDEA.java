...
import com.github.zhenwei.core.asn1.misc.IDEACBCPar;
...
import com.github.zhenwei.core.crypto.engines.IDEAEngine;
...
public final class IDEA {
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("AlgorithmParameterGenerator.1.3.6.1.4.1.188.7.1.1.2",
          PREFIX + "$AlgParamGen");
      ...
      provider.addAlgorithm("Cipher", MiscObjectIdentifiers.as_sys_sec_alg_ideaCBC,
          PREFIX + "$CBC");
      ...
      provider.addAlgorithm("KeyGenerator", MiscObjectIdentifiers.as_sys_sec_alg_ideaCBC,
          PREFIX + "$KeyGen");
