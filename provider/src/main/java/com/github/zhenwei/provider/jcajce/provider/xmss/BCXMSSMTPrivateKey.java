    ...
    implements PrivateKey, XMSSMTPrivateKey
{
    ...
    {
        return new org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSMTPrivateKey(this.treeDigest, keyParams.extractKeyShard(usageCount));
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (o instanceof org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSMTPrivateKey)
        {
            org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSMTPrivateKey otherKey = (org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSMTPrivateKey)o;
