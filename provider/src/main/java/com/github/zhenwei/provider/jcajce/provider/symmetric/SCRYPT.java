...
public class SCRYPT {
    ...
    protected SecretKey engineGenerateSecret(
      ...
      if (keySpec instanceof ScryptKeySpec) {
        ...
        CipherParameters param = new KeyParameter(SCrypt.generate(
            ...
            pbeSpec.getCostParameter(), pbeSpec.getBlockSize(),
            pbeSpec.getParallelizationParameter(),
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("SecretKeyFactory", MiscObjectIdentifiers.id_scrypt,
          PREFIX + "$ScryptWithUTF8");
    }
  }
}