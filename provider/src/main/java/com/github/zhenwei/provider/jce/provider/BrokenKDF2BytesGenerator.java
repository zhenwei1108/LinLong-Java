 ...
 * <br>
 * This implementation is based on draft 9 of IEEE P1363a. <b>Note:</b> as this is still a draft the
 * output of this generator may change, don't use it for anything that might be subject to long term
 * storage.
 */
public class BrokenKDF2BytesGenerator
  ...
  /**
   * Construct a KDF2 Parameters generator. Generates key material according to IEEE P1363a - if you
   * want orthodox results you should use a digest specified in the standard.
   * <p>
   * <b>Note:</b> IEEE P1363a standard is still a draft standard, if the standard
   * changes this function, the output of this function will change as well. Don't use this routine
   * for anything subject to long term storage.
   *
