...
import com.github.zhenwei.core.pqc.crypto.xmss.XMSSMTKeyGenerationParameters;
import com.github.zhenwei.core.pqc.crypto.xmss.XMSSMTKeyPairGenerator;
...
import com.github.zhenwei.provider.jcajce.spec.XMSSMTParameterSpec;
...
public class XMSSMTKeyPairGeneratorSpi
  ...
  public KeyPair generateKeyPair() {
    if (!initialised) {
      param = new XMSSMTKeyGenerationParameters(new XMSSMTParameters(10, 20, new SHA512Digest()),
          random);
    ...
    return new KeyPair(new BCXMSSMTPublicKey(treeDigest, pub),
        new BCXMSSMTPrivateKey(treeDigest, priv));
  }
}