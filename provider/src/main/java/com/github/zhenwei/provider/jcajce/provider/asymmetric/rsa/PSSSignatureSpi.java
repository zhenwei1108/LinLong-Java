...
public class PSSSignatureSpi
  ...
  protected void engineInitVerify(
    ...
    pss = new com.github.zhenwei.core.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest,
        saltLength, trailer);
    pss.init(false, key);
    isInitState = true;
  }
  ...
  protected void engineSetParameter(
    ...
    if (params instanceof PSSParameterSpec) {
      ...
      if (mgfDigest == null) {
        throw new InvalidAlgorithmParameterException(
            "no match on MGF algorithm: " + newParamSpec.getMGFAlgorithm());
      }
  ...
  static public class SHA512_224withRSA
    ...
    public SHA512_224withRSA() {
      super(new RSABlindedEngine(),
          new PSSParameterSpec("SHA-512(224)", "MGF1", new MGF1ParameterSpec("SHA-512(224)"), 28,
              1));
    }
  }
  ...
  static public class SHA512_256withRSA
    ...
    public SHA512_256withRSA() {
      super(new RSABlindedEngine(),
          new PSSParameterSpec("SHA-512(256)", "MGF1", new MGF1ParameterSpec("SHA-512(256)"), 32,
              1));
    }
  }
