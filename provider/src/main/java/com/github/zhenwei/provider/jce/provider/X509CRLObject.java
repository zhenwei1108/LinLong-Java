 ...
 * @deprecated Do not use this class directly - either use com.github.zhenwei.pkix.cert (bcpkix) or CertificateFactory.
 */
            ...
            while (certs.hasMoreElements())
            {
                ...
                if (entry.getUserCertificate().hasValue(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = com.github.zhenwei.core.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
