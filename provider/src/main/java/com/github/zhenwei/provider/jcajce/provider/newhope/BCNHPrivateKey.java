    ...
    implements NHPrivateKey
{
    ...
    {
        if (!(o instanceof org.bouncycastle.pqc.jcajce.provider.newhope.BCNHPrivateKey))
        {
            return false;
        }
        org.bouncycastle.pqc.jcajce.provider.newhope.BCNHPrivateKey otherKey = (org.bouncycastle.pqc.jcajce.provider.newhope.BCNHPrivateKey)o;
