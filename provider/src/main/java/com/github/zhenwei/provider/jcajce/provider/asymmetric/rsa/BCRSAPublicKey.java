...
public class BCRSAPublicKey
  ...
  private void populateFromPublicKeyInfo(SubjectPublicKeyInfo info) {
    try {
      com.github.zhenwei.core.asn1.pkcs.RSAPublicKey pubKey = com.github.zhenwei.core.asn1.pkcs.RSAPublicKey.getInstance(
          info.parsePublicKey());
  ...
  public byte[] getEncoded() {
    return KeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier,
        new com.github.zhenwei.core.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
  }
  ...
  public String toString() {
    ...
    buf.append("RSA Public Key [").append(RSAUtil.generateKeyFingerprint(this.getModulus()))
        .append("]")
        .append(",[")
