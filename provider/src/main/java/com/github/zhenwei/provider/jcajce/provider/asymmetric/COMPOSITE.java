...
public class COMPOSITE
{
    ...
    static
    {
        compositeAttributes.put("SupportedKeyClasses", "com.github.zhenwei.provider.jcajce.CompositePublicKey|com.github.zhenwei.provider.jcajce.CompositePrivateKey");
