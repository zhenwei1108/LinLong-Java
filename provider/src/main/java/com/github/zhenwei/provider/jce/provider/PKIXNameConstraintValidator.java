...
import com.github.zhenwei.core.asn1.x509.NameConstraintValidatorException;

public class PKIXNameConstraintValidator {

  com.github.zhenwei.core.asn1.x509.PKIXNameConstraintValidator validator = new com.github.zhenwei.core.asn1.x509.PKIXNameConstraintValidator();
   ...
   *
   * @param name The GeneralName.
   * @throws PKIXNameConstraintValidatorException If the <code>name</code> is excluded.
   */
