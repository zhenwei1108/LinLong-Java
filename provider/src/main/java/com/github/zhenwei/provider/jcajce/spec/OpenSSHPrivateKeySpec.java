...
/**
 * OpenSSHPrivateKeySpec holds and encoded OpenSSH private key. The format of the key can be either
 * ASN.1 or OpenSSH.
 */
public class OpenSSHPrivateKeySpec
   ...
   * <p>
   * KeyFactory kpf = KeyFactory.getInstance("RSA", "BC"); PrivateKey prk =
   * kpf.generatePrivate(privSpec);
   * <p>
