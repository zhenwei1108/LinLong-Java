...
import com.github.zhenwei.core.crypto.generators.DSTU4145KeyPairGenerator;
import com.github.zhenwei.core.crypto.generators.ECKeyPairGenerator;
import com.github.zhenwei.core.crypto.params.DSTU4145Parameters;
...
public class KeyPairGeneratorSpi
  ...
  public void initialize(
    ...
    if (params instanceof ECParameterSpec) {
      ...
      engine.init(param);
      initialised = true;
    } else if (params == null && LinLongProvider.CONFIGURATION.getEcImplicitlyCa() != null) {
      ECParameterSpec p = LinLongProvider.CONFIGURATION.getEcImplicitlyCa();
      this.ecParams = params;
