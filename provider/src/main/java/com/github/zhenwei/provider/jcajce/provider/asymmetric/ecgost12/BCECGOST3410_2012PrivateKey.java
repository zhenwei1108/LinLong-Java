...
public class BCECGOST3410_2012PrivateKey
  ...
  private void populateFromPrivKeyInfo(PrivateKeyInfo info)
    ...
    if (p instanceof ASN1Sequence && (ASN1Sequence.getInstance(p).size() == 2
      ...
      gostParams = GOST3410PublicKeyAlgParameters.getInstance(
  ...
  public byte[] getEncoded() {
    ...
    if (gostParams != null) {
      ...
      try {
        PrivateKeyInfo info = new PrivateKeyInfo(new AlgorithmIdentifier(identifier, gostParams),
      ...
      if (publicKey != null) {
        keyStructure = new com.github.zhenwei.core.asn1.sec.ECPrivateKey(orderBitLength,
      ...
      try {
        info = new PrivateKeyInfo(new AlgorithmIdentifier(identifier, params.toASN1Primitive()),
