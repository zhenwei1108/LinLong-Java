...
import com.github.zhenwei.provider.jcajce.CompositePublicKey;
...
abstract class X509CertificateImpl
  ...
  protected com.github.zhenwei.core.asn1.x509.Certificate c;
  protected BasicConstraints basicConstraints;
  protected boolean[] keyUsage;
  protected String sigAlgName;
  protected byte[] sigAlgParams;

  X509CertificateImpl(JcaJceHelper bcHelper, com.github.zhenwei.core.asn1.x509.Certificate c,
      BasicConstraints basicConstraints, boolean[] keyUsage, String sigAlgName,
      byte[] sigAlgParams) {
  ...
  /**
   * return a more "meaningful" representation for the signature algorithm used in the certificate.
   */
  ...
  public PublicKey getPublicKey() {
    try {
      return LinLongProvider.getPublicKey(c.getSubjectPublicKeyInfo());
    } catch (IOException e) {
        ...
        if (ext.getExtnValue() != null) {
          ...
          try {
            if (oid.equals(Extension.basicConstraints)) {
              ...
              buf.append(new NetscapeRevocationURL(ASN1IA5String.getInstance(dIn.readObject())))
                  .append(nl);
            } else if (oid.equals(MiscObjectIdentifiers.verisignCzagExtension)) {
              buf.append(new VerisignCzagExtension(ASN1IA5String.getInstance(dIn.readObject())))
                  .append(nl);
            } else {
  ...
  private void doVerify(
    ...
    if (key instanceof CompositePublicKey && X509SignatureUtil.isCompositeAlgorithm(
  ...
  private void checkSignature(
    ...
    try {
      OutputStream sigOut = new BufferedOutputStream(OutputStreamFactory.createStream(signature),
          512);
  ...
  private boolean isAlgIdEqual(AlgorithmIdentifier id1, AlgorithmIdentifier id2) {
    ...
    if (Properties.isOverrideSet("com.github.zhenwei.provider.x509.allow_absent_equiv_NULL")) {
  ...
  private static Collection getAlternativeNames(com.github.zhenwei.core.asn1.x509.Certificate c,
      String oid)
      throws CertificateParsingException {
  ...
  protected static byte[] getExtensionOctets(com.github.zhenwei.core.asn1.x509.Certificate c,
      String oid) {
    ASN1OctetString extValue = getExtensionValue(c, oid);
    if (null != extValue) {
  ...
  protected static ASN1OctetString getExtensionValue(
      com.github.zhenwei.core.asn1.x509.Certificate c, String oid) {
