    ...
    implements BCX509Certificate
{
    ...
    private static Collection getAlternativeNames(com.github.zhenwei.core.asn1.x509.Certificate c, String oid)
        throws CertificateParsingException
    {
    ...
    protected static byte[] getExtensionOctets(com.github.zhenwei.core.asn1.x509.Certificate c, String oid)
    {
        ASN1OctetString extValue = getExtensionValue(c, oid);
        if (null != extValue)
        {
    ...
    protected static ASN1OctetString getExtensionValue(com.github.zhenwei.core.asn1.x509.Certificate c, String oid)
    {
