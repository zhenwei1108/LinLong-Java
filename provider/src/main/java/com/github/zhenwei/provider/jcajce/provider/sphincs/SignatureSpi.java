...
import com.github.zhenwei.core.pqc.crypto.sphincs.SPHINCS256Signer;
    ...
    if (publicKey instanceof BCSphincs256PublicKey) {
      ...
      if (!treeDigest.equals(key.getTreeDigest())) {
        throw new InvalidKeyException(
            "SPHINCS-256 signature for tree digest: " + key.getTreeDigest());
      }
...
//            }
  ...
  static public class withSha512
    ...
    public withSha512() {
      super(new SHA512Digest(), NISTObjectIdentifiers.id_sha512_256,
          new SPHINCS256Signer(new SHA512tDigest(256), new SHA512Digest()));
    }
  }
  ...
  static public class withSha3_512
    ...
    public withSha3_512() {
      super(new SHA3Digest(512), NISTObjectIdentifiers.id_sha3_256,
          new SPHINCS256Signer(new SHA3Digest(256), new SHA3Digest(512)));
    }
  }
}