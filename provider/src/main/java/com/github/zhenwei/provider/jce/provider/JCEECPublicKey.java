    ...
    implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    {
        if (!(o instanceof org.bouncycastle.jce.provider.JCEECPublicKey))
        {
            return false;
        }

        org.bouncycastle.jce.provider.JCEECPublicKey other = (org.bouncycastle.jce.provider.JCEECPublicKey)o;
