...
public class JCEECPublicKey
  ...
  private com.github.zhenwei.core.math.ec.ECPoint q;
  ...
  public JCEECPublicKey(
    ...
    if (spec.getParams() != null) // can be null if implictlyCa
    {
      ...
      if (q.getCurve() == null) {
        com.github.zhenwei.provider.jce.spec.ECParameterSpec s = LinLongProvider.CONFIGURATION.getEcImplicitlyCa();
  ...
  private void populateFromPubKeyInfo(SubjectPublicKeyInfo info) {
    ...
    if (algID.getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
      ...
      if (params.isNamedCurve()) {
        ...
        ecSpec = null;
        curve = LinLongProvider.CONFIGURATION.getEcImplicitlyCa().getCurve();
      } else {
  ...
  public com.github.zhenwei.core.math.ec.ECPoint engineGetQ() {
    return q;
  }
  ...
  public String toString() {
    ...
    buf.append("            X: ").append(this.q.getAffineXCoord().toBigInteger().toString(16))
        .append(nl);
    buf.append("            Y: ").append(this.q.getAffineYCoord().toBigInteger().toString(16))
        .append(nl);
  ...
  public boolean equals(Object o) {
    ...
    return engineGetQ().equals(other.engineGetQ()) && (engineGetSpec().equals(
        other.engineGetSpec()));
  }
