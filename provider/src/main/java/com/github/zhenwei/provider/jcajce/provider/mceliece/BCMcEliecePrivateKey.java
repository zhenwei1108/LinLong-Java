...
//    }
    ...
    {
        if (!(other instanceof org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey))
        {
            return false;
        }
        org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey otherKey = (org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey)other;
