...
public class KeyFactorySpi
  ...
  protected KeySpec engineGetKeySpec(
    ...
    if ((spec.isAssignableFrom(KeySpec.class) || spec.isAssignableFrom(
        java.security.spec.ECPublicKeySpec.class)) && key instanceof ECPublicKey) {
    ...
    } else if ((spec.isAssignableFrom(KeySpec.class) || spec.isAssignableFrom(
        java.security.spec.ECPrivateKeySpec.class)) && key instanceof ECPrivateKey) {
    ...
    } else if (spec.isAssignableFrom(com.github.zhenwei.provider.jce.spec.ECPublicKeySpec.class)
    ...
    } else if (spec.isAssignableFrom(com.github.zhenwei.provider.jce.spec.ECPrivateKeySpec.class)
        ...
        try {
          return new OpenSSHPublicKeySpec(
              OpenSSHPublicKeyUtil.encodePublicKey(
                  new ECPublicKeyParameters(bcPk.getQ(),
                      new ECDomainParameters(sc.getCurve(), sc.getG(), sc.getN(), sc.getH(),
                          sc.getSeed()))));
        } catch (IOException e) {
      ...
      if (key instanceof BCECPrivateKey) {
        try {
          return new OpenSSHPrivateKeySpec(
              PrivateKeyInfo.getInstance(key.getEncoded()).parsePrivateKey().toASN1Primitive()
                  .getEncoded());
        } catch (IOException e) {
  ...
  protected PrivateKey engineGeneratePrivate(
    ...
    if (keySpec instanceof ECPrivateKeySpec) {
      ...
      com.github.zhenwei.core.asn1.sec.ECPrivateKey ecKey = com.github.zhenwei.core.asn1.sec.ECPrivateKey.getInstance(
  ...
  protected PublicKey engineGeneratePublic(
    ...
    try {
      if (keySpec instanceof ECPublicKeySpec) {
        ...
        CipherParameters params = OpenSSHPublicKeyUtil.parsePublicKey(
  ...
  public static class EC
    ...
    public EC() {
      super("EC", WeGooProvider.CONFIGURATION);
    }
  }
  ...
  public static class ECGOST3410
    ...
    public ECGOST3410() {
      super("ECGOST3410", WeGooProvider.CONFIGURATION);
    }
  }
  ...
  public static class ECGOST3410_2012
    ...
    public ECGOST3410_2012() {
      super("ECGOST3410-2012", WeGooProvider.CONFIGURATION);
    }
  }
