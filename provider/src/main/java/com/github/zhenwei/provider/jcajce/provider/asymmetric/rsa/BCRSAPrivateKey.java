    ...
    implements RSAPrivateKey, PKCS12BagAttributeCarrier
{
    ...
    BCRSAPrivateKey(AlgorithmIdentifier algID, com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey key)
    {
        this.algorithmIdentifier = algID;
        this.algorithmIdentifierEnc = getEncoding(algID);
    ...
    {
        return KeyUtil.getEncodedPrivateKeyInfo(algorithmIdentifier, new com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey(getModulus(), ZERO, getPrivateExponent(), ZERO, ZERO, ZERO, ZERO, ZERO));
    }
