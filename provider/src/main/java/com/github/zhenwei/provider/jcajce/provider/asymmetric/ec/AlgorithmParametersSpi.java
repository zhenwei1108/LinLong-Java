...
public class AlgorithmParametersSpi
  ...
  protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec)
    ...
    if (algorithmParameterSpec instanceof ECGenParameterSpec) {
      ...
      ProviderConfiguration configuration = LinLongProvider.CONFIGURATION;
      ...
      ecParameterSpec = new ECNamedCurveSpec(curveName,
          baseSpec.getCurve(), baseSpec.getGenerator(), baseSpec.getOrder(),
      ...
      throw new InvalidParameterSpecException(
          "AlgorithmParameterSpec class not recognized: " + algorithmParameterSpec.getClass()
              .getName());
    }
  }
  ...
  protected void engineInit(byte[] bytes, String format)
    ...
    if (isASN1FormatString(format)) {
      ...
      ECCurve curve = EC5Util.getCurve(LinLongProvider.CONFIGURATION, params);
  ...
  protected <T extends AlgorithmParameterSpec> T engineGetParameterSpec(Class<T> paramSpec)
    ...
    if (ECParameterSpec.class.isAssignableFrom(paramSpec)
      ...
      if (curveName != null) {
        ...
        ASN1ObjectIdentifier namedCurveOid = ECUtil.getNamedCurveOid(
  ...
  protected byte[] engineGetEncoded(String format)
    ...
    if (isASN1FormatString(format)) {
      ...
      if (ecParameterSpec == null)     // implicitly CA
      {
        ...
        com.github.zhenwei.provider.jce.spec.ECParameterSpec ecSpec = EC5Util.convertSpec(
            ecParameterSpec);
