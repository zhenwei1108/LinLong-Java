...
import com.github.zhenwei.core.asn1.cryptopro.GOST3410NamedParameters;
import com.github.zhenwei.core.asn1.cryptopro.GOST3410ParamSetParameters;
import com.github.zhenwei.core.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
import com.github.zhenwei.provider.jce.interfaces.GOST3410Params;
...
public class GOST3410ParameterSpec
  ...
  public boolean equals(Object o) {
    if (o instanceof GOST3410ParameterSpec) {
      ...
      return this.keyParameters.equals(other.keyParameters)
          ...
          || (this.encryptionParamSetOID != null && this.encryptionParamSetOID.equals(
          other.encryptionParamSetOID)));
    }
  ...
  public static GOST3410ParameterSpec fromPublicKeyAlg(
    ...
    if (params.getEncryptionParamSet() != null) {
      return new GOST3410ParameterSpec(params.getPublicKeyParamSet().getId(),
          params.getDigestParamSet().getId(), params.getEncryptionParamSet().getId());
    } else {
      return new GOST3410ParameterSpec(params.getPublicKeyParamSet().getId(),
          params.getDigestParamSet().getId());
    }
  }
}