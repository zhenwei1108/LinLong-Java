...
/**
 * utility class for converting jce/jca ECDSA, ECDH, and ECDHC objects into their
...
public class ECUtil {
   ...
   * @return the sorted array of middle terms of the reduction polynomial. This array always has
   * length 3.
   */
  ...
  public static ECDomainParameters getDomainParameters(
      ...
      com.github.zhenwei.provider.jce.spec.ECParameterSpec params) {
    ...
    if (params instanceof ECNamedCurveParameterSpec) {
      ...
      domainParameters = new ECNamedDomainParameters(nameOid, nParams.getCurve(), nParams.getG(),
          nParams.getN(), nParams.getH(), nParams.getSeed());
    } else if (params == null) {
      com.github.zhenwei.provider.jce.spec.ECParameterSpec iSpec = configuration.getEcImplicitlyCa();

      domainParameters = new ECDomainParameters(iSpec.getCurve(), iSpec.getG(), iSpec.getN(),
          iSpec.getH(), iSpec.getSeed());
    } else {
  ...
  public static AsymmetricKeyParameter generatePublicKeyParameter(
    ...
    if (key instanceof ECPublicKey) {
      ...
      try {
        ...
        PublicKey publicKey = ChaosProvider.getPublicKey(
  ...
  public static AsymmetricKeyParameter generatePrivateKeyParameter(
    ...
    if (key instanceof ECPrivateKey) {
      ...
      if (s == null) {
        s = ChaosProvider.CONFIGURATION.getEcImplicitlyCa();
      }
      ...
      try {
        ...
        PrivateKey privateKey = ChaosProvider.getPrivateKey(
  ...
  public static ASN1ObjectIdentifier getNamedCurveOid(
    ...
    for (Enumeration names = ECNamedCurveTable.getNames(); names.hasMoreElements(); ) {
      ...
      if (params.getN().equals(ecParameterSpec.getN())
        ...
        return com.github.zhenwei.core.asn1.x9.ECNamedCurveTable.getOID(name);
      }
    }
  ...
  public static String privateKeyToString(String algorithm, BigInteger d,
      com.github.zhenwei.provider.jce.spec.ECParameterSpec spec) {
    StringBuffer buf = new StringBuffer();
    String nl = Strings.lineSeparator();

    com.github.zhenwei.core.math.ec.ECPoint q = new FixedPointCombMultiplier().multiply(spec.getG(),
        d).normalize();

    buf.append(algorithm);
    buf.append(" Private Key [").append(ECUtil.generateKeyFingerprint(q, spec)).append("]")
        .append(nl);
    buf.append("            X: ").append(q.getAffineXCoord().toBigInteger().toString(16))
        .append(nl);
    buf.append("            Y: ").append(q.getAffineYCoord().toBigInteger().toString(16))
        .append(nl);

    return buf.toString();
  }

  public static String publicKeyToString(String algorithm,
      com.github.zhenwei.core.math.ec.ECPoint q,
      com.github.zhenwei.provider.jce.spec.ECParameterSpec spec) {
    StringBuffer buf = new StringBuffer();
    String nl = Strings.lineSeparator();

    buf.append(algorithm);
    buf.append(" Public Key [").append(ECUtil.generateKeyFingerprint(q, spec)).append("]")
        .append(nl);
    buf.append("            X: ").append(q.getAffineXCoord().toBigInteger().toString(16))
        .append(nl);
    buf.append("            Y: ").append(q.getAffineYCoord().toBigInteger().toString(16))
  ...
  public static String generateKeyFingerprint(ECPoint publicPoint,
      com.github.zhenwei.provider.jce.spec.ECParameterSpec spec) {
    ...
    if (curve != null) {
      return new Fingerprint(
          Arrays.concatenate(publicPoint.getEncoded(false), curve.getA().getEncoded(),
              curve.getB().getEncoded(), g.getEncoded(false))).toString();
    }
