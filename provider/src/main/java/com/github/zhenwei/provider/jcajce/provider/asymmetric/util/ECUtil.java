...
public class ECUtil
{
    ...
    public static String privateKeyToString(String algorithm, BigInteger d, com.github.zhenwei.provider.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();

        com.github.zhenwei.core.math.ec.ECPoint q = new FixedPointCombMultiplier().multiply(spec.getG(), d).normalize();
    ...
    public static String publicKeyToString(String algorithm, com.github.zhenwei.core.math.ec.ECPoint q, com.github.zhenwei.provider.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();
    ...
    public static String generateKeyFingerprint(ECPoint publicPoint, com.github.zhenwei.provider.jce.spec.ECParameterSpec spec)
    {
