 ...
 * @see com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi
...
public class ExtendedPKIXBuilderParameters extends ExtendedPKIXParameters {
   ...
   * <code>Set</code> is <code>null</code> an empty set is assumed.
   * <p>
  ...
  /**
   * Creates an instance of <code>PKIXBuilderParameters</code> with the specified <code>Set</code>
   * of most-trusted CAs. Each element of the set is a {@link TrustAnchor TrustAnchor}.
   *
   * <p>
   * Note that the <code>Set</code> is copied to protect against subsequent modifications.
   *
   * @param trustAnchors      a <code>Set</code> of <code>TrustAnchor</code>s
   * @param targetConstraints a <code>Selector</code> specifying the constraints on the target
   *                          certificate or attribute certificate.
   * @throws InvalidAlgorithmParameterException if <code>trustAnchors</code> is empty.
   ...
   *                      certification path
   * @throws InvalidParameterException if <code>maxPathLength</code> is set to a value less than -1
   * @see com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi
   ...
   * @see com.github.zhenwei.provider.x509.ExtendedPKIXParameters#setParams(PKIXParameters)
   */
  ...
  /**
   * Makes a copy of this <code>PKIXParameters</code> object. Changes to the copy will not affect
  ...
  /**
   * Returns an instance of <code>ExtendedPKIXParameters</code> which can be safely casted to
   * <code>ExtendedPKIXBuilderParameters</code>.
   * <p>
