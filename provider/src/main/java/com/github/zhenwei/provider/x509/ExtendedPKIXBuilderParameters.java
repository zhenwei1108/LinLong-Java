...
public class ExtendedPKIXBuilderParameters extends ExtendedPKIXParameters
{
    ...
    protected void setParams(PKIXParameters params)
    {
        ...
        if (params instanceof org.bouncycastle.x509.ExtendedPKIXBuilderParameters)
        {
            org.bouncycastle.x509.ExtendedPKIXBuilderParameters _params = (org.bouncycastle.x509.ExtendedPKIXBuilderParameters) params;
    ...
    public Object clone()
    {
        org.bouncycastle.x509.ExtendedPKIXBuilderParameters params = null;
        try
        {
            params = new org.bouncycastle.x509.ExtendedPKIXBuilderParameters(getTrustAnchors(),
    ...
    public static ExtendedPKIXParameters getInstance(PKIXParameters pkixParams)
    {
        ...
        try
        {
            params = new org.bouncycastle.x509.ExtendedPKIXBuilderParameters(pkixParams
