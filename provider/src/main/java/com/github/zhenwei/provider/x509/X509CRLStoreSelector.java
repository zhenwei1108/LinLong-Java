    ...
    implements Selector
{
     ...
     *                fails.
     */
    public static org.bouncycastle.x509.X509CRLStoreSelector getInstance(X509CRLSelector selector)
    {
        if (selector == null)
        {
        ...
        org.bouncycastle.x509.X509CRLStoreSelector cs = new org.bouncycastle.x509.X509CRLStoreSelector();
    ...
    public Object clone()
    {
        org.bouncycastle.x509.X509CRLStoreSelector sel = org.bouncycastle.x509.X509CRLStoreSelector.getInstance(this);
