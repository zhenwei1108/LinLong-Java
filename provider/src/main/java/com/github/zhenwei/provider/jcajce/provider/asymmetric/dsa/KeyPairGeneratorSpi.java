...
import com.github.zhenwei.core.crypto.generators.DSAKeyPairGenerator;
import com.github.zhenwei.core.crypto.generators.DSAParametersGenerator;
  ...
  public void initialize(
    ...
    if (spec != null) {
      param = new DSAKeyGenerationParameters(random,
          new DSAParameters(spec.getP(), spec.getQ(), spec.getG()));
