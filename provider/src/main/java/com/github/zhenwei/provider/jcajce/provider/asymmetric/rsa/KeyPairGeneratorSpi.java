...
import com.github.zhenwei.core.crypto.generators.RSAKeyPairGenerator;
import com.github.zhenwei.core.crypto.params.RSAKeyGenerationParameters;
...
public class KeyPairGeneratorSpi
  ...
  private static final AlgorithmIdentifier PSS_ALGID = new AlgorithmIdentifier(
  ...
  public KeyPairGeneratorSpi(
    ...
    param = new RSAKeyGenerationParameters(defaultPublicExponent,
        CryptoServicesRegistrar.getSecureRandom(), 2048,
