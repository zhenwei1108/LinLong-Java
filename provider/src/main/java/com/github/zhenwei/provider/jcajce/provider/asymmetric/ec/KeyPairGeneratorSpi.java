...
public abstract class KeyPairGeneratorSpi
  ...
  public static class EC
    ...
    public void initialize(
      ...
      ECGenParameterSpec ecParams = (ECGenParameterSpec) ecParameters.get(
          Integers.valueOf(strength));
      if (ecParams == null) {
    ...
    protected ECKeyGenerationParameters createKeyGenParamsJCE(X9ECParameters x9, SecureRandom r) {
      ECDomainParameters dp = new ECDomainParameters(x9.getCurve(), x9.getG(), x9.getN(),
          x9.getH());
    ...
    protected void initializeNamedCurve(String curveName, SecureRandom random)
      ...
      this.ecParams = new ECNamedCurveSpec(curveName, x9.getCurve(), x9.getG(), x9.getN(),
          x9.getH(), seed);
