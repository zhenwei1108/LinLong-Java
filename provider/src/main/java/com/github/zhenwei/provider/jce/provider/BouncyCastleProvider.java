    ...
    implements ConfigurableProvider
{
    ...
    public static final ProviderConfiguration CONFIGURATION = new org.bouncycastle.jce.provider.BouncyCastleProviderConfiguration();

    private static final Map keyInfoConverters = new HashMap();

    private static final Class revChkClass = ClassUtil.loadClass(
        org.bouncycastle.jce.provider.BouncyCastleProvider.class, "java.security.cert.PKIXRevocationChecker");
    ...
    private void loadAlgorithms(String packageName, String[] names)
    {
        ...
        {
            Class clazz = ClassUtil.loadClass(org.bouncycastle.jce.provider.BouncyCastleProvider.class, packageName + names[i] + "$Mappings");
    ...
    public void setParameter(String parameterName, Object parameter)
    {
        ...
        {
            ((org.bouncycastle.jce.provider.BouncyCastleProviderConfiguration)CONFIGURATION).setParameter(parameterName, parameter);
        }
    }
