    ...
    implements ConfigurableProvider
{
    ...
    private void setup()
    {
        ...
        // X509Store
        //
        put("X509Store.CERTIFICATE/COLLECTION", "com.github.zhenwei.provider.jce.provider.X509StoreCertCollection");
        put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "com.github.zhenwei.provider.jce.provider.X509StoreAttrCertCollection");
        put("X509Store.CRL/COLLECTION", "com.github.zhenwei.provider.jce.provider.X509StoreCRLCollection");
        put("X509Store.CERTIFICATEPAIR/COLLECTION", "com.github.zhenwei.provider.jce.provider.X509StoreCertPairCollection");

        put("X509Store.CERTIFICATE/LDAP", "com.github.zhenwei.provider.jce.provider.X509StoreLDAPCerts");
        put("X509Store.CRL/LDAP", "com.github.zhenwei.provider.jce.provider.X509StoreLDAPCRLs");
        put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "com.github.zhenwei.provider.jce.provider.X509StoreLDAPAttrCerts");
        put("X509Store.CERTIFICATEPAIR/LDAP", "com.github.zhenwei.provider.jce.provider.X509StoreLDAPCertPairs");

        //
        // X509StreamParser
        //
        put("X509StreamParser.CERTIFICATE", "com.github.zhenwei.provider.jce.provider.X509CertParser");
        put("X509StreamParser.ATTRIBUTECERTIFICATE", "com.github.zhenwei.provider.jce.provider.X509AttrCertParser");
        put("X509StreamParser.CRL", "com.github.zhenwei.provider.jce.provider.X509CRLParser");
        put("X509StreamParser.CERTIFICATEPAIR", "com.github.zhenwei.provider.jce.provider.X509CertPairParser");

        //
        // cipher engines
        //
        put("Cipher.BROKENPBEWITHMD5ANDDES", "com.github.zhenwei.provider.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");

        put("Cipher.BROKENPBEWITHSHA1ANDDES", "com.github.zhenwei.provider.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");


        put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "com.github.zhenwei.provider.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");

        // Certification Path API
        if (revChkClass != null)
        {
            put("CertPathValidator.RFC3281", "com.github.zhenwei.provider.jce.provider.PKIXAttrCertPathValidatorSpi");
            put("CertPathBuilder.RFC3281", "com.github.zhenwei.provider.jce.provider.PKIXAttrCertPathBuilderSpi");
            put("CertPathValidator.RFC3280", "com.github.zhenwei.provider.jce.provider.PKIXCertPathValidatorSpi_8");
            put("CertPathBuilder.RFC3280", "com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi_8");
            put("CertPathValidator.PKIX", "com.github.zhenwei.provider.jce.provider.PKIXCertPathValidatorSpi_8");
            put("CertPathBuilder.PKIX", "com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi_8");
        }
        else
        {
            put("CertPathValidator.RFC3281", "com.github.zhenwei.provider.jce.provider.PKIXAttrCertPathValidatorSpi");
            put("CertPathBuilder.RFC3281", "com.github.zhenwei.provider.jce.provider.PKIXAttrCertPathBuilderSpi");
            put("CertPathValidator.RFC3280", "com.github.zhenwei.provider.jce.provider.PKIXCertPathValidatorSpi");
            put("CertPathBuilder.RFC3280", "com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi");
            put("CertPathValidator.PKIX", "com.github.zhenwei.provider.jce.provider.PKIXCertPathValidatorSpi");
            put("CertPathBuilder.PKIX", "com.github.zhenwei.provider.jce.provider.PKIXCertPathBuilderSpi");
        }
