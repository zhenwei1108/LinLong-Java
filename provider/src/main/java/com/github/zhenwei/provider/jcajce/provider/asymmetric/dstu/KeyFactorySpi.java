...
public class KeyFactorySpi
  ...
  protected KeySpec engineGetKeySpec(
    ...
    } else if (spec.isAssignableFrom(java.security.spec.ECPrivateKeySpec.class)
  ...
  protected PublicKey engineGeneratePublic(
    ...
    if (keySpec instanceof ECPublicKeySpec) {
      return new BCDSTU4145PublicKey((ECPublicKeySpec) keySpec, LinLongProvider.CONFIGURATION);
  ...
  public PrivateKey generatePrivate(PrivateKeyInfo keyInfo)
    ...
    if (algOid.equals(UAObjectIdentifiers.dstu4145le) || algOid.equals(
