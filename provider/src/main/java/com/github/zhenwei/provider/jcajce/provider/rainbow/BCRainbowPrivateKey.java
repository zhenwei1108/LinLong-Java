...
import com.github.zhenwei.core.pqc.asn1.RainbowPrivateKey;
import com.github.zhenwei.core.pqc.crypto.rainbow.Layer;
...
import com.github.zhenwei.provider.jcajce.spec.RainbowPrivateKeySpec;
import java.io.IOException;
import java.security.PrivateKey;
import java.util.Arrays;

/**
 * The Private key in Rainbow consists of the linear affine maps L1, L2 and the map F, consisting of
 * quadratic polynomials. In this implementation, we denote: L1 = A1*x + b1 L2 = A2*x + b2
 * <p>
 * The coefficients of the polynomials in F are stored in 3-dimensional arrays per layer. The
 * indices of these arrays denote the polynomial, and the variables.
 * </p><p>
 * More detailed information about the private key is to be found in the paper of Jintai Ding,
 * Dieter Schmidt: Rainbow, a New Multivariable Polynomial Signature Scheme. ACNS 2005: 164-175
...
public class BCRainbowPrivateKey
  ...
  public BCRainbowPrivateKey(
    ...
    this(params.getInvA1(), params.getB1(), params.getInvA2(), params.getB2(), params.getVi(),
        params.getLayers());
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 37 + com.github.zhenwei.core.util.Arrays.hashCode(A1inv);
    hash = hash * 37 + com.github.zhenwei.core.util.Arrays.hashCode(b1);
    hash = hash * 37 + com.github.zhenwei.core.util.Arrays.hashCode(A2inv);
    hash = hash * 37 + com.github.zhenwei.core.util.Arrays.hashCode(b2);
    hash = hash * 37 + com.github.zhenwei.core.util.Arrays.hashCode(vi);
