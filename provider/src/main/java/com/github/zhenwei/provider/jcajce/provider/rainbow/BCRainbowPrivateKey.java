    ...
    implements PrivateKey
{
    ...
    {
        if (other == null || !(other instanceof org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey))
        {
            return false;
        }
        org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey otherKey = (org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey)other;
