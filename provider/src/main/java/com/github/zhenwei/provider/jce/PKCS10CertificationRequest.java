 ...
 * </pre>
 *
 * @deprecated use classes in com.github.zhenwei.pkix.pkcs.
 */
public class PKCS10CertificationRequest
  ...
  public PKCS10CertificationRequest(
    ...
    try {
      ...
      this.reqInfo = new CertificationRequestInfo(subject, SubjectPublicKeyInfo.getInstance(seq),
          attributes);
    } catch (IOException e) {
  ...
  /**
   * return the public key associated with the certification request - the public key is created
   * using the BC provider.
   */
  public PublicKey getPublicKey()
      throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
    return getPublicKey(LinLongProvider.PROVIDER_NAME);
  }
  ...
  public PublicKey getPublicKey(
    ...
    try {
      X509EncodedKeySpec xspec = new X509EncodedKeySpec(
          new DERBitString(subjectPKInfo).getOctets());
  ...
  public boolean verify()
      throws NoSuchAlgorithmException, NoSuchProviderException,
      InvalidKeyException, SignatureException {
    return verify(LinLongProvider.PROVIDER_NAME);
  }
