    ...
    implements PublicKey
{
    ...
    {
        if (other == null || !(other instanceof org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey))
        {
            return false;
        }
        org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey otherKey = (org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey)other;
