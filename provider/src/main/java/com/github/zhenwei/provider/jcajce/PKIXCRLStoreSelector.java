...
public class PKIXCRLStoreSelector<T extends CRL>
  ...
  public static class Builder {
     ...
     * <p>
     * The issuing distribution point extension is a CRL extension which identifies the scope and
     * the distribution point of a CRL. The scope contains among others information about revocation
     ...
     *
     * @param issuingDistributionPoint The issuing distribution point to set. This is the DER
     *                                 encoded OCTET STRING extension value.
  ...
  public static Collection<? extends CRL> getCRLs(final PKIXCRLStoreSelector selector,
      CertStore certStore)
