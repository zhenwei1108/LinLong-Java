...
import com.github.zhenwei.core.pqc.crypto.mceliece.McElieceCCA2KeyParameters;
import com.github.zhenwei.core.pqc.crypto.mceliece.McEliecePointchevalCipher;
import com.github.zhenwei.provider.jcajce.provider.util.AsymmetricHybridCipher;
...
public class McEliecePointchevalCipherSpi
  ...
  public int getKeySize(Key key)
    ...
    if (key instanceof PublicKey) {
      mcElieceCCA2KeyParameters = (McElieceCCA2KeyParameters) McElieceCCA2KeysToParams.generatePublicKeyParameter(
          (PublicKey) key);
    } else {
      mcElieceCCA2KeyParameters = (McElieceCCA2KeyParameters) McElieceCCA2KeysToParams.generatePrivateKeyParameter(
          (PrivateKey) key);
    }
