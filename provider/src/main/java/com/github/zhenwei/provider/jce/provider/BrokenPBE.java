    ...
    static class Util
    {
            ...
            int                     hash)
        {
            ...
            else if (type == OLD_PKCS12)
            {
                ...
                {
                case MD5:
                    generator = new org.bouncycastle.jce.provider.OldPKCS12ParametersGenerator(new MD5Digest());
                    break;
                case SHA1:
                    generator = new org.bouncycastle.jce.provider.OldPKCS12ParametersGenerator(new SHA1Digest());
                    break;
                case RIPEMD160:
                    generator = new org.bouncycastle.jce.provider.OldPKCS12ParametersGenerator(new RIPEMD160Digest());
                    break;
                default:
