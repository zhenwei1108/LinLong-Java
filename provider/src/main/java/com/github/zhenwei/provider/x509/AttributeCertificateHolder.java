...
import com.github.zhenwei.core.asn1.x509.Holder;
import com.github.zhenwei.core.asn1.x509.IssuerSerial;
import com.github.zhenwei.core.asn1.x509.ObjectDigestInfo;
import com.github.zhenwei.core.util.Arrays;
import com.github.zhenwei.core.util.Selector;
import com.github.zhenwei.provider.jce.PrincipalUtil;
 ...
 * </pre>
 *
 * @deprecated use com.github.zhenwei.pkix.cert.AttributeCertificateHolder
 */
public class AttributeCertificateHolder
  ...
  public AttributeCertificateHolder(X509Principal issuerName,
    ...
    holder = new com.github.zhenwei.core.asn1.x509.Holder(new IssuerSerial(
  ...
  public AttributeCertificateHolder(int digestedObjectType,
    ...
    holder = new Holder(new ObjectDigestInfo(digestedObjectType,
        ...
        new AlgorithmIdentifier(new ASN1ObjectIdentifier(digestAlgorithm)), Arrays
        .clone(objectDigest)));
  }
   ...
   *
   * @return an array of Principal objects (usually X500Principal), null if no entity names field is
   * set.
   */
  ...
  public boolean match(Certificate cert) {
    ...
    try {
      ...
      if (holder.getObjectDigestInfo() != null) {
        ...
        try {
          md = MessageDigest.getInstance(getDigestAlgorithm(), "WeGoo");
