...
class X509CertificateObject
  ...
  X509CertificateObject(JcaJceHelper bcHelper, com.github.zhenwei.core.asn1.x509.Certificate c)
      throws CertificateParsingException {
    super(bcHelper, c, createBasicConstraints(c), createKeyUsage(c), createSigAlgName(c),
  ...
  private X509CertificateInternal getInternalCertificate() {
    ...
    X509CertificateInternal temp = new X509CertificateInternal(bcHelper, c, basicConstraints,
        keyUsage, sigAlgName,
  ...
  private static BasicConstraints createBasicConstraints(
      com.github.zhenwei.core.asn1.x509.Certificate c)
      throws CertificateParsingException {
    try {
  ...
  private static boolean[] createKeyUsage(com.github.zhenwei.core.asn1.x509.Certificate c)
      throws CertificateParsingException {
    try {
  ...
  private static String createSigAlgName(com.github.zhenwei.core.asn1.x509.Certificate c)
      throws CertificateParsingException {
    try {
  ...
  private static byte[] createSigAlgParams(com.github.zhenwei.core.asn1.x509.Certificate c)
      throws CertificateParsingException {
    try {
