    ...
    implements PKCS12BagAttributeCarrier
{
    ...
    private static BasicConstraints createBasicConstraints(com.github.zhenwei.core.asn1.x509.Certificate c)
        throws CertificateParsingException
    {
        try
        {
    ...
    private static String createSigAlgName(com.github.zhenwei.core.asn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
    ...
    private static byte[] createSigAlgParams(com.github.zhenwei.core.asn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
