...
import com.github.zhenwei.core.crypto.generators.ElGamalKeyPairGenerator;
...
public class KeyPairGeneratorSpi
  ...
  public void initialize(
    ...
    if (params instanceof ElGamalParameterSpec) {
      ...
      param = new ElGamalKeyGenerationParameters(random,
          new ElGamalParameters(elParams.getP(), elParams.getG()));
    } else {
  ...
  public KeyPair generateKeyPair() {
    if (!initialised) {
      DHParameterSpec dhParams = LinLongProvider.CONFIGURATION.getDHDefaultParameters(
          strength);
