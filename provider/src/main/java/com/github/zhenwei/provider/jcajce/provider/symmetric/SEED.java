...
import com.github.zhenwei.core.crypto.engines.SEEDEngine;
import com.github.zhenwei.core.crypto.engines.SEEDWrapEngine;
...
public final class SEED {
  ...
  public static class Poly1305
    ...
    public Poly1305() {
      super(new com.github.zhenwei.core.crypto.macs.Poly1305(new SEEDEngine()));
    }
  }
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("Alg.Alias.AlgorithmParameters." + KISAObjectIdentifiers.id_seedCBC,
          "SEED");

      provider.addAlgorithm("AlgorithmParameterGenerator.SEED", PREFIX + "$AlgParamGen");
      provider.addAlgorithm(
          "Alg.Alias.AlgorithmParameterGenerator." + KISAObjectIdentifiers.id_seedCBC, "SEED");
      ...
      provider.addAlgorithm("Alg.Alias.Cipher", KISAObjectIdentifiers.id_npki_app_cmsSeed_wrap,
          "SEEDWRAP");
      ...
      provider.addAlgorithm("KeyGenerator", KISAObjectIdentifiers.id_npki_app_cmsSeed_wrap,
          PREFIX + "$KeyGen");
