    ...
    extends KeyStoreSpi
{
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (helper != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(com.github.zhenwei.core.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
        ...
        throws CertificateEncodingException
    {
        ...
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = com.github.zhenwei.core.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
