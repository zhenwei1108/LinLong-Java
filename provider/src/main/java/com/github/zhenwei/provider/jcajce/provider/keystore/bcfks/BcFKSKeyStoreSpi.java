...
import ObjectData;
import ObjectDataSequence;
import ObjectStore;
import ObjectStoreData;
import ObjectStoreIntegrityCheck;
    ...
    extends KeyStoreSpi
{
        ...
        extends AdaptingKeyStoreSpi
    {
        public StdCompat()
        {
            super(new DefaultJcaJceHelper(), new org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi(new BCJcaJceHelper()));
        }
    }
        ...
        extends AdaptingKeyStoreSpi
    {
        public DefCompat()
        {
            super(new DefaultJcaJceHelper(), new org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi(new DefaultJcaJceHelper()));
        }
    }
        ...
        extends AdaptingKeyStoreSpi
    {
        ...
        {
            super(new BCJcaJceHelper(), new org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi(new BCJcaJceHelper()));
        }
    }
