...
/**
 * This class provides methods for setting and getting the Rainbow-parameters like number of
 * Vinegar-variables in the layers, number of layers and so on.
 * <p>
 * More detailed information about the needed parameters for the Rainbow Signature Scheme is to be
 * found in the paper of Jintai Ding, Dieter Schmidt: Rainbow, a New Multivariable Polynomial
...
public class RainbowParameterSpec
  ...
  /**
   * Default Constructor The elements of the array containing the number of Vinegar variables in
   * each layer are set to the default values here.
   */
   ...
   *
   * @param vi The elements of the array containing the number of Vinegar variables per layer are
   *           set to the values of the input array.
