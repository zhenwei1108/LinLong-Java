...
public interface X509ObjectIdentifiers {
  ...
  static final ASN1ObjectIdentifier id_at_organizationIdentifier = new ASN1ObjectIdentifier(
      "2.5.4.97").intern();

  /**
   * id-SHA1 OBJECT IDENTIFIER ::= {iso(1) identified-organization(3) oiw(14) secsig(3)
   * algorithms(2) 26 }
   * <p>
   * OID: 1.3.14.3.2.27
   */
  ...
  /**
   * ripemd160 OBJECT IDENTIFIER ::= {iso(1) identified-organization(3) TeleTrust(36) algorithm(3)
  ...
  /**
   * ripemd160WithRSAEncryption OBJECT IDENTIFIER ::= {iso(1) identified-organization(3)
   * TeleTrust(36) algorithm(3) signatureAlgorithm(3) rsaSignature(1) rsaSignatureWithripemd160(2)
   * }
   * <p>
   * OID: 1.3.36.3.3.1.2
   */
  static final ASN1ObjectIdentifier ripemd160WithRSAEncryption = new ASN1ObjectIdentifier(
      "1.3.36.3.3.1.2").intern();
  ...
  /**
   * id-RSASSA-PSS-SHAKE128  OBJECT IDENTIFIER  ::=  { iso(1) identified-organization(3) dod(6)
   * internet(1) security(5) mechanisms(5) pkix(7) algorithms(6) 30 }
   */
  static final ASN1ObjectIdentifier id_rsassa_pss_shake128 = id_pkix.branch("6.30");

  /**
   * id-RSASSA-PSS-SHAKE256  OBJECT IDENTIFIER  ::=  { iso(1) identified-organization(3) dod(6)
   * internet(1) security(5) mechanisms(5) pkix(7) algorithms(6) 31 }
   */
  static final ASN1ObjectIdentifier id_rsassa_pss_shake256 = id_pkix.branch("6.31");

  /**
   * id-ecdsa-with-shake128 OBJECT IDENTIFIER  ::=  { iso(1) identified-organization(3) dod(6)
   * internet(1) security(5) mechanisms(5) pkix(7) algorithms(6) 32 }
   */
  static final ASN1ObjectIdentifier id_ecdsa_with_shake128 = id_pkix.branch("6.32");

  /**
   * id-ecdsa-with-shake256 OBJECT IDENTIFIER  ::=  { iso(1) identified-organization(3) dod(6)
   * internet(1) security(5) mechanisms(5) pkix(7) algorithms(6) 33 }
   */
