...
/**
 * Parameters holder for private unified static/ephemeral agreement as described in NIST SP
 * 800-56A.
 */
public class ECDHUPrivateParameters
  ...
  public ECDHUPrivateParameters(
    ...
    if (ephemeralPublicKey == null) {
      ECPoint q = new FixedPointCombMultiplier().multiply(parameters.getG(),
          ephemeralPrivateKey.getD());
