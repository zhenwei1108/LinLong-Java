...
public class NTRUEngine
  ...
  protected IntegerPolynomial encrypt(IntegerPolynomial m, TernaryPolynomial r,
  ...
  private Polynomial generateBlindingPoly(byte[] seed, byte[] M) {
    ...
    if (params.polyType == NTRUParameters.TERNARY_POLYNOMIAL_TYPE_PRODUCT) {
      SparseTernaryPolynomial r1 = new SparseTernaryPolynomial(
          generateBlindingCoeffs(ig, params.dr1));
      SparseTernaryPolynomial r2 = new SparseTernaryPolynomial(
          generateBlindingCoeffs(ig, params.dr2));
      SparseTernaryPolynomial r3 = new SparseTernaryPolynomial(
          generateBlindingCoeffs(ig, params.dr3));
   ...
   */
  protected IntegerPolynomial decrypt(IntegerPolynomial e, Polynomial priv_t,
