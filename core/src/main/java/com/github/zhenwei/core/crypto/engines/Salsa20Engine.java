...
import com.github.zhenwei.core.crypto.MaxBytesExceededException;
import com.github.zhenwei.core.crypto.OutputLengthException;
import com.github.zhenwei.core.crypto.SkippingStreamCipher;
  ...
  public void init(
    ...
    if (!(params instanceof ParametersWithIV)) {
      throw new IllegalArgumentException(
          getAlgorithmName() + " Init parameters must include an IV");
    }
