...
/**
 * an implementation of Rijndael, based on the documentation and reference implementation by Paulo
 * Barreto, Vincent Rijmen, for v2.0 August '99.
 * <p>
...
public class RijndaelEngine
  ...
  private static final byte[] aLogtable = {
      ...
      (byte) 127, (byte) 129, (byte) 152, (byte) 179, (byte) 206, (byte) 73, (byte) 219, (byte) 118,
      (byte) 154,
