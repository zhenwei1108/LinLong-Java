...
/**
 * A class which converts integers to byte arrays, allowing padding and calculations to be done
 * according the the filed size of the curve or field element involved.
 */
