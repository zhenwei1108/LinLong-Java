...
/**
 * Builder and holder class for preparing SP 800-56A compliant OtherInfo. The data is ultimately
 * encoded as a DER SEQUENCE. Empty octet strings are used to represent nulls in compulsory fields.
 */
