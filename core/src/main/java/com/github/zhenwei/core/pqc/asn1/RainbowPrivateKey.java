    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.RainbowPrivateKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.RainbowPrivateKey)
        {
            return (org.bouncycastle.pqc.asn1.RainbowPrivateKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.RainbowPrivateKey(ASN1Sequence.getInstance(o));
        }
