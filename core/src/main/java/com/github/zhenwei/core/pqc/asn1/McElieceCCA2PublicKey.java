    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.McElieceCCA2PublicKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.McElieceCCA2PublicKey)
        {
            return (org.bouncycastle.pqc.asn1.McElieceCCA2PublicKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.McElieceCCA2PublicKey(ASN1Sequence.getInstance(o));
        }
