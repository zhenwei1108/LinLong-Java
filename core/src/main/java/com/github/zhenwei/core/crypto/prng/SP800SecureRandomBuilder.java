...
public class SP800SecureRandomBuilder
{
     ...
     */
    public org.bouncycastle.crypto.prng.SP800SecureRandomBuilder setPersonalizationString(byte[] personalizationString)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.crypto.prng.SP800SecureRandomBuilder setSecurityStrength(int securityStrength)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.crypto.prng.SP800SecureRandomBuilder setEntropyBitsRequired(int entropyBitsRequired)
    {
