 ...
 * McEliecePKCS which is CCA2-secure. For details, see D. Engelbert, R. Overbeck, A. Schmidt, "A
 * Summary of McEliece-Type Cryptosystems and their Security", technical report.
...
public class McElieceKobaraImaiCipher
  ...
  public byte[] messageDecrypt(byte[] input)
    ...
    GF2Vector[] c4z = McElieceCCA2Primitives.decryptionPrimitive(
