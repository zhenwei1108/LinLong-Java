  ...
  public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter privateKey,
    ...
    if (privateKey instanceof RSAKeyParameters) {
      ...
      return new PrivateKeyInfo(
          ...
          new RSAPrivateKey(priv.getModulus(), priv.getPublicExponent(), priv.getExponent(),
      ...
      if (domainParams == null) {
        ...
        orderBitLength = priv.getD()
            .bitLength();   // TODO: this is as good as currently available, must be a better way...
