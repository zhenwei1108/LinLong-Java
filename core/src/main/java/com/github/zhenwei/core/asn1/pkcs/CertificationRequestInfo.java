...
public class CertificationRequestInfo
   ...
   * Basic constructor.
   * <p>
   * Note: Early on a lot of CAs would only accept messages with attributes missing. As the ASN.1
   * def shows the attributes field is not optional so should always at least contain an empty set.
   * If a fully compliant request is required, pass in an empty set, the class will otherwise
   * interpret a null as it should encode the request with the field missing.
   * </p>
   *
