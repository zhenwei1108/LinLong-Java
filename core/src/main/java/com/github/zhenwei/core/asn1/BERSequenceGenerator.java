...
public class BERSequenceGenerator
  ...
  /**
   * Use the passed in stream as the target for the generator, writing out the header tag for a
  ...
  /**
   * Use the passed in stream as the target for the generator, writing out the header tag for a
   * tagged constructed SEQUENCE (possibly implicit).
   *
   * @param out        target stream
   ...
   * @throws IOException if the target stream cannot be written to or the primitive cannot be
   *                     encoded.
   */
