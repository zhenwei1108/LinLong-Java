...
public class GF2mVector
  ...
  /**
   * creates the vector over GF(2^m) of given length and with elements from array v (beginning at
   * the first bit)
   *
  ...
  /**
   * Create a new vector over <tt>GF(2<sup>m</sup>)</tt> of the given length and element array.
   *
   ...
   * @throws ArithmeticException if the other vector is not defined over the same field as this
   *                             vector.
   *                             <p>
