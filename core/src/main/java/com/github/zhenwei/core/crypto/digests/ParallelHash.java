...
/**
 * ParallelHash - a hash designed  to  support the efficient hashing of very long strings, by taking
 * advantage of the parallelism available in modern processors with an optional XOF mode.
 * <p>
 * From NIST Special Publication 800-185 - SHA-3 Derived Functions:cSHAKE, KMAC, TupleHash and
 * ParallelHash
 * </p>
 */
