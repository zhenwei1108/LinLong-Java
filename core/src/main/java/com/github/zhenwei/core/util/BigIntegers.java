...
public final class BigIntegers {
  ...
  /**
   * Write the passed in value as unsigned bytes to the specified buffer range, padded with leading
   * zeros as necessary.
   *
   * @param value the value to be converted.
  ...
  private static final BigInteger SMALL_PRIMES_PRODUCT = new BigInteger(
      ...
      16);
  private static final int MAX_SMALL = BigInteger.valueOf(743)
      .bitLength(); // bitlength of 743 * 743
