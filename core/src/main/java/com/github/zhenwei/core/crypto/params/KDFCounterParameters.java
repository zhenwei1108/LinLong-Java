...
/**
 * This KDF has been defined by the publicly available NIST SP 800-108 specification. NIST SP800-108
 * allows for alternative orderings of the input fields, meaning that the input can be formated in
 * multiple ways. There are 3 supported formats:  - Below [i]_2 is a counter of r-bits length
 * concatenated to the fixedInputData.
 * <ul>
...
public final class KDFCounterParameters
   ...
   * @param r                           length of the counter in bits.
   */
  public KDFCounterParameters(byte[] ki, byte[] fixedInputDataCounterPrefix,
      byte[] fixedInputDataCounterSuffix, int r) {
    if (ki == null) {
