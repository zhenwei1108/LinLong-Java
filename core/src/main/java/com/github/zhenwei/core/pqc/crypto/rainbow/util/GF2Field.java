...
/**
 * This class provides the basic operations like addition, multiplication and finding the
 * multiplicative inverse of an element in GF2^8.
 * <p>
 * The operations are implemented using the irreducible polynomial 1+x^2+x^3+x^6+x^8 ( 1 0100 1101 =
 * 0x14d )
 * <p>
 * This class makes use of lookup tables(exps and logs) for implementing the operations in order to
 * increase the efficiency of Rainbow.
 */
public class GF2Field {
  ...
  /**
   * This function computes the multiplicative inverse of a given element in GF2^8 The 0 has no
   * multiplicative inverse and in this case 0 is returned.
   *
   * @param x the element which multiplicative inverse is to be computed
   * @return the multiplicative inverse of the given element, in case it exists or 0, otherwise
   */
  ...
  /**
   * This function multiplies two elements in GF2^8. If one of the two elements is 0, 0 is
   * returned.
   *
