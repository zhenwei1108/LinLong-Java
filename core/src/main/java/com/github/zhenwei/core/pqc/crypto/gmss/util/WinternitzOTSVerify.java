...
/**
 * This class implements signature verification of the Winternitz one-time signature scheme (OTSS),
 * described in C.Dods, N.P. Smart, and M. Stam, "Hash Based Digital Signature Schemes", LNCS 3796,
 * pages 96&#8211;115, 2005. The class is used by the GMSS classes.
 */
public class WinternitzOTSVerify {
   ...
   * The constructor
   *
   * @param digest the name of the hash function used by the OTS and the provider name of the hash
   *               function
  ...
  /**
   * This method computes the public OTS key from the one-time signature of a message. This is *NOT*
   * a complete OTS signature verification, but it suffices for usage with CMSS.
   *
   ...
   * @return The least integer greater or equal to the logarithm to the base 256 of
   * <code>intValue</code>
   */
