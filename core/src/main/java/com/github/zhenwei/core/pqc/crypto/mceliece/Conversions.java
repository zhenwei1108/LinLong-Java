...
final class Conversions {
  ...
  /**
   * Decode a binary vector of length n and weight t into a number between 0 and (n|t) (binomial
   * coefficient). The result is given as a byte array of length floor[(s+7)/8], where s =
   * floor[log(n|t)].
   *
   * @param n   integer
   * @param t   integer
