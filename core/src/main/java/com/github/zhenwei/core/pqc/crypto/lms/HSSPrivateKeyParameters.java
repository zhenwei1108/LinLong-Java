    ...
    implements LMSContextBasedSigner
{
    ...
    public static org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters getInstance(byte[] privEnc, byte[] pubEnc)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        else if (src instanceof DataInputStream)
        {
            ...
            return new org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters(d, keys, signatures, index, maxIndex, limited);
        }
        ...
        org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters privateKeyParameters)
    {
        try
        {
            return org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters.getInstance(privateKeyParameters.getEncoded());
        }
        catch (Exception ex)
        {
    ...
    public org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters extractKeyShard(int usageCount)
    {
        synchronized (this)
        {
            ...
            org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters shard = makeCopy(new org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters(l, keys, sig, shardStartIndex, maxIndexForShard, true));
