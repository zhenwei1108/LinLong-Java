...
public class HKDFParameters
  ...
  /**
   * Generates parameters for HKDF, specifying both the optional salt and optional info. Step 1:
   * Extract won't be skipped.
   *
   ...
   *
   * @param ikm  the input keying material or seed, directly used for step 2: Expand
   * @param info the info to use, may be null for an info field of zero bytes
