    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.RainbowPublicKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.RainbowPublicKey)
        {
            return (org.bouncycastle.pqc.asn1.RainbowPublicKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.RainbowPublicKey(ASN1Sequence.getInstance(o));
        }
