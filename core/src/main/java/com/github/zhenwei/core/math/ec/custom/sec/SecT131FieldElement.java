...
//    }
    ...
    public ECFieldElement add(ECFieldElement b)
    {
        ...
        SecT131Field.add(x, ((org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT131FieldElement(z);
    }
    ...
    {
        long[] z = Nat192.create64();
        SecT131Field.multiply(x, ((org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT131FieldElement(z);
    }
    ...
    {
        long[] ax = this.x, bx = ((org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)b).x;
        long[] xx = ((org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)x).x, yx = ((org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)y).x;
    ...
    public boolean equals(Object other)
    {
        ...
        if (!(other instanceof org.bouncycastle.math.ec.custom.sec.SecT131FieldElement))
        {
            return false;
        }

        org.bouncycastle.math.ec.custom.sec.SecT131FieldElement o = (org.bouncycastle.math.ec.custom.sec.SecT131FieldElement)other;
