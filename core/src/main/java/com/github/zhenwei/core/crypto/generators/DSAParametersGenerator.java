...
public class DSAParametersGenerator {
   ...
   * @param certainty measure of robustness of prime (for FIPS 186-2 compliance this should be at
   *                  least 80).
  ...
  private static BigInteger calculateGenerator_FIPS186_2(BigInteger p, BigInteger q,
      SecureRandom r) {
...
//        return !Primes.hasAnySmallFactors(x) && Primes.isMRProbablePrime(x, random, iterations);
  ...
  private static BigInteger calculateGenerator_FIPS186_3_Verifiable(Digest d, BigInteger p,
      BigInteger q,
      byte[] seed, int index) {
