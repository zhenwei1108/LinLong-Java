...
public interface TeleTrusTObjectIdentifiers {
   ...
   * 1.3.36.3.3.1
   */
  static final ASN1ObjectIdentifier teleTrusTRSAsignatureAlgorithm = teleTrusTAlgorithm.branch(
      "3.1");

  /**
   * 1.3.36.3.3.1.2
   */
  static final ASN1ObjectIdentifier rsaSignatureWithripemd160 = teleTrusTRSAsignatureAlgorithm.branch(
      "2");
  /**
   * 1.3.36.3.3.1.3
   */
  static final ASN1ObjectIdentifier rsaSignatureWithripemd128 = teleTrusTRSAsignatureAlgorithm.branch(
      "3");
  /**
   * 1.3.36.3.3.1.4
   */
  static final ASN1ObjectIdentifier rsaSignatureWithripemd256 = teleTrusTRSAsignatureAlgorithm.branch(
      "4");
