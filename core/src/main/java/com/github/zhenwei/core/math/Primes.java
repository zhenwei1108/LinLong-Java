...
public abstract class Primes
{
     ...
     * {@linkplain org.bouncycastle.math.Primes#enhancedMRProbablePrimeTest(BigInteger, SecureRandom, int) Enhanced
    ...
    /**
     * Used to return the output from the
     * {@linkplain org.bouncycastle.math.Primes#generateSTRandomPrime(Digest, int, byte[]) Shawe-Taylor Random_Prime
     * Routine}
     */
