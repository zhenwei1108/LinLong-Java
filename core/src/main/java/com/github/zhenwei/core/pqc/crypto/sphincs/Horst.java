...
class Horst
{
    ...
    static final int N_MASKS = (2*(org.bouncycastle.pqc.crypto.sphincs.Horst.HORST_LOGT)); /* has to be the max of  (2*(SUBTREE_HEIGHT+WOTS_LOGL)) and (WOTS_W-1) and 2*HORST_LOGT */
