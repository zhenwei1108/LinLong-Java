...
public class LocalizedMessage {
   ...
   * @throws NullPointerException         if <code>resource</code> or <code>id</code> is
   *                                      <code>null</code>
  ...
  /**
   * Reads the entry <code>id + "." + key</code> from the resource file and returns a formated
   * message for the given Locale and TimeZone.
   *
   ...
   * @throws MissingEntryException if the resource file is not available or the entry does not
   *                               exist.
   */
  public String getEntry(String key, Locale loc, TimeZone timezone) throws MissingEntryException {
    ...
    try {
      ...
      throw new MissingEntryException(
          "Can't find entry " + entry + " in resource file " + resource + ".",
          resource,
          entry,
          loc,
  ...
  /**
   * Returns the {@link ClassLoader} which loads the resource files or <code>null</code> if the
