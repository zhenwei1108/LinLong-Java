    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.ua.DSTU4145ECBinary getInstance(Object obj)
    {
        ...
        if (obj != null)
        {
            return new org.bouncycastle.asn1.ua.DSTU4145ECBinary(ASN1Sequence.getInstance(obj));
        }
