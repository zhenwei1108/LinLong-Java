...
/**
 * Wrapper class that reduces the output length of a particular digest to only the first n bytes of
 * the digest function.
 */
public class ShortenedDigest
   ...
   * @throws IllegalArgumentException if baseDigest is null, or length is greater than
