    ...
    extends Vector
{
    ...
    /**
     * Construct a new {@link org.bouncycastle.pqc.math.linearalgebra.GF2Vector} of the given length and with the given
    ...
    public static org.bouncycastle.pqc.math.linearalgebra.GF2Vector OS2VP(int length, byte[] encVec)
    {
        ...
        return new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(length, LittleEndianConversions.toIntArray(encVec));
    }
    ...
    public Vector multiply(Permutation p)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Vector result = new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(length);
    ...
    public org.bouncycastle.pqc.math.linearalgebra.GF2Vector extractVector(int[] setJ)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Vector result = new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(k);
     ...
     * @return a new {@link org.bouncycastle.pqc.math.linearalgebra.GF2Vector} consisting of the first <tt>k</tt>
     ...
     *
     * @param k the number of elements to extract
     * @return a new {@link org.bouncycastle.pqc.math.linearalgebra.GF2Vector} consisting of the last <tt>k</tt>
     *         elements of this vector
     */
