...
/**
 * Password hashing scheme BCrypt, designed by Niels Provos and David Mazières, using the String
 * format and the Base64 encoding of the reference implementation on OpenBSD
 */
public class OpenBSDBCrypt {
  ...
  /**
   * Creates a 60 character Bcrypt String, including version, cost factor, salt and hash, separated
   * by '$' using version '2y'.
   *
   ...
   *
   * @param bcryptString a 60 character Bcrypt String, including version, cost factor, salt and
   *                     hash, separated by '$'
  ...
  private static byte[] decodeSaltString(
    ...
    {
      throw new DataLengthException(
          "Invalid base64 salt length: " + saltChars.length + " , 22 required.");
    }
