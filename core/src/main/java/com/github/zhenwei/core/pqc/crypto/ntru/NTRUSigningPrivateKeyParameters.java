 ...
 * zeroth basis for which <code>h</code> is undefined.
 */
public class NTRUSigningPrivateKeyParameters
  ...
  public NTRUSigningPrivateKeyParameters(List<Basis> bases,
  ...
  public static class Basis {
     ...
     * @param is        an input stream
     * @param params    NtruSign parameters
     * @param include_h whether to read the polynomial <code>h</code> (<code>true</code>) or only
     *                  <code>f</code> and <code>f'</code> (<code>false</code>)
     */
     ...
     *
     * @param os        an output stream
     * @param include_h whether to write the polynomial <code>h</code> (<code>true</code>) or only
     *                  <code>f</code> and <code>f'</code> (<code>false</code>)
     * @throws IOException
     */
