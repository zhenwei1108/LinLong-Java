    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.McEliecePublicKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.McEliecePublicKey)
        {
            return (org.bouncycastle.pqc.asn1.McEliecePublicKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.McEliecePublicKey(ASN1Sequence.getInstance(o));
        }
