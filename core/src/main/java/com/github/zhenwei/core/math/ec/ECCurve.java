...
public abstract class ECCurve {
   ...
   * each z coordinate is scaled by this value prior to normalization (but only one actual
   ...
   * of, including point compression for
    ...
    return new AbstractECLookupTable() {
      ...
      private ECPoint createPoint(byte[] x, byte[] y) {
        return createRawPoint(fromBigInteger(new BigInteger(1, x)),
            fromBigInteger(new BigInteger(1, y)));
      }
    };
  }
  ...
  public static class Fp extends AbstractFp {
    ...
    public ECPoint importPoint(ECPoint p) {
      if (this != p.getCurve() && this.getCoordinateSystem() == ECCurve.COORD_JACOBIAN
          && !p.isInfinity()) {
...
//                }
    ...
    public boolean isKoblitz() {
      return this.order != null && this.cofactor != null && this.b.isOne() && (this.a.isZero()
          || this.a.isOne());
    }
  ...
  public static class F2m extends AbstractF2m {
    ...
    /**
     * TPB: The integer <code>k</code> where <code>x<sup>m</sup> + x<sup>k</sup> + 1</code>
     * represents the reduction polynomial
     * <code>f(z)</code>.<br>
     * PPB: The integer <code>k1</code> where <code>x<sup>m</sup> + x<sup>k3</sup> + x<sup>k2</sup>
     * + x<sup>k1</sup> + 1</code> represents the reduction polynomial <code>f(z)</code>.<br>
     */
    private int k1;  // can't be final - JDK 1.1

    /**
     * TPB: Always set to <code>0</code><br> PPB: The integer <code>k2</code> where
     * <code>x<sup>m</sup> + x<sup>k3</sup> + x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents
     * the reduction polynomial <code>f(z)</code>.<br>
     */
    private int k2;  // can't be final - JDK 1.1

    /**
     * TPB: Always set to <code>0</code><br> PPB: The integer <code>k3</code> where
     * <code>x<sup>m</sup> + x<sup>k3</sup> + x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents
     * the reduction polynomial <code>f(z)</code>.<br>
     */
     ...
     * @param a The coefficient <code>a</code> in the Weierstrass equation for non-supersingular
     *          elliptic curves over
     *          <code>F<sub>2<sup>m</sup></sub></code>.
     * @param b The coefficient <code>b</code> in the Weierstrass equation for non-supersingular
     *          elliptic curves over
     *          <code>F<sub>2<sup>m</sup></sub></code>.
     * @deprecated use constructor taking order/cofactor
     */
     ...
     * @param m        The exponent <code>m</code> of
     *                 <code>F<sub>2<sup>m</sup></sub></code>.
     * @param k        The integer <code>k</code> where <code>x<sup>m</sup> + x<sup>k</sup> +
     *                 1</code> represents the reduction polynomial <code>f(z)</code>.
     ...
     * @param m  The exponent <code>m</code> of
     *           <code>F<sub>2<sup>m</sup></sub></code>.
     * @param k1 The integer <code>k1</code> where <code>x<sup>m</sup> + x<sup>k3</sup> +
     *           x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents the reduction polynomial
     *           <code>f(z)</code>.
     * @param k2 The integer <code>k2</code> where <code>x<sup>m</sup> + x<sup>k3</sup> +
     *           x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents the reduction polynomial
     *           <code>f(z)</code>.
     * @param k3 The integer <code>k3</code> where <code>x<sup>m</sup> + x<sup>k3</sup> +
     *           x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents the reduction polynomial
     *           <code>f(z)</code>.
     * @param a  The coefficient <code>a</code> in the Weierstrass equation for non-supersingular
     *           elliptic curves over
     ...
     *                 <code>F<sub>2<sup>m</sup></sub></code>.
     * @param k1       The integer <code>k1</code> where <code>x<sup>m</sup> + x<sup>k3</sup> +
     *                 x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents the reduction
