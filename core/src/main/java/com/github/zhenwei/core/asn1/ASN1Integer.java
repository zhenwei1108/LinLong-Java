...
public class ASN1Integer
   ...
   * </p>
   * <p>
   * It has turned out that there are still a few applications that struggle with the ASN.1 BER
   * encoding rules for an INTEGER as described in:
   * <p>
   * https://www.itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf Section 8.3.2.
   * </p>
   * <p>
   * Users can set the 'com.github.zhenwei.core.asn1.allow_unsafe_integer' to 'true' and a looser
   * validation will be applied. Users must recognise that this is not ideal and may pave the way
   * for an exploit based around a faulty encoding in the future.
   * </p>
   *
    ...
    switch (bytes.length) {
      ...
      default:
        return bytes[0] == (bytes[1] >> 7)
            ...
            && !Properties.isOverrideSet("com.github.zhenwei.core.asn1.allow_unsafe_integer");
    }
  }
