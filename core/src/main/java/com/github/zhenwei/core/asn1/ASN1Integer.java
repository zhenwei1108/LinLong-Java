...
public class ASN1Integer
   ...
   * </p>
   * <p>
   * Users can set the 'allow_unsafe_integer' to 'true' and a looser validation will be applied.
   * Users must recognise that this is not ideal and may pave the way for an exploit based around a
   * faulty encoding in the future.
   * </p>
   *
