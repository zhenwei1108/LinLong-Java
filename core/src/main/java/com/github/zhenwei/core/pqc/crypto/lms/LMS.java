...
class LMS {
  ...
  public static LMSSignature generateSign(LMSContext context) {
    ...
    // Step 1.
    LMOtsSignature ots_signature = LM_OTS.lm_ots_generate_signature(context.getPrivateKey(),
        context.getQ(), context.getC());
...
//    }
  ...
  public static boolean verifySignature(LMSPublicKeyParameters publicKey, LMSSignature S,
      byte[] message) {
  ...
  public static boolean verifySignature(LMSPublicKeyParameters publicKey, byte[] S,
      byte[] message) {
