...
public class BlockCipherMac
  ...
  /**
   * create a standard MAC based on a block cipher. This will produce an authentication code half
   ...
   * <p>
   * Note: the size of the MAC must be at least 16 bits (FIPS Publication 113), and in general
   * should be less than the size of the block cipher as it reduces the chance of an exhaustive
   * attack (see Handbook of Applied Cryptography).
   *
   * @param cipher        the cipher to be used as the basis of the MAC generation.
