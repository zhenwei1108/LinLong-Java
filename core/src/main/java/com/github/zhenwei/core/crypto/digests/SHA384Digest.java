    ...
    extends LongDigest
{
     ...
     * message digest.
     */
    public SHA384Digest(org.bouncycastle.crypto.digests.SHA384Digest t)
    {
        super(t);
    }
    ...
    {
        org.bouncycastle.crypto.digests.SHA384Digest d = (org.bouncycastle.crypto.digests.SHA384Digest)other;
