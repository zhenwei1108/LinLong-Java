...
public class G3413CTRBlockCipher
   ...
   * Basic constructor.
   *
   * @param cipher the block cipher to be used as the basis of the counter mode (must have a 64 bit
   *               block size).
   */
   ...
   * Basic constructor.
   *
   * @param cipher       the block cipher to be used as the basis of the counter mode (must have a
   *                     64 bit block size).
   ...
   *
   * @return the name of the underlying algorithm followed by "/GCTR" and the block size in bits
   */
