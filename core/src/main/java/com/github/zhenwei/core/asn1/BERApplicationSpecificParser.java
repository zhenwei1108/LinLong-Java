 ...
 *
 * @deprecated Test for {@link ASN1TaggedObjectParser} with {@link ASN1TaggedObjectParser#getTagClass()
 * tag class} of {@link BERTags#APPLICATION} instead.
 */
public class BERApplicationSpecificParser
   ...
   * @throws IOException if the underlying stream cannot be read, or does not contain an ASN.1
   *                     encoding.
   */
