    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.McEliecePrivateKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.McEliecePrivateKey)
        {
            return (org.bouncycastle.pqc.asn1.McEliecePrivateKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.McEliecePrivateKey(ASN1Sequence.getInstance(o));
        }
