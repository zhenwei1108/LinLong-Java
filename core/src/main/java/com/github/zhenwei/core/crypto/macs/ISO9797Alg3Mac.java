 ...
 * <p>
 * This could as well be derived from CBCBlockCipherMac, but then the property mac in the base class
...
public class ISO9797Alg3Mac
  ...
  /**
   * create a Retail-MAC based on a CBC block cipher. This will produce an authentication code of
   * the length of the block size of the cipher.
   *
   * @param cipher the cipher to be used as the basis of the MAC generation. This must be
   *               DESEngine.
   */
  ...
  /**
   * create a Retail-MAC based on a block cipher with the size of the MAC been given in bits. This
   * class uses single DES CBC mode as the basis for the MAC generation.
   * <p>
   * Note: the size of the MAC must be at least 24 bits (FIPS Publication 81), or 16 bits if being
   * used as a data authenticator (FIPS Publication 113), and in general should be less than the
   * size of the block cipher as it reduces the chance of an exhaustive attack (see Handbook of
  ...
  /**
   * create a standard MAC based on a block cipher with the size of the MAC been given in bits. This
   * class uses single DES CBC mode as the basis for the MAC generation. The final block is
   * decrypted and then encrypted using the middle and right part of the key.
   * <p>
   * Note: the size of the MAC must be at least 24 bits (FIPS Publication 81), or 16 bits if being
   * used as a data authenticator (FIPS Publication 113), and in general should be less than the
   * size of the block cipher as it reduces the chance of an exhaustive attack (see Handbook of
