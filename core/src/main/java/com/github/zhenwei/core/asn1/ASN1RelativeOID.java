...
public class ASN1RelativeOID
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1RelativeOID.class,
      BERTags.RELATIVE_OID) {
    ...
    if (obj instanceof ASN1Encodable) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "failed to construct relative OID from byte[]: " + e.getMessage());
      }
    }
