...
/**
 * Base class for ASN.1 primitive objects. These are the actual objects used to generate byte
 * encodings.
 */
public abstract class ASN1Primitive
   ...
   * @throws IOException if there is a problem parsing the data, or parsing the stream did not
