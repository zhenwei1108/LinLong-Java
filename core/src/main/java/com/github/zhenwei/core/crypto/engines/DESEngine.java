...
public class DESEngine
  ...
  /**
   * what follows is mainly taken from "Applied Cryptography", by Bruce Schneier, however it also
   * bears great resemblance to Richard Outerbridge's D3DES...
   */
...
//        };
  ...
  /**
   * generate an integer based working key based on our secret key and what we processing we are
   * planning to do.
   * <p>
   * Acknowledgements for this routine go to James Gillogly &amp; Phil Karn. (whoever, and wherever
   * they are!).
   */
