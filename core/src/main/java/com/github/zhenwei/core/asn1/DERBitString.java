...
/**
 * A BIT STRING with DER encoding - the first byte contains the count of padding bits included in
 * the byte array's last byte.
 */
public class DERBitString
   ...
   * @deprecated Use {@link ASN1BitString#getInstance(Object)} and {@link #convert(ASN1BitString)}
   * instead.
   */
   ...
   * @deprecated Use {@link ASN1BitString#getInstance(ASN1TaggedObject, boolean)} and {@link
