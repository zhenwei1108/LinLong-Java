...
/**
 * Implements OpenPGP's rather strange version of Cipher-FeedBack (CFB) mode on top of a simple
 * cipher. This class assumes the IV has been prepended to the data stream already, and just
 * accomodates the reset after (blockSize + 2) bytes have been read.
 * <p>
...
public class OpenPGPCFBBlockCipher
   ...
   *
   * @return the name of the underlying algorithm followed by "/OpenPGPCFB" and the block size in
   * bits.
   */
