    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.bc.EncryptedSecretKeyData getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.bc.EncryptedSecretKeyData)
        {
            return (org.bouncycastle.asn1.bc.EncryptedSecretKeyData)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.asn1.bc.EncryptedSecretKeyData(ASN1Sequence.getInstance(o));
        }
