...
public final class ByteUtils {
  ...
  /**
   * Computes a hashcode based on the contents of a one-dimensional byte array rather than its
   * identity.
   *
  ...
  /**
   * Computes a hashcode based on the contents of a two-dimensional byte array rather than its
   * identity.
   *
   * @param array the array to compute the hashcode of
   * @return the hashcode
  ...
  /**
   * Computes a hashcode based on the contents of a three-dimensional byte array rather than its
   * identity.
   *
   * @param array the array to compute the hashcode of
   * @return the hashcode
  ...
  /**
   * Convert a 2-dimensional byte array into a 1-dimensional byte array by concatenating all
   * entries.
   *
  ...
  /**
   * Split a byte array <tt>input</tt> into two arrays at <tt>index</tt>, i.e. the first array will
   * have the lower <tt>index</tt> bytes, the second one the higher <tt>input.length - index</tt>
   * bytes.
   *
   ...
   * @param input the input byte array
   * @param start the start index
   * @return a subarray of <tt>input</tt>, ranging from <tt>start</tt> to the end of the array
   */
