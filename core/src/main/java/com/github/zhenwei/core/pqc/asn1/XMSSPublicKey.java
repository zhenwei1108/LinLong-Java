    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.XMSSPublicKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.XMSSPublicKey)
        {
            return (org.bouncycastle.pqc.asn1.XMSSPublicKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.XMSSPublicKey(ASN1Sequence.getInstance(o));
        }
