...
/**
 * Simulates pointer arithmetic. A utility for porting C to Java where C code makes heavy use of
 * pointer arithmetic.
 *
 * @Deprecated Remove when Post-Quantum Standardization project has finished and standard is
 * published.
 */
