...
/**
 * This class implements the distributed signature generation of the Winternitz one-time signature
 * scheme (OTSS), described in C.Dods, N.P. Smart, and M. Stam, "Hash Based Digital Signature
 * Schemes", LNCS 3796, pages 96&#8211;115, 2005. The class is used by the GMSS classes.
 */
public class GMSSRootSig {
   ...
   *
   * @param digest   an array of strings, containing the digest of the used hash function, the
   *                 digest of the PRGN and the names of the corresponding providers
   ...
   *
   * @param digest an array of strings, containing the digest of the used hash function, the digest
  ...
  /**
   * This method initializes the distributed sigature calculation. Variables are reseted and
   * necessary steps are calculated
   *
  ...
  /**
   * This Method performs <code>steps</code> steps of distributed signature calculaion
   *
  ...
  /**
   * This method returns the least integer that is greater or equal to the logarithm to the base 2
   * of an integer <code>intValue</code>.
   *
