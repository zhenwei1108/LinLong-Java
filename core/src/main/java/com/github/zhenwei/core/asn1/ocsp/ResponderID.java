    ...
    implements ASN1Choice
{
        ...
        Object  obj)
    {
        ...
        {
            return new org.bouncycastle.asn1.ocsp.ResponderID((DEROctetString)obj);
        }
        else if (obj instanceof ASN1TaggedObject)
        {
            ...
            if (o.getTagNo() == 1)
            {
                return new org.bouncycastle.asn1.ocsp.ResponderID(X500Name.getInstance(o, true));
            }
            else
            {
                return new org.bouncycastle.asn1.ocsp.ResponderID(ASN1OctetString.getInstance(o, true));
            }
        }

        return new org.bouncycastle.asn1.ocsp.ResponderID(X500Name.getInstance(obj));
    }
