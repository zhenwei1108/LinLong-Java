...
/**
 * This class implements permutations of the set {0,1,...,n-1} for some given n &gt; 0, i.e.,
 * ordered sequences containing each number <tt>m</tt> (<tt>0 &lt;= m &lt; n</tt>) once and only
 * once.
 */
public class Permutation {

  /**
   * perm holds the elements of the permutation vector, i.e. <tt>[perm(0), perm(1), ...,
   * perm(n-1)]</tt>
   */
  private int[] perm;
