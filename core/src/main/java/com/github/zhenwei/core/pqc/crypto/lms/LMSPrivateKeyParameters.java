    ...
    implements LMSContextBasedSigner
{
    ...
    private LMSPrivateKeyParameters(org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters parent, int q, int maxQ)
    {
        super(true);
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters getInstance(byte[] privEnc, byte[] pubEnc)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        else if (src instanceof DataInputStream)
        {
            ...
            return new org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters(parameter, otsParameter, q, I, maxQ, masterSecret);
    ...
    public org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters extractKeyShard(int usageCount)
    {
        synchronized (this)
        {
            ...
            org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters keyParameters = new org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters(this, q, q + usageCount);
            q += usageCount;
