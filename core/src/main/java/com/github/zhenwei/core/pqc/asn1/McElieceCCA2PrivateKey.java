    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.McElieceCCA2PrivateKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.McElieceCCA2PrivateKey)
        {
            return (org.bouncycastle.pqc.asn1.McElieceCCA2PrivateKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.McElieceCCA2PrivateKey(ASN1Sequence.getInstance(o));
        }
