...
//    }
    ...
    public ECFieldElement add(ECFieldElement b)
    {
        ...
        SecT409Field.add(x, ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(z);
    }
    ...
    {
        long[] z = Nat448.create64();
        SecT409Field.multiply(x, ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(z);
    }
    ...
    {
        long[] ax = this.x, bx = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)b).x;
        long[] xx = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)x).x, yx = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)y).x;
    ...
    public boolean equals(Object other)
    {
        ...
        if (!(other instanceof org.bouncycastle.math.ec.custom.sec.SecT409FieldElement))
        {
            return false;
        }

        org.bouncycastle.math.ec.custom.sec.SecT409FieldElement o = (org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)other;
