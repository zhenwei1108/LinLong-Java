...
/**
 * This class represents a layer of the Rainbow Oil- and Vinegar Map. Each Layer consists of oi
 * polynomials with their coefficients, generated at random.
 * <p>
 * To sign a document, we solve a LES (linear equation system) for each layer in order to find the
 * oil variables of that layer and to be able to use the variables to compute the signature. This
 * functionality is implemented in the RainbowSignature-class, by the aid of the private key.
 * <p>
 * Each layer is a part of the private key.
 * <p>
 * More information about the layer can be found in the paper of Jintai Ding, Dieter Schmidt:
...
public class Layer {
   ...
   * @param viNext     number of vinegar variables of next layer. It's the same as (num of oils) +
   *                   (num of vinegars) of this layer.
  ...
  /**
   * This function generates the coefficients of all polynomials in this layer at random using
   * random generator.
   *
  ...
  /**
   * This method plugs in the vinegar variables into the polynomials of this layer and computes the
   * coefficients of the Oil-variables as well as the free coefficient in each polynomial.
   * <p>
   ...
   * @return coeff the coefficients of Oil variables and the free coeff in the polynomials of this
   * layer.
   */
