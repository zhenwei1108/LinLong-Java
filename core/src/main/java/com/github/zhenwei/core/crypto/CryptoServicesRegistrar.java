...
public final class CryptoServicesRegistrar {
  ...
  private static final Permission CanSetDefaultProperty = new CryptoServicesPermission(
      CryptoServicesPermission.GLOBAL_CONFIG);
  private static final Permission CanSetThreadProperty = new CryptoServicesPermission(
      CryptoServicesPermission.THREAD_LOCAL_CONFIG);
  private static final Permission CanSetDefaultRandom = new CryptoServicesPermission(
      CryptoServicesPermission.DEFAULT_RANDOM);

  private static final ThreadLocal<Map<String, Object[]>> threadProperties = new ThreadLocal<Map<String, Object[]>>();
  private static final Map<String, Object[]> globalProperties = Collections.synchronizedMap(
  ...
  static {
    ...
    DSAParameters def512Params = new DSAParameters(
        ...
        new BigInteger(
            ...
            16),
        new DSAValidationParameters(Hex.decodeStrict("b869c82b35d70e1b1ff91b28e37a62ecdc34409b"),
            123));
    ...
    DSAParameters def768Params = new DSAParameters(
        ...
        new DSAValidationParameters(Hex.decodeStrict("77d0f8c4dad15eb8c4f2f8d6726cefd96d5bb399"),
            263));
    ...
    DSAParameters def1024Params = new DSAParameters(
        ...
        new DSAValidationParameters(Hex.decodeStrict("8d5155894229d5e689ee01e6018a237e2cae64cd"),
            92));
    ...
    DSAParameters def2048Params = new DSAParameters(
        ...
        new DSAValidationParameters(
            Hex.decodeStrict("b0b4417601b59cbc9d8ac8f935cadaec4f5fbb2f23785609ae466748d9b5a536"),
            497));

    localSetGlobalProperty(Property.DSA_DEFAULT_PARAMS, def512Params, def768Params, def1024Params,
        def2048Params);
  ...
  /**
   * Return either the passed-in SecureRandom, or if it is null, then the default source of
   * randomness.
   *
  ...
  /**
   * Return the default value for a particular property if one exists. The look up is done on the
   * thread's local configuration first and then on the global configuration in no local
  ...
  /**
   * Return an array representing the current values for a sized property such as DH_DEFAULT_PARAMS
   * or DSA_DEFAULT_PARAMS.
   *
  ...
  /**
   * Set the value of the the passed in property on the current thread only. More than one value can
   * be passed in for a sized property. If more than one value is provided the first value in the
   * argument list becomes the default value.
   *
  ...
  /**
   * Set the value of the the passed in property globally in the JVM. More than one value can be
   * passed in for a sized property. If more than one value is provided the first value in the
   * argument list becomes the default value.
   *
   * @param property      the name of the property to set.
   * @param propertyValue the values to assign to the property.
  ...
  public static final class Property {
     ...
     */
    public static final Property EC_IMPLICITLY_CA = new Property("ecImplicitlyCA",
        X9ECParameters.class);
    /**
     * The default parameters for a particular size of Diffie-Hellman key.This is a sized property.
     */
    public static final Property DH_DEFAULT_PARAMS = new Property("dhDefaultParams",
        DHParameters.class);
    /**
     * The default parameters for a particular size of DSA key. This is a sized property.
     */
    public static final Property DSA_DEFAULT_PARAMS = new Property("dsaDefaultParams",
        DSAParameters.class);
