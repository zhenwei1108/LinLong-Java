...
import com.github.zhenwei.core.asn1.x9.DHPublicKey;
import com.github.zhenwei.core.asn1.x9.DomainParameters;
import com.github.zhenwei.core.asn1.x9.ECNamedCurveTable;
import com.github.zhenwei.core.asn1.x9.ValidationParams;
...
/**
 * Factory to create asymmetric public key parameters for asymmetric ciphers from range of ASN.1
 * encoded SubjectPublicKeyInfo objects.
 */
public class PublicKeyFactory {
  ...
  static {
    ...
    converters.put(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256,
        new GOST3410_2012Converter());
    converters.put(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512,
        new GOST3410_2012Converter());
  ...
  public static AsymmetricKeyParameter createKey(SubjectPublicKeyInfo keyInfo, Object defaultParams)
    ...
    SubjectPublicKeyInfoConverter converter = (SubjectPublicKeyInfoConverter) converters.get(
        algID.getAlgorithm());
    if (null == converter) {
  ...
  private static abstract class SubjectPublicKeyInfoConverter {
    ...
    abstract AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
  ...
  private static class RSAConverter
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
        Object defaultParams)
        throws IOException {
  ...
  private static class DHPublicNumberConverter
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
      ...
      DomainParameters dhParams = DomainParameters.getInstance(
          keyInfo.getAlgorithm().getParameters());
