    ...
    extends ASN1Object
{
    ...
    public static ocsp.BasicOCSPResponse getInstance(
    ...
    public static ocsp.BasicOCSPResponse getInstance(
        Object  obj)
    {
        if (obj instanceof ocsp.BasicOCSPResponse)
        {
            return (ocsp.BasicOCSPResponse)obj;
        }
        else if (obj != null)
        {
            return new ocsp.BasicOCSPResponse(ASN1Sequence.getInstance(obj));
        }
