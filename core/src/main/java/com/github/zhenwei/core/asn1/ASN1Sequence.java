...
{
    static final ASN1UniversalType TYPE = new ASN1UniversalType(org.bouncycastle.asn1.ASN1Sequence.class, BERTags.SEQUENCE)
    {
        ASN1Primitive fromImplicitConstructed(org.bouncycastle.asn1.ASN1Sequence sequence)
        {
            return sequence;
        }
    };
     ...
     */
    public static org.bouncycastle.asn1.ASN1Sequence getInstance(Object obj)
    {
...
//      else if (obj instanceof ASN1SequenceParser)
        else if (obj instanceof ASN1Encodable)
        {
            ...
            if (primitive instanceof org.bouncycastle.asn1.ASN1Sequence)
            {
                return (org.bouncycastle.asn1.ASN1Sequence)primitive;
            }
        }
        else if (obj instanceof byte[])
        {
            try
            {
                return (org.bouncycastle.asn1.ASN1Sequence)TYPE.fromByteArray((byte[])obj);
            }
            catch (IOException e)
            {
     ...
     */
    public static org.bouncycastle.asn1.ASN1Sequence getInstance(ASN1TaggedObject taggedObject, boolean explicit)
    {
        return (org.bouncycastle.asn1.ASN1Sequence)TYPE.getContextInstance(taggedObject, explicit);
    }
    ...
    public ASN1SequenceParser parser()
    {
        ...
        return new ASN1SequenceParser()
        {
            ...
            public ASN1Encodable readObject() throws IOException
            {
                ...
                {
                    return ((org.bouncycastle.asn1.ASN1Sequence)obj).parser();
                }
...
//        return Arrays.hashCode(elements);
    ...
    {
        if (!(other instanceof org.bouncycastle.asn1.ASN1Sequence))
        {
            return false;
        }

        org.bouncycastle.asn1.ASN1Sequence that = (org.bouncycastle.asn1.ASN1Sequence)other;
