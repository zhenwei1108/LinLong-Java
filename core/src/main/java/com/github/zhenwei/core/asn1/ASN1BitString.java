...
public abstract class ASN1BitString
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1BitString.class,
      BERTags.BIT_STRING) {
...
//      else if (obj instanceof ASN1BitStringParser)
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "failed to construct BIT STRING from byte[]: " + e.getMessage());
      }
    }
  ...
  /**
   * Return the octets contained in this BIT STRING, checking that this BIT STRING really does
   * represent an octet aligned string. Only use this method when the standard you are following
   * dictates that the BIT STRING will be octet aligned.
   *
