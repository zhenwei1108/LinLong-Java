...
public class CFBBlockCipherMac
  ...
  /**
   * create a standard MAC based on a CFB block cipher. This will produce an authentication code
   * half the length of the block size of the cipher, with the CFB mode set to 8 bits.
   *
   ...
   * class uses CFB mode as the basis for the MAC generation.
   * <p>
