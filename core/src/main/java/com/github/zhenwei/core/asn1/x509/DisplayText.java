...
import com.github.zhenwei.core.asn1.DERVisibleString;
...
public class DisplayText
   ...
   * @param text the text to store. Strings longer than 200 characters are truncated.
   */
   ...
   * Creates a new <code>DisplayText</code> instance.
   *
   * @param text the text to encapsulate. Strings longer than 200 characters are truncated.
   */
