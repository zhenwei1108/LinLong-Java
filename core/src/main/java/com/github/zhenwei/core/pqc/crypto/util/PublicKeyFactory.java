...
public class PublicKeyFactory {
  ...
  private static class QTeslaConverter
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
        Object defaultParams)
        throws IOException {
      return new QTESLAPublicKeyParameters(
          Utils.qTeslaLookupSecurityCategory(keyInfo.getAlgorithm()),
  ...
  private static class XMSSMTConverter
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
        Object defaultParams)
        throws IOException {
      XMSSMTKeyParams keyParams = XMSSMTKeyParams.getInstance(
      ...
      if (keyParams != null) {
        ...
        return new XMSSMTPublicKeyParameters
            .Builder(new XMSSMTParameters(keyParams.getHeight(), keyParams.getLayers(),
  ...
  private static class McElieceCCA2Converter
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo,
      ...
      return new McElieceCCA2PublicKeyParameters(mKey.getN(), mKey.getT(), mKey.getG(),
          Utils.getDigestName(mKey.getDigest().getAlgorithm()));
    }
  }
}