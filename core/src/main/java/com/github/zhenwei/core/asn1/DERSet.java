 ...
 * </p><p>
 * For short: Constructing this form does sort the supplied elements, and the sorting happens also
 * before serialization (if necesssary). This is different from the way {@link BERSet},{@link DLSet}
 * does things.
 * </p>
 */
public class DERSet
