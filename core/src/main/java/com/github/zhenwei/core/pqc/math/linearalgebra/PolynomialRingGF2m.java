...
public class PolynomialRingGF2m {
  ...
  /**
   * the matrix for computing square roots in this polynomial ring (given as the array of its row
   * vectors). This matrix is computed as the inverse of the squaring matrix.
   */
  ...
  /**
   * Compute the squaring matrix for this polynomial ring, using the base field and the reduction
   * polynomial.
   */
  ...
  /**
   * Compute the matrix for computing square roots in this polynomial ring by inverting the squaring
   * matrix.
   */
