...
/**
 * ASN.1 BMPString object encodes BMP (<i>Basic Multilingual Plane</i>) subset (aka UCS-2) of
 * UNICODE (ISO 10646) characters in codepoints 0 to 65535.
 * <p>
...
public abstract class ASN1BMPString
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1BMPString.class,
      BERTags.BMP_STRING) {
