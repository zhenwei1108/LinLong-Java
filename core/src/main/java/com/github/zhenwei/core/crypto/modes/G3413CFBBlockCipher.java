...
/**
 * An implementation of the CFB mode for GOST 3412 2015 cipher. See  <a
 * href="https://www.tc26.ru/standard/gost/GOST_R_3413-2015.pdf">GOST R 3413 2015</a>
 */
public class G3413CFBBlockCipher
  ...
  public G3413CFBBlockCipher(BlockCipher cipher, int bitBlockSize) {
    ...
    if (bitBlockSize < 0 || bitBlockSize > cipher.getBlockSize() * 8) {
      throw new IllegalArgumentException(
          "Parameter bitBlockSize must be in range 0 < bitBlockSize <= "
  ...
  /**
   * Initialise the cipher and initialisation vector R. If an IV isn't passed as part of the
   * parameter, the IV will be all zeros. An IV which is too short is handled in FIPS compliant
   * fashion. R_init = IV, and R1 = R_init
   *
  ...
  /**
   * this method sets default values to <b>s</b> and <b>m</b> parameters:<br> s = <b>blockSize</b>;
   * <br> m = <b>2 * blockSize</b>
   */
