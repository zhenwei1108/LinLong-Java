...
import com.github.zhenwei.core.crypto.SignerWithRecovery;
import com.github.zhenwei.core.crypto.params.ParametersWithRandom;
import com.github.zhenwei.core.crypto.params.ParametersWithSalt;
...
public class ISO9796d2PSSSigner
    ...
    if (implicit) {
      ...
      if (trailerObj != null) {
        ...
        throw new IllegalArgumentException(
            "no valid trailer for digest: " + digest.getAlgorithmName());
      }
    }
  }
   ...
   * @param param      parameters for signature generation/verification. If the parameters are for
   *                   generation they should be a ParametersWithRandom, a ParametersWithSalt, or
   *                   just an RSAKeyParameters object. If RSAKeyParameters are passed in a
   *                   SecureRandom will be created.
   * @throws IllegalArgumentException if wrong parameter type or a fixed salt is passed in which is
   *                                  the wrong length.
   */
  public void init(
      boolean forSigning,
   ...
   * @see com.github.zhenwei.core.crypto.SignerWithRecovery#hasFullMessage()
   */
  ...
  /**
   * Return a reference to the recoveredMessage message, either as it was added to a just generated
   * signature, or extracted from a verified one.
   *
   * @return the full/partial recoveredMessage message.
   * @see com.github.zhenwei.core.crypto.SignerWithRecovery#getRecoveredMessage()
   */
