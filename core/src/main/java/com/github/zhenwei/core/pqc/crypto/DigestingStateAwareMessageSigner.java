...
/**
 * Implements the sign and verify functions for a Signature Scheme using a hash function to allow
 * processing of large messages.
 * <p>
 * This class can be used with algorithms where the state associated with the private key changes as
 * each signature is generated. Calling getUpdatedPrivateKey() will recover the private key that can
 * be used to initialize a signer next time around.
 * </p>
 */
public class DigestingStateAwareMessageSigner
   ...
   * <p>
   * <b>Note:</b> calling this method will effectively disable the Signer from being used for
   * further
