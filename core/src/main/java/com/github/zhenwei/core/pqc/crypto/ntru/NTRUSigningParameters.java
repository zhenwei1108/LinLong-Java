...
public class NTRUSigningParameters
   ...
   *                  such as <code>SHA-256</code>. The <code>MessageDigest</code> must support the
   *                  <code>getDigestLength()</code> method.
   */
  public NTRUSigningParameters(int N, int q, int d, int B, double beta, double normBound,
      Digest hashAlg) {
    this.N = N;
    this.q = q;
    this.d = d;
   ...
   */
  public NTRUSigningParameters(int N, int q, int d1, int d2, int d3, int B, double beta,
      double normBound, double keyNormBound, Digest hashAlg) {
    this.N = N;
    this.q = q;
    this.d1 = d1;
    this.d2 = d2;
