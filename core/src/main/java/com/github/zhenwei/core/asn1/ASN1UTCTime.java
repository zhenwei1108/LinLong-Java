...
public class ASN1UTCTime
   ...
   * When you're creating one of these objects from scratch, that's what you want to use, otherwise
   * we'll try to deal with whatever gets read from the input stream... (this is why the input
  ...
  /**
   * Return the time as a date based on whatever a 2 digit year will return. For standardised
   * processing use getAdjustedDate().
   *
   ...
   * may lead to unexpected results. If you want to stick the normal convention of 1950 to 2049 use
   * the getAdjustedTime() method.
   */
  ...
  /**
   * Return a time string as an adjusted date with a 4 digit year. This goes in the range of 1950 -
   * 2049.
   */
