...
/**
 * The DLSet encodes ASN.1 SET value without element ordering, and always using definite length
 * form.
 * <hr>
 * <h2>X.690</h2>
...
public class DLSet
   ...
   * <p>
   * As DL requires the constructed, definite-length model to be used for structured types, this
   * varies slightly from the ASN.1 descriptions given. Rather than just outputting SET, we also
