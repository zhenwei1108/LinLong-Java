    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.ParSet getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.ParSet)
        {
            return (org.bouncycastle.pqc.asn1.ParSet)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.ParSet(ASN1Sequence.getInstance(o));
        }
