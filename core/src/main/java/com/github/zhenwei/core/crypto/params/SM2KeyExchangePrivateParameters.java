...
/**
 * Private parameters for an SM2 key exchange. The ephemeralPrivateKey is used to calculate the
 * random point used in the algorithm.
 */
public class SM2KeyExchangePrivateParameters
  ...
  public SM2KeyExchangePrivateParameters(
    ...
    this.ephemeralPublicPoint = m.multiply(parameters.getG(), ephemeralPrivateKey.getD())
        .normalize();
  }
