...
/**
 * A SecureRandom that maintains a journal of its output. This can be used to recreate an output
 * that was based on randomness For the transcript to be reusable, the order of the requests for
 * randomness during recreation must be consistent with the initial requests and no other sources of
...
public class JournalingSecureRandom
  ...
  /**
   * Constructor with a prior transcript. Both the transcript used and any new randomness are
   * journaled.
   *
  ...
  /**
   * Fill bytes with random data, journaling the random data before returning or re-use previously
   * used random data, depending on the state of the transcript.
   *
  ...
  /**
   * Return the full transcript, such as would be needed to create a copy of this
