...
/**
 * A basic hash-committer as described in "Making Mix Nets Robust for Electronic Voting by
 * Randomized Partial Checking", by Jakobsson, Juels, and Rivest (11th Usenix Security Symposium,
 * 2002).
 * <p>
 * Use this class if you can enforce fixed length for messages. If you need something more general,
