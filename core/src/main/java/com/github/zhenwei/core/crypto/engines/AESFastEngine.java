 ...
 * </p>
 *
 * @deprecated unfortunately this class is has a few side channel issues. In an environment where
 * encryption/decryption may be closely observed it should not be used.
 */
