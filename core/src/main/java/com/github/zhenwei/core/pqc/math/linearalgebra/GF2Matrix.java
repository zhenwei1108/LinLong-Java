    ...
    extends Matrix
{
    ...
    private void assignRandomRegularMatrix(int n, SecureRandom sr)
    {
        ...
        length = (n + 31) >>> 5;
        matrix = new int[numRows][length];
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix lm = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(n, Matrix.MATRIX_TYPE_RANDOM_LT, sr);
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix um = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(n, Matrix.MATRIX_TYPE_RANDOM_UT, sr);
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix rm = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)lm.rightMultiply(um);
     ...
     */
    public static org.bouncycastle.pqc.math.linearalgebra.GF2Matrix[] createRandomRegularMatrixAndItsInverse(int n,
                                                                     SecureRandom sr)
    {
        ...
        // inverse to lm
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix invLm = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(n, Matrix.MATRIX_TYPE_UNIT);
        for (int i = 0; i < n; i++)
        {
            int rest = i & 0x1f;
            int q = i >>> 5;
        ...
        // inverse to um
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix invUm = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(n, Matrix.MATRIX_TYPE_UNIT);
        for (int i = n - 1; i >= 0; i--)
        {
            int rest = i & 0x1f;
            int q = i >>> 5;
        ...
        // inverse matrix
        result[1] = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)invUm.rightMultiply(invLm.rightMultiply(p));
    ...
    public org.bouncycastle.pqc.math.linearalgebra.GF2Matrix extendLeftCompactForm()
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix result = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(numRows, newNumColumns);
    ...
    public org.bouncycastle.pqc.math.linearalgebra.GF2Matrix getRightSubMatrix()
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix result = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(numRows, numColumns - numRows);
    ...
    {
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix result = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(numRows, numRows + numColumns);
    ...
    public Matrix rightMultiply(Matrix mat)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix result = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(numRows, mat.numColumns);
    ...
    public Matrix rightMultiply(Permutation p)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2Matrix result = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(numRows, numColumns);
