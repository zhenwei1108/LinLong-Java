    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.pqc.asn1.XMSSPrivateKey getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.pqc.asn1.XMSSPrivateKey)
        {
            return (org.bouncycastle.pqc.asn1.XMSSPrivateKey)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.pqc.asn1.XMSSPrivateKey(ASN1Sequence.getInstance(o));
        }
