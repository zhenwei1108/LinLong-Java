...
public final class LittleEndianConversions {
  ...
  /**
   * Convert an byte array of length 4 beginning at <tt>offset</tt> into an integer.
   *
  ...
  /**
   * Convert a byte array of the given length beginning at <tt>offset</tt> into an integer.
   *
   * @param input the byte array
   * @param inOff the offset into the byte array
  ...
  /**
   * Convert an integer to a byte array beginning at the specified offset. No length checking is
   * performed (i.e., if the integer cannot be encoded with
  ...
  /**
   * Convert an int array to a byte array of the specified length. No length checking is performed
   * (i.e., if the last integer cannot be encoded with
