...
/**
 * ASN.1 T61String (also the teletex string), try not to use this if you don't need to. The standard
 * support the encoding for this has been withdrawn.
 */
public abstract class ASN1T61String
    extends ASN1Primitive
    implements ASN1String {

  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1T61String.class,
      BERTags.T61_STRING) {
