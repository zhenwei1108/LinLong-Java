...
/**
 * This class describes operations with polynomials from the ring R = GF(2^m)[X], where 2 &lt;= m
 * &lt;=31.
 *
 * @see GF2mField
...
public class PolynomialGF2mSmallM {
   ...
   * represented as int (see {@link GF2mField}). The polynomials are stored as int arrays.
   */
  ...
  /**
   * Constant used for polynomial construction (see constructor {@link
  ...
  /**
   * Construct the polynomial over the given finite field GF(2^m) from the given coefficient
   * vector.
   *
  ...
  /**
   * Create a polynomial over the finite field GF(2^m) out of the given coefficient vector. The
   * finite field is also obtained from the {@link GF2mVector}.
   *
  ...
  /**
   * Compute the product of two polynomials over the field <tt>GF(2^m)</tt> using a Karatzuba like
   * multiplication.
   *
   * @param a the first polynomial
   * @param b the second polynomial
  ...
  /**
   * Compute the product of two polynomials modulo a third polynomial over the finite field
   * <tt>GF(2^m)</tt>.
   *
   * @param a the first polynomial
   * @param b the second polynomial
  ...
  /**
   * Compute the result of the division of this polynomial by another polynomial modulo a third
   * polynomial.
   *
  ...
  /**
   * Compute the result of the division of two polynomials modulo a third polynomial over the field
   * <tt>GF(2^m)</tt>.
   *
   * @param a the first polynomial
   * @param b the second polynomial
  ...
  /**
   * Compute a polynomial pair (a,b) from this polynomial and the given polynomial g with the
   * property b*this = a mod g and deg(a)&lt;=deg(g)/2.
   *
   * @param g the reduction polynomial
   ...
   *
   * @param a the polynomial
   * @return the degree of the polynomial <tt>a</tt>. If <tt>a</tt> is the zero polynomial, return
   * -1.
   */
