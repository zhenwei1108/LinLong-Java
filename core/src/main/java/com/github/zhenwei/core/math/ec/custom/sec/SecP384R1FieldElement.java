...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp
{
    ...
    {
        int[] z = Nat.create(12);
        SecP384R1Field.add(x, ((org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement(z);
    }
    ...
    {
        int[] z = Nat.create(12);
        SecP384R1Field.subtract(x, ((org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement(z);
    }
    ...
    {
        int[] z = Nat.create(12);
        SecP384R1Field.multiply(x, ((org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement(z);
    }
...
//        return multiply(b.invert());
        int[] z = Nat.create(12);
        SecP384R1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement)b).x, z);
...
//        return new SecP384R1FieldElement(toBigInteger().modInverse(Q));
    ...
    public ECFieldElement sqrt()
    {
        ...
        return Nat.eq(12, x1, t2) ? new org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement(t1) : null;
    }
    ...
    public boolean equals(Object other)
    {
        ...
        if (!(other instanceof org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement))
        {
            return false;
        }

        org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement o = (org.bouncycastle.math.ec.custom.sec.SecP384R1FieldElement)other;
