 ...
 * forms depending on whether product-form polynomials are used, and on <code>fastP</code><br> The
 * inverse of <code>f</code> modulo <code>p</code> is precomputed on initialization.
 */
public class NTRUEncryptionPrivateKeyParameters
   ...
   * @param t      the polynomial which determines the key: if <code>fastFp=true</code>,
   *               <code>f=1+3t</code>; otherwise, <code>f=t</code>
