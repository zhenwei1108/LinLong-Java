...
public class SecT239K1Point extends AbstractF2m
{
    ...
    {
        return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(null, this.getAffineXCoord(), this.getAffineYCoord()); // earlier JDK
    }
    ...
    public ECPoint add(ECPoint b)
    {
        ...
        if (X2.isZero())
        {
            ...
            if (X3.isZero())
            {
                return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(curve, X3, curve.getB());
            }
        ...
        return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(curve, X3, L3, new ECFieldElement[]{ Z3 });
    }
    ...
    public ECPoint twice()
    {
        ...
        if (T.isZero())
        {
            return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(curve, T, curve.getB());
        }
    ...
    public ECPoint twicePlus(ECPoint b)
    {
        ...
        if (A.isZero())
        {
            return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(curve, A, curve.getB());
        }
    ...
    public ECPoint negate()
    {
        ...
        return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(curve, X, L.add(Z), new ECFieldElement[]{ Z });
    }
}