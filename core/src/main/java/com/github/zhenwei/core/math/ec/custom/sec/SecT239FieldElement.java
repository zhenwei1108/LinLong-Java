...
//    }
    ...
    public ECFieldElement add(ECFieldElement b)
    {
        ...
        SecT239Field.add(x, ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(z);
    }
    ...
    {
        long[] z = Nat256.create64();
        SecT239Field.multiply(x, ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)b).x, z);
        return new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(z);
    }
    ...
    {
        long[] ax = this.x, bx = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)b).x;
        long[] xx = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)x).x, yx = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)y).x;
    ...
    public boolean equals(Object other)
    {
        ...
        if (!(other instanceof org.bouncycastle.math.ec.custom.sec.SecT239FieldElement))
        {
            return false;
        }

        org.bouncycastle.math.ec.custom.sec.SecT239FieldElement o = (org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)other;
