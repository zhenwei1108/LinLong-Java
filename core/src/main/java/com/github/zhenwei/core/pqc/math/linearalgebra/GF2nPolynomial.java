...
public class GF2nPolynomial {
  ...
  /**
   * Creates a new PolynomialGF2n from the given Bitstring <i>polynomial</i> over the GF2nField
   * <i>B1</i>.
   *
  ...
  /**
   * Returns the size (=maximum degree + 1) of this PolynomialGF2n. This is not the degree, use
   * getDegree instead.
   *
  ...
  /**
   * Adds the PolynomialGF2n <tt>b</tt> to <tt>this</tt> and returns the result in a new
   * <tt>PolynomialGF2n</tt>.
   *
  ...
  /**
   * Multiplies the scalar <i>s</i> to each coefficient of this PolynomialGF2n and returns the
  ...
  /**
   * Multiplies <i>this</i> by <i>b</i> and returns the result in a new PolynomialGF2n.
   *
  ...
  /**
   * Multiplies <i>this</i> by <i>b</i>, reduces the result by <i>g</i> and returns it in a new
   * PolynomialGF2n.
   *
   * @param b the PolynomialGF2n to multiply
   * @param g the modul
  ...
  /**
   * Reduces <i>this</i> by <i>g</i> and returns the result in a new PolynomialGF2n.
   *
   * @param g - the modulus
  ...
  /**
   * Divides <i>this</i> by <i>b</i> and stores the result in a new PolynomialGF2n[2], quotient in
   * result[0] and remainder in result[1].
   *
   * @param b the divisor
  ...
  /**
   * Divides <i>this</i> by <i>b</i> and stores the remainder in a new PolynomialGF2n.
   *
   * @param b the divisor
  ...
  /**
   * Divides <i>this</i> by <i>b</i> and stores the quotient in a new PolynomialGF2n.
   *
   * @param b the divisor
  ...
  /**
   * Computes the greatest common divisor of <i>this</i> and <i>g</i> and returns the result in a
   * new PolynomialGF2n.
   *
