...
public class GF2nPolynomial
{
    ...
    {
        if (other == null || !(other instanceof org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial))
        {
            return false;
        }
     ...
     */
    public final org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial scalarMultiply(GF2nElement s)
    {
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial result = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial(size());
        int i;
        for (i = 0; i < size(); i++)
        {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial b)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial result = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial((aDegree << 1) - 1);
        for (i = 0; i < size(); i++)
        {
            for (j = 0; j < b.size(); j++)
            {
    ...
    public final org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial shiftLeft(int amount)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial result = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial(size + amount, coeff[0]);
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial b)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial a = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial(this);
        a.shrink();
    ...
    {
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial a = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial(this);
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial b = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomial(g);
        a.shrink();
        b.shrink();
