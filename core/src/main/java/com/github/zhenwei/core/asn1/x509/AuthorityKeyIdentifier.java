    ...
    extends ASN1Object
{
        ...
        Object  obj)
    {
        ...
        if (obj != null)
        {
            return new org.bouncycastle.asn1.x509.AuthorityKeyIdentifier(ASN1Sequence.getInstance(obj));
        }

        return null;
    }

    public static org.bouncycastle.asn1.x509.AuthorityKeyIdentifier fromExtensions(Extensions extensions)
    {
