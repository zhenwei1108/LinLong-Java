...
import com.github.zhenwei.core.crypto.params.SRP6GroupParameters;
import java.math.BigInteger;
import java.security.SecureRandom;


/**
 * Implements the server side SRP-6a protocol. Note that this class is stateful, and therefore NOT
 * threadsafe. This implementation of SRP is based on the optimized message sequence put forth by
 * Thomas Wu in the paper "SRP-6: Improvements and Refinements to the Secure Remote Password
 * Protocol, 2002"
 */
public class SRP6Server {
  ...
  /**
   * Authenticates the received client evidence message M1 and saves it only if correct. To be
   * called after calculating the secret S.
   *
  ...
  /**
   * Computes the server evidence message M2 using the previously verified values. To be called
   * after successfully verifying the client evidence message M1.
   *
  ...
  /**
   * Computes the final session key as a result of the SRP successful mutual authentication To be
   * called after calculating the server evidence message M2.
   *
