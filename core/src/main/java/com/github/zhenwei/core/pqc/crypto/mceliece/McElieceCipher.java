 ...
 * in R.J. McEliece, "A public key cryptosystem based on algebraic coding theory", DSN progress
 * report, 42-44:114-116, 1978. The McEliecePKCS is the first cryptosystem which is based on error
 * correcting codes. The trapdoor for the McEliece cryptosystem using Goppa codes is the knowledge
