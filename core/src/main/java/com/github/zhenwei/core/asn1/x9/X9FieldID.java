...
/**
 * ASN.1 def for Elliptic-Curve Field ID structure. See 62, for further details.
 */
public class X9FieldID
   ...
   *           <code>F<sub>2<sup>m</sup></sub></code>.
   * @param k1 The integer <code>k1</code> where <code>x<sup>m</sup> + x<sup>k1</sup> + 1</code>
