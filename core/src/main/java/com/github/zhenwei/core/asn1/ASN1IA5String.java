...
public abstract class ASN1IA5String
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1IA5String.class,
      BERTags.IA5_STRING) {
  ...
  /**
   * return true if the passed in String can be represented without loss as an IA5String, false
   * otherwise.
   *
