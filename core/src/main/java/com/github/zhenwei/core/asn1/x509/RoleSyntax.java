...
public class RoleSyntax
   ...
   *
   * @param obj the object used to construct an instance of <code> RoleSyntax</code>. It must be an
   *            instance of <code>RoleSyntax
  ...
  /**
   * Utility constructor. Takes a <code>String</code> argument representing the role name, builds a
   * <code>GeneralName</code> to hold the role name and calls the constructor that takes a
   * <code>GeneralName</code>.
   *
   * @param roleName
   */
  public RoleSyntax(
  ...
  /**
   * Implementation of the method <code>toASN1Object</code> as required by the superclass
   * <code>ASN1Encodable</code>.
   *
   * <pre>
   * RoleSyntax ::= SEQUENCE {
   *                 roleAuthority  [0] GeneralNames OPTIONAL,
