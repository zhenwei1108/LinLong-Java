...
public final class ASN1ObjectDescriptor
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1ObjectDescriptor.class,
      BERTags.OBJECT_DESCRIPTOR) {
    ...
    if (obj == null || obj instanceof ASN1ObjectDescriptor) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "failed to construct object descriptor from byte[]: " + e.getMessage());
      }
    }
