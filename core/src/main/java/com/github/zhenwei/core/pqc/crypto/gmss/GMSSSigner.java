...
public class GMSSSigner
  ...
  /**
   * Array of strings containing the name of the hash function used by the OTS and the corresponding
   * provider name
   */
  ...
  /**
   * The standard constructor tries to generate the MerkleTree Algorithm identifier with the
   * corresponding OID.
   *
  ...
  public byte[] generateSignature(byte[] message) {
    ...
    System.arraycopy(authPathBytes, 0, gmssSigFirstPart, (indexBytes.length + otsSig.length),
