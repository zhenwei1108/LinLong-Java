 ...
 * <p>
 * Implemented are functions: - finding inverse of a matrix - solving linear equation systems using
 * the Gauss-Elimination method - basic operations like matrix multiplication, addition and so on.
 */
...
public class ComputeInField {
  ...
  /**
   * This function finds a solution of the equation Bx = b. Exception is thrown if the linear
   * equation system has no solution
   *
  ...
  /**
   * Elimination under the diagonal. This function changes a matrix so that it contains only zeros
   * under the diagonal(Ai,i) using only Gauss-Elimination operations.
   * <p>
   * It is used in solveEquaton as well as in the function for finding an inverse of a matrix:
   * {@link}inverse. Both of them use the Gauss-Elimination Method.
   * </p><p>
  ...
  /**
   * Elimination above the diagonal. This function changes a matrix so that it contains only zeros
   * above the diagonal(Ai,i) using only Gauss-Elimination operations.
   * <p>
   ...
   * <p>
   * If the multiplicative inverse of 0 is needed, an exception is thrown. In this case is the LES
   * not solvable
   * </p>
   *
   * @throws RuntimeException in case a multiplicative inverse of 0 is needed
  ...
  /**
   * This function multiplies two given matrices. If the given matrices cannot be multiplied due to
   * different sizes, an exception is thrown.
   *
   * @param M1 -the 1st matrix
   * @param M2 -the 2nd matrix
   * @return A = M1*M2
   * @throws RuntimeException in case the given matrices cannot be multiplied due to different
   *                          dimensions.
   */
   ...
   * <p>
   * An exception is thrown, if the number of columns in the matrix and the number of rows in the
   * one-dim. array differ.
   *
   ...
   * @throws RuntimeException in case the addition is impossible due to inconsistency in the
   *                          dimensions
   */
   ...
   * @throws RuntimeException in case the multiplication is impossible due to inconsistency in the
   *                          dimensions
   */
   ...
   * @throws RuntimeException in case the addition is not possible because of different dimensions
   *                          of the matrices
   */
