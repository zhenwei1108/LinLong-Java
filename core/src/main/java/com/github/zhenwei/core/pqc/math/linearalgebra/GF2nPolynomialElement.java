...
/**
 * This class implements elements of finite binary fields <i>GF(2<sup>n</sup>)</i> using polynomial
 * representation. For more information on the arithmetic see for example IEEE Standard 1363 or <a
...
public class GF2nPolynomialElement
  ...
  /**
   * Creates a new GF2nPolynomialElement using the given field <i>f</i> and byte[] <i>os</i> as
   * value. The conversion is done according to 1363.
   *
   * @param f  the GF2nField to use
  ...
  /**
   * Creates a new GF2nPolynomialElement using the given field <i>f</i> and int[] <i>is</i> as
   * value.
   *
   * @param f  the GF2nField to use
  ...
  /**
   * Creates a new GF2nPolynomialElement by cloning the given GF2nPolynomialElement <i>b</i>.
   *
  ...
  /**
   * Returns whether the rightmost bit of the bit representation is set. This is needed for data
   * conversion according to 1363.
   *
  ...
  /**
   * Calculates the multiplicative inverse of <i>this</i> and returns the result in a new
  ...
  /**
   * Calculates the multiplicative inverse of <i>this</i> using the modified almost inverse
   * algorithm and returns the result in a new GF2nPolynomialElement.
   *
   * @return <i>this</i>^(-1)
   * @throws ArithmeticException if <i>this</i> equals zero
   */
  ...
  /**
   * This method is used internally to map the square()-calls within GF2nPolynomialElement to one of
  ...
  /**
   * Squares this GF2nPolynomialElement using GF2nField's squaring matrix. This is supposed to be
   * fast when using a polynomial (no tri- or pentanomial) as fieldpolynomial. Use squarePreCalc
  ...
  /**
   * Squares this GF2nPolynomialElement using GF2nFields squaring matrix. This is supposed to be
   * fast when using a polynomial (no tri- or pentanomial) as fieldpolynomial. Use squarePreCalc
   * when using a tri- or pentanomial as fieldpolynomial instead.
   *
   * @see GF2Polynomial#vectorMult
  ...
  /**
   * Squares this GF2nPolynomialElement by using precalculated values and reducing. This is supposed
   * to de fastest when using a trinomial or pentanomial as field polynomial. Use squareMatrix when
  ...
  /**
   * Calculates <i>this</i> to the power of <i>k</i> and returns the result in a new
   * GF2nPolynomialElement.
   *
   * @param k the power
  ...
  /**
   * Solves the quadratic equation <tt>z<sup>2</sup> + z = this</tt> if such a solution exists. This
   * method returns one of the two possible solutions. The other solution is <tt>z + 1</tt>. Use
   * z.increase() to compute this solution.
   *
   * @return a GF2nPolynomialElement representing one z satisfying the equation <tt>z<sup>2</sup> +
   * z = this</tt>
  ...
  /**
   * Reduce this GF2nPolynomialElement using the trinomial x^n + x^tc + 1 as fieldpolynomial. The
   * coefficients are reduced bit by bit.
   */
  ...
  /**
   * Reduce this GF2nPolynomialElement using the pentanomial x^n + x^pc[2] + x^pc[1] + x^pc[0] + 1
   * as fieldpolynomial. The coefficients are reduced bit by bit.
   */
  ...
  /**
   * Returns a string representing this Bitstrings value using hexadecimal radix in MSB-first
   * order.
   *
  ...
  /**
   * Returns a string representing this Bitstrings value using hexadecimal or binary radix in
   * MSB-first order.
   *
