    ...
    extends GF2nElement
{
     ...
     */
    public GF2nPolynomialElement(org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement other)
    {
        mField = other.mField;
     ...
     */
    public static org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement ZERO(GF2nPolynomialField f)
    {
     ...
     */
    public static org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement ONE(GF2nPolynomialField f)
    {
        GF2Polynomial polynomial = new GF2Polynomial(f.getDegree(),
            new int[]{1});
        return new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement(f, polynomial);
    ...
    {
        if (other == null || !(other instanceof org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement))
        {
            return false;
        }
    ...
    {
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement result = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement(this);
        ...
        throws RuntimeException
    {
        ...
        if (!mField.equals(((org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement)addend).mField))
        {
            throw new RuntimeException();
        }
        polynomial.addToThis(((org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement)addend).polynomial);
    }
        ...
        throws RuntimeException
    {
        ...
        if (!mField.equals(((org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement)factor).mField))
        {
            throw new RuntimeException();
        }
        if (equals(factor))
        ...
        polynomial = polynomial
            .multiply(((org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement)factor).polynomial);
        reduceThis();
    }
        ...
        throws ArithmeticException
    {
        ...
        b.reduceN();
        return new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement((GF2nPolynomialField)mField, b);
    }
        ...
        throws ArithmeticException
    {
        ...
        while (true)
        {
            ...
            if (u.isOne())
            {
                return new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement((GF2nPolynomialField)mField,
                    b);
            }
            u.reduceN();
            v.reduceN();
    ...
    public org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement power(int k)
    {
        ...
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement x = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement(this);
     ...
     * {@link org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement}.
     *
    ...
    public int trace()
    {
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement t = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement(this);
        int i;
        ...
        throws RuntimeException
    {
        ...
        int i;
        org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement h = new org.bouncycastle.pqc.math.linearalgebra.GF2nPolynomialElement(this);
