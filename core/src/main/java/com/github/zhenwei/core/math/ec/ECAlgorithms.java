...
public class ECAlgorithms {
  ...
  public static ECPoint sumOfTwoMultiplies(ECPoint P, BigInteger a,
    ...
    if (endomorphism instanceof GLVEndomorphism) {
      return implCheckResult(
          implSumOfMultipliesGLV(new ECPoint[]{P, Q}, new BigInteger[]{a, b},
  ...
  static ECPoint implShamirsTrickWNaf(ECEndomorphism endomorphism, ECPoint P, BigInteger k,
      BigInteger l) {
    boolean negK = k.signum() < 0, negL = l.signum() < 0;
    ...
    WNafPreCompInfo infoQ = WNafUtil.precomputeWithPointMap(Q, endomorphism.getPointMap(), infoP,
        true);
  ...
  private static ECPoint implShamirsTrickFixedPoint(ECPoint p, BigInteger k, ECPoint q,
      BigInteger l) {
    ECCurve c = p.getCurve();
    int combSize = FixedPointUtil.getCombSize(c);
