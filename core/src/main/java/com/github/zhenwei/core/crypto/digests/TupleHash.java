...
/**
 * TupleHash - a hash designed  to  simply  hash  a  tuple  of  input  strings,  any  or  all  of
 * which  may  be  empty  strings, in  an  unambiguous way with an optional XOF mode.
 * <p>
