...
public final class Streams {
  ...
  /**
   * Read from inStr up to a maximum number of bytes, throwing an exception if more the maximum
   * amount of requested data is available.
   *
   * @param inStr stream to be read.
   * @param limit maximum number of bytes that can be read.
   * @return a byte array representing the contents of inStr.
   * @throws IOException in case of underlying IOException, or if limit is reached on inStr still
   *                     has data in it.
   */
