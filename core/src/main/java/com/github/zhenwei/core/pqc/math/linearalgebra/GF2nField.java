...
/**
 * This abstract class defines the finite field <i>GF(2<sup>n</sup>)</i>. It holds the extension
 * degree <i>n</i>, the characteristic, the irreducible fieldpolynomial and conversion matrices.
 * GF2nField is implemented by the classes GF2nPolynomialField and GF2nONBField.
 *
 * @see GF2nONBField
