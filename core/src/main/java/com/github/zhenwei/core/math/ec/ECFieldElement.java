    ...
    public ECFieldElement sqrt() {
      ...
      do {
        ...
        while (P.compareTo(q) >= 0
            || !modReduce(P.multiply(P).subtract(fourX)).modPow(legendreExponent, q)
            .equals(qMinusOne));
...
//            }
  ...
  public static class F2m extends AbstractF2m {
    ...
    /**
     * Indicates gaussian normal basis representation (GNB). Number chosen according to 62. GNB is
     * not implemented at present.
     */
    public static final int GNB = 1;

    /**
     * Indicates trinomial basis representation (TPB). Number chosen according to 62.
     */
    public static final int TPB = 2;

    /**
     * Indicates pentanomial basis representation (PPB). Number chosen according to 62.
     */
     ...
     * TPB (trinomial basis representation) or PPB (pentanomial basis representation).
     */
    ...
    /**
     * @return TPB: The integer <code>k</code> where <code>x<sup>m</sup> + x<sup>k</sup> + 1</code>
    ...
    /**
     * @return TPB: Always returns <code>0</code><br> PPB: The integer <code>k2</code> where
    ...
    /**
     * @return TPB: Always set to <code>0</code><br> PPB: The integer <code>k3</code> where
     * <code>x<sup>m</sup> + x<sup>k3</sup> + x<sup>k2</sup> + x<sup>k1</sup> + 1</code> represents
     * the reduction polynomial <code>f(z)</code>.<br>
     */
    public int getK3() {
