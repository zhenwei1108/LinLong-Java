...
import com.github.zhenwei.core.crypto.Commitment;
import com.github.zhenwei.core.crypto.Committer;
...
/**
 * A basic hash-committer based on the one described in "Making Mix Nets Robust for Electronic
 * Voting by Randomized Partial Checking", by Jakobsson, Juels, and Rivest (11th Usenix Security
 * Symposium, 2002).
 * <p>
 * The algorithm used by this class differs from the one given in that it includes the length of the
 * message in the hash calculation.
 * </p>
 */
public class GeneralHashCommitter
  ...
  /**
   * Base Constructor. The maximum message length that can be committed to is half the length of the
   * internal block size for the digest (ExtendedDigest.getBlockLength()).
   *
