...
/**
 * This class describes decoding operations of an irreducible binary Goppa code. A check matrix H of
 * the Goppa code and an irreducible Goppa polynomial are used the operations are worked over a
 * finite field GF(2^m)
 *
 * @see GF2mField
...
public final class GoppaCode {
  ...
  /**
   * This class is a container for an instance of {@link GF2Matrix} and one int[]. It is used to
   * hold a generator matrix and the set of indices such that the submatrix of the generator matrix
  ...
  public static class MatrixSet {
     ...
     * @param setJ the set of indices such that the submatrix of the generator matrix consisting of
     *             the specified columns is the identity
     */
    ...
    /**
     * @return the set of indices such that the submatrix of the generator matrix consisting of the
     * specified columns is the identity
     */
    public int[] getSetJ() {
      return setJ;
    }
  ...
  /**
   * Construct the check matrix of a Goppa code in canonical form from the irreducible Goppa
  ...
  /**
   * Find an error vector <tt>e</tt> over <tt>GF(2)</tt> from an input syndrome <tt>s</tt> over
   * <tt>GF(2<sup>m</sup>)</tt>.
   *
