 ...
 * <p>
 * This Java implementation is based on the Java reference implementation provided by Bruce Schneier
 * and developed by Raif S. Naffah.
 */
public final class TwofishEngine
  ...
  /**
   * Define the fixed p0/p1 permutations used in keyed S-box lookup. By changing the following
   * constant definitions, the S-boxes will automatically get changed in the Twofish engine.
   */
  ...
  /**
   * Encrypt the given input starting at the given offset and place the result in the provided
   * buffer starting at the given offset. The input will be an exact multiple of our blocksize.
   * <p>
  ...
  /**
   * Decrypt the given input starting at the given offset and place the result in the provided
   * buffer starting at the given offset. The input will be an exact multiple of our blocksize.
   */
  ...
  /**
   * Use (12, 8) Reed-Solomon code over GF(256) to produce a key S-box 32-bit entity from 2 key
   * material 32-bit entities.
   *
