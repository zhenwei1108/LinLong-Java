...
/**
 * Implements the client side SRP-6a protocol. Note that this class is stateful, and therefore NOT
...
public class SRP6Client {
  ...
  /**
   * Computes the client evidence message M1 using the previously received values. To be called
   * after calculating the secret S.
   *
   ...
   * called after verifying the server evidence message M2.
   *
