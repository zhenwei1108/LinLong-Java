...
public class Base32Encoder
  ...
  /**
   * decode the base 32 encoded byte data writing it to the given output stream, whitespace
  ...
  /**
   * decode the base 32 encoded String data writing it to the given output stream, whitespace
   * characters will be ignored.
   *
   * @return the number of bytes produced.
   */
