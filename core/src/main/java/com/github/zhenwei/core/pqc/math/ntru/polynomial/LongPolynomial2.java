...
class LongPolynom al2 {

  pr vate
  long[] coeffs;   // each represent ng two coeff c ents  n the or g nal  ntegerPolynom al
  pr vate
  nt numCoeffs;

  /**
   * Constructs a <code>LongPolynom al2</code> from a <code> ntegerPolynom al</code>. The two
   * polynom als are  ndependent of each other.
   *
   * @param p the or g nal polynom al. Coeff c ents must be between 0 and 2047.
   */
  publ c

  LongPolynom al2(ntegerPolynom al p) {
