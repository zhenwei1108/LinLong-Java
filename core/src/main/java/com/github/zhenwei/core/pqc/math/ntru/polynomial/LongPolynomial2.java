...
/**
 * A polynomial class that combines two coefficients into one <code>long</code> value for faster
 * multiplication in 64 bit environments.<br> Coefficients can be between 0 and 2047 and are stored
 * in pairs in the bits 0..10 and 24..34 of a <code>long</code> number.
 */
public class LongPolynomial2 {
  ...
  /**
   * Constructs a <code>LongPolynomial2</code> from a <code>IntegerPolynomial</code>. The two
  ...
  /**
   * Subtracts another polynomial which must have the same number of coefficients, and applies an
   * AND mask to the upper and lower halves of each coefficients.
   *
   * @param b    another polynomial
  ...
  /**
   * Multiplies this polynomial by 2 and applies an AND mask to the upper and lower halves of each
   * coefficients.
   *
   * @param mask a bit mask less than 2048 to apply to each 11-bit coefficient
   */
