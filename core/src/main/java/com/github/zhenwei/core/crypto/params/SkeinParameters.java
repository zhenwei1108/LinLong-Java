...
public class SkeinParameters
  ...
  public static class Builder {
     ...
     * range 0,5..62, and cannot use the value {@link #PARAM_TYPE_MESSAGE} (reserved for message
     * body).
     * <p>
     * Parameters with type &lt; {@link #PARAM_TYPE_MESSAGE} are processed before the message
     * content, parameters with type &gt; {@link #PARAM_TYPE_MESSAGE} are processed after the
     * message and prior to output.
     *
