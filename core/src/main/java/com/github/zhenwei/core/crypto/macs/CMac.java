 ...
 * </p><p>
 * CMAC/OMAC1 is a blockcipher-based message authentication code designed and analyzed by Tetsu
 * Iwata and Kaoru Kurosawa.
 * </p><p>
 * CMAC/OMAC1 is a simple variant of the CBC MAC (Cipher Block Chaining Message Authentication
 * Code). OMAC stands for One-Key CBC MAC.
 * </p><p>
 * It supports 128- or 64-bits block ciphers, with any key size, and returns a MAC with dimension
 * less or equal to the block size of the underlying cipher.
 * </p>
 */
public class CMac implements Mac {
  ...
  /**
   * create a standard MAC based on a CBC block cipher (64 or 128 bit block). This will produce an
   * authentication code the length of the block size of the cipher.
   *
