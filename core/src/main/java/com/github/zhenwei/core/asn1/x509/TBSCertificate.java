 ...
 * </pre>
 * <p>
 * Note: issuerUniqueID and subjectUniqueID are both deprecated by the IETF. This class will parse
 * them, but you really shouldn't be creating new ones.
 */
public class TBSCertificate
  ...
  public ASN1Primitive toASN1Primitive() {
    if (Properties.getPropertyValue("com.github.zhenwei.provider.x509.allow_non-der_tbscert")
        != null) {
