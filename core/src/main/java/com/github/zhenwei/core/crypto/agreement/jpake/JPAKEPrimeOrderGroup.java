 ...
 * <p>
 * Typically a Schnorr group is used.  In general, J-PAKE can use any prime order group that is
 * suitable for public key cryptography, including elliptic curve cryptography.
 * <p>
...
public class JPAKEPrimeOrderGroup {
  ...
  /**
   * Internal package-private constructor used by the pre-approved groups in {@link
   * JPAKEPrimeOrderGroups}. These pre-approved groups can avoid the expensive checks.
   */
