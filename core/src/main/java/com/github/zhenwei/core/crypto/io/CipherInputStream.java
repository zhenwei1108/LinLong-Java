...
public class CipherInputStream
  ...
  /**
   * Constructs a CipherInputStream from an InputStream, a BufferedBlockCipher, and a specified
  ...
  /**
   * Constructs a CipherInputStream from an InputStream, a StreamCipher, and a specified internal
   * buffer size.
   */
  public CipherInputStream(
      InputStream is,
  ...
  /**
   * Constructs a CipherInputStream from an InputStream, an AEADBlockCipher, and a specified
   * internal buffer size.
   */
  public CipherInputStream(
      InputStream is,
  ...
  /**
   * Reads data from the underlying stream and processes it with the cipher until the cipher outputs
   * data, and returns the next available byte.
   * <p>
  ...
  /**
   * Reads data from the underlying stream and processes it with the cipher until the cipher outputs
   * data, and then returns up to <code>b.length</code> bytes in the provided array.
   * <p>
   * If the underlying stream is exhausted by this call, the cipher will be finalised.
   * </p>
   *
  ...
  /**
   * Reads data from the underlying stream and processes it with the cipher until the cipher outputs
   * data, and then returns up to <code>len</code> bytes in the provided array.
   * <p>
   * If the underlying stream is exhausted by this call, the cipher will be finalised.
   * </p>
   *
   ...
   * <p>
   * This method only works if markSupported() returns true - which means the underlying stream
   * supports marking, and the cipher passed in to this stream's constructor is a SkippingCipher (so
   * capable of being reset to an arbitrary point easily).
   * </p>
   *
  ...
  /**
   * Return true if mark(readlimit) is supported. This will be true if the underlying stream
   * supports marking and the cipher used is a SkippingCipher,
   *
