    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.nist.KMACwithSHAKE256_params getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.nist.KMACwithSHAKE256_params)
        {
            return (org.bouncycastle.asn1.nist.KMACwithSHAKE256_params)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.asn1.nist.KMACwithSHAKE256_params(ASN1Sequence.getInstance(o));
        }
