...
public class CTRSP800DRBG
   ...
   */
  public CTRSP800DRBG(BlockCipher engine, int keySizeInBits, int securityStrength,
  ...
  private static final byte[] K_BITS = Hex.decodeStrict(
  ...
  private void padKey(byte[] keyMaster, int keyOff, byte[] tmp, int tmpOff) {
    ...
    tmp[tmpOff + 1] = (byte) ((keyMaster[keyOff + 0] << 7) | ((keyMaster[keyOff + 1] & 0xfc)
        >>> 1));
    tmp[tmpOff + 2] = (byte) ((keyMaster[keyOff + 1] << 6) | ((keyMaster[keyOff + 2] & 0xf8)
        >>> 2));
    tmp[tmpOff + 3] = (byte) ((keyMaster[keyOff + 2] << 5) | ((keyMaster[keyOff + 3] & 0xf0)
        >>> 3));
    tmp[tmpOff + 4] = (byte) ((keyMaster[keyOff + 3] << 4) | ((keyMaster[keyOff + 4] & 0xe0)
        >>> 4));
    tmp[tmpOff + 5] = (byte) ((keyMaster[keyOff + 4] << 3) | ((keyMaster[keyOff + 5] & 0xc0)
        >>> 5));
    tmp[tmpOff + 6] = (byte) ((keyMaster[keyOff + 5] << 2) | ((keyMaster[keyOff + 6] & 0x80)
        >>> 6));
