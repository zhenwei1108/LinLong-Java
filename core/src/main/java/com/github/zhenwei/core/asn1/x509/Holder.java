...
public class Holder
  ...
  /**
   * Constructs a holder with an entityName for V2 attribute certificates or with a subjectName for
   * V1 attribute certificates.
   *
   * @param entityName The entity or subject name.
   * @param version    The version of the attribute certificate.
   */
  ...
  /**
   * Returns the entityName for an V2 attribute certificate or the subjectName for an V1 attribute
   * certificate.
   *
