...
public class XMSSReducedSignature
  ...
  protected XMSSReducedSignature(Builder builder) {
    ...
    if (reducedSignature != null) {
      ...
      this.wotsPlusSignature = new WOTSPlusSignature(params.getWOTSPlus().getParams(),
          wotsPlusSignature);
      ...
      if (tmpSignature != null) {
        ...
        wotsPlusSignature = new WOTSPlusSignature(params.getWOTSPlus().getParams(),
            new byte[len][n]);
      }
      ...
      if (tmpAuthPath != null) {
        if (tmpAuthPath.size() != height) {
          throw new IllegalArgumentException(
              "size of authPath needs to be equal to height of tree");
        }
