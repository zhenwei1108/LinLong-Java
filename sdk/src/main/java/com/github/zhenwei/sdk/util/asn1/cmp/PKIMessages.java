    ...
    extends ASN1Object
{
    ...
    public static cmp.PKIMessages getInstance(Object o)
    {
        if (o instanceof cmp.PKIMessages)
        {
            return (cmp.PKIMessages)o;
        }

        if (o != null)
        {
            return new cmp.PKIMessages(ASN1Sequence.getInstance(o));
        }
