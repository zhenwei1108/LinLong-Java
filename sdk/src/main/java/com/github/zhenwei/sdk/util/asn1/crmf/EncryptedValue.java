    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.crmf.EncryptedValue getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.crmf.EncryptedValue)
        {
            return (org.bouncycastle.asn1.crmf.EncryptedValue)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.asn1.crmf.EncryptedValue(ASN1Sequence.getInstance(o));
        }
