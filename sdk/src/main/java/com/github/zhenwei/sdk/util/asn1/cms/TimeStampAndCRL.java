    ...
    extends ASN1Object
{
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.TimeStampAndCRL} object
     ...
     */
    public static cms.TimeStampAndCRL getInstance(Object obj)
    {
        if (obj instanceof cms.TimeStampAndCRL)
        {
            return (cms.TimeStampAndCRL)obj;
        }
        else if (obj != null)
        {
            return new cms.TimeStampAndCRL(ASN1Sequence.getInstance(obj));
        }
