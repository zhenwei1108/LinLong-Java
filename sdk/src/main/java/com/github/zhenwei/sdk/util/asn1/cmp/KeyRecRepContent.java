    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.cmp.KeyRecRepContent getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.cmp.KeyRecRepContent)
        {
            return (org.bouncycastle.asn1.cmp.KeyRecRepContent)o;
        }

        if (o != null)
        {
            return new org.bouncycastle.asn1.cmp.KeyRecRepContent(ASN1Sequence.getInstance(o));
        }
