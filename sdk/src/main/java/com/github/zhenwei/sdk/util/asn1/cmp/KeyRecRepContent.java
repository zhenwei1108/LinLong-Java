    ...
    extends ASN1Object
{
    ...
    public static cmp.KeyRecRepContent getInstance(Object o)
    {
        if (o instanceof cmp.KeyRecRepContent)
        {
            return (cmp.KeyRecRepContent)o;
        }

        if (o != null)
        {
            return new cmp.KeyRecRepContent(ASN1Sequence.getInstance(o));
        }
