    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.cmc.ModCertTemplate getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.cmc.ModCertTemplate)
        {
            return (org.bouncycastle.asn1.cmc.ModCertTemplate)o;
        }

        if (o != null)
        {
            return new org.bouncycastle.asn1.cmc.ModCertTemplate(ASN1Sequence.getInstance(o));
        }
