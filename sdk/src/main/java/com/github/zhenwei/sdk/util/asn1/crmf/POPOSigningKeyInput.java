    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.crmf.POPOSigningKeyInput getInstance(Object o)
    {
        if (o instanceof org.bouncycastle.asn1.crmf.POPOSigningKeyInput)
        {
            return (org.bouncycastle.asn1.crmf.POPOSigningKeyInput)o;
        }

        if (o != null)
        {
            return new org.bouncycastle.asn1.crmf.POPOSigningKeyInput(ASN1Sequence.getInstance(o));
        }
