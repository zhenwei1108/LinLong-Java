    ...
    extends ASN1Object
{
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.KeyTransRecipientInfo} object
     ...
     */
    public static cms.KeyTransRecipientInfo getInstance(
        Object obj)
    {
        if (obj instanceof cms.KeyTransRecipientInfo)
        {
            return (cms.KeyTransRecipientInfo)obj;
        }
        
        if(obj != null)
        {
            return new cms.KeyTransRecipientInfo(ASN1Sequence.getInstance(obj));
        }
