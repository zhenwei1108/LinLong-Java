    ...
    extends ASN1Object
{
    ...
    public static cmp.PKIHeader getInstance(Object o)
    {
        if (o instanceof cmp.PKIHeader)
        {
            return (cmp.PKIHeader)o;
        }

        if (o != null)
        {
            return new cmp.PKIHeader(ASN1Sequence.getInstance(o));
        }
