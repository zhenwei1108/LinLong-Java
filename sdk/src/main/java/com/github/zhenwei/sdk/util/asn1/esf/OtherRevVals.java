    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.esf.OtherRevVals getInstance(Object obj)
    {
        ...
        if (obj != null)
        {
            return new org.bouncycastle.asn1.esf.OtherRevVals(ASN1Sequence.getInstance(obj));
        }
