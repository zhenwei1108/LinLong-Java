    ...
    extends ASN1Object
{
     ...
     */
    public static cms.EnvelopedData getInstance(
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.EnvelopedData} object
    ...
    public static cms.EnvelopedData getInstance(
        Object obj)
    {
        if (obj instanceof cms.EnvelopedData)
        {
            return (cms.EnvelopedData)obj;
        }

        if (obj != null)
        {
            return new cms.EnvelopedData(ASN1Sequence.getInstance(obj));
        }
