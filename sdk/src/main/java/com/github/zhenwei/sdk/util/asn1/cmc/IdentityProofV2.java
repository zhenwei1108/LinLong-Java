    ...
    extends ASN1Object
{
    ...
    public static cmc.IdentityProofV2 getInstance(Object o)
    {
        if (o instanceof cmc.IdentityProofV2)
        {
            return (cmc.IdentityProofV2)o;
        }

        if (o != null)
        {
            return new cmc.IdentityProofV2(ASN1Sequence.getInstance(o));
        }
