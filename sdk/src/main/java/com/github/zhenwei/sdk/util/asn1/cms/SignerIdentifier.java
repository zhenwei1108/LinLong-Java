    ...
    implements ASN1Choice
{
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.SignerIdentifier} object
     ...
     */
    public static cms.SignerIdentifier getInstance(
        Object o)
    {
        if (o == null || o instanceof cms.SignerIdentifier)
        {
            return (cms.SignerIdentifier)o;
        }
        
        if (o instanceof IssuerAndSerialNumber)
        {
            return new cms.SignerIdentifier((IssuerAndSerialNumber)o);
        }
        
        if (o instanceof ASN1OctetString)
        {
            return new cms.SignerIdentifier((ASN1OctetString)o);
        }
        
        if (o instanceof ASN1Primitive)
        {
            return new cms.SignerIdentifier((ASN1Primitive)o);
        }
