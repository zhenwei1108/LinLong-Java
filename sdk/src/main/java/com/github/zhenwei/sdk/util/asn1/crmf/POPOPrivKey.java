    ...
    implements ASN1Choice
{
    ...
    public static org.bouncycastle.asn1.crmf.POPOPrivKey getInstance(Object obj)
    {
        ...
        if (obj != null)
        {
            return new org.bouncycastle.asn1.crmf.POPOPrivKey(ASN1TaggedObject.getInstance(obj));
        }

        return null;
    }

    public static org.bouncycastle.asn1.crmf.POPOPrivKey getInstance(ASN1TaggedObject obj, boolean explicit)
    {
