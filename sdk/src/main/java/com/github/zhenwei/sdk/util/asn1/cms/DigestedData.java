    ...
    extends ASN1Object
{
     ...
     */
    public static org.bouncycastle.asn1.cms.DigestedData getInstance(
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link org.bouncycastle.asn1.cms.DigestedData} object
        ...
        Object obj)
    {
        ...
        if (obj != null)
        {
            return new org.bouncycastle.asn1.cms.DigestedData(ASN1Sequence.getInstance(obj));
        }
