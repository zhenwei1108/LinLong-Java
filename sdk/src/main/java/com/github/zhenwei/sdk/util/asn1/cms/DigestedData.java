    ...
    extends ASN1Object
{
     ...
     */
    public static cms.DigestedData getInstance(
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.DigestedData} object
    ...
    public static cms.DigestedData getInstance(
        Object obj)
    {
        if (obj instanceof cms.DigestedData)
        {
            return (cms.DigestedData)obj;
        }
        
        if (obj != null)
        {
            return new cms.DigestedData(ASN1Sequence.getInstance(obj));
        }
