    ...
    extends ASN1Object
{
     ...
     */
    public static cms.CompressedData getInstance(
     ...
     * <ul>
     * <li> null &rarr; null
     * <li> {@link cms.CompressedData} object
    ...
    public static cms.CompressedData getInstance(
        Object obj)
    {
        if (obj instanceof cms.CompressedData)
        {
            return (cms.CompressedData)obj;
        }

        if (obj != null)
        {
            return new cms.CompressedData(ASN1Sequence.getInstance(obj));
        }
