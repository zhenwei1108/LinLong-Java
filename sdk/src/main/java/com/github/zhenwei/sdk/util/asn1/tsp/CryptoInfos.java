    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.tsp.CryptoInfos getInstance(final Object obj)
    {
        ...
        {
            return new org.bouncycastle.asn1.tsp.CryptoInfos(ASN1Sequence.getInstance(obj));
        }

        return null;
    }

    public static org.bouncycastle.asn1.tsp.CryptoInfos getInstance(
