    ...
    extends ASN1Object
{
    ...
    public static org.bouncycastle.asn1.cms.GenericHybridParameters getInstance(
        Object  o)
    {
        if (o instanceof org.bouncycastle.asn1.cms.GenericHybridParameters)
        {
            return (org.bouncycastle.asn1.cms.GenericHybridParameters)o;
        }
        else if (o != null)
        {
            return new org.bouncycastle.asn1.cms.GenericHybridParameters(ASN1Sequence.getInstance(o));
        }
