...
public class Pkcs7Test {
  ...
  @Test
  public void pkcs7Data() throws Exception {
    DEROctetString data = new DEROctetString(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ContentInfo contentInfo = new ContentInfo(Pkcs7ContentInfoTypeEnum.DATA.getOid(), data);
    System.out.println(Hex.toHexString(contentInfo.getEncoded(ASN1Encoding.DER)));
  }

  public void pkcs7SignedData(){
