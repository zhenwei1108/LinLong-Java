...
public class X509CRLEntryHolder {
  ...
  /**
   * Return the available names for the certificate issuer for the certificate referred to by this
   * CRL entry.
   * <p>
   * Note: this will be the issuer of the CRL unless it has been specified that the CRL is indirect
   * in the IssuingDistributionPoint extension and either a previous entry, or the current one, has
   * specified a different CA via the certificateIssuer extension.
   * </p>
   *
   ...
   * contained in this holder's CRL entry.
   *
