...
import com.github.zhenwei.pkix.util.asn1.crmf.AttributeTypeAndValue;
import com.github.zhenwei.pkix.util.asn1.crmf.CertReqMsg;
import com.github.zhenwei.pkix.util.asn1.crmf.CertRequest;
import com.github.zhenwei.pkix.util.asn1.crmf.CertTemplate;
import com.github.zhenwei.pkix.util.asn1.crmf.CertTemplateBuilder;
import com.github.zhenwei.pkix.util.asn1.crmf.OptionalValidity;
import com.github.zhenwei.pkix.util.asn1.crmf.PKMACValue;
import com.github.zhenwei.pkix.util.asn1.crmf.POPOPrivKey;
import com.github.zhenwei.pkix.util.asn1.crmf.ProofOfPossession;
import com.github.zhenwei.pkix.util.asn1.crmf.SubsequentMessage;
...
public class CertificateRequestMessageBuilder {
  ...
  /**
   * Request a validity period for the certificate. Either, but not both, of the date parameters may
   * be null.
   *
  ...
  public CertificateRequestMessageBuilder setValidity(Date notBeforeDate, Date notAfterDate) {
    templateBuilder.setValidity(
        new OptionalValidity(createTime(notBeforeDate), createTime(notAfterDate)));
  ...
  public CertificateRequestMessageBuilder setProofOfPossessionSigningKeySigner(
  ...
  public CertificateRequestMessageBuilder setProofOfPossessionSubsequentMessage(int type,
    ...
    if (type != ProofOfPossession.TYPE_KEY_ENCIPHERMENT
        && type != ProofOfPossession.TYPE_KEY_AGREEMENT) {
      throw new IllegalArgumentException(
          "type must be ProofOfPossession.TYPE_KEY_ENCIPHERMENT || ProofOfPossession.TYPE_KEY_AGREEMENT");
    }
  ...
  public CertificateRequestMessage build()
    ...
    if (popSigner != null) {
      ...
      if (template.getSubject() == null || template.getPublicKey() == null) {
        ...
        ProofOfPossessionSigningKeyBuilder builder = new ProofOfPossessionSigningKeyBuilder(
            pubKeyInfo);
