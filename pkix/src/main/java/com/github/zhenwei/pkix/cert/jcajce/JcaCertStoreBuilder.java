...
public class JcaCertStoreBuilder
{
     ...
     */
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder addCertificates(Store certStore)
    {
     ...
     */
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder addCRLs(Store crlStore)
    {
     ...
     */
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder addCRL(X509CRLHolder crl)
    {
        crls.add(crl);
    ...
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder setProvider(Provider provider)
    {
     ...
     */
    public org.bouncycastle.cert.jcajce.JcaCertStoreBuilder setType(String type)
    {
        this.type = type;
