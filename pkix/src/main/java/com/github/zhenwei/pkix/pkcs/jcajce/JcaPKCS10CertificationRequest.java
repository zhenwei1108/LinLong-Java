    ...
    extends PKCS10CertificationRequest
{
    ...
    public org.bouncycastle.pkcs.jcajce.JcaPKCS10CertificationRequest setProvider(String providerName)
    {
    ...
    public org.bouncycastle.pkcs.jcajce.JcaPKCS10CertificationRequest setProvider(Provider provider)
    {
