    ...
    implements Selector
{
    ...
    public boolean equals(
        Object  o)
    {
        if (!(o instanceof org.bouncycastle.cert.selector.X509CertificateHolderSelector))
        {
            return false;
        }

        org.bouncycastle.cert.selector.X509CertificateHolderSelector id = (org.bouncycastle.cert.selector.X509CertificateHolderSelector)o;
    ...
    public Object clone()
    {
        return new org.bouncycastle.cert.selector.X509CertificateHolderSelector(this.issuer, this.serialNumber, this.subjectKeyId);
    }
}