    ...
    extends ESTServiceBuilder
{
    ...
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withHostNameAuthorizer(JsseHostnameAuthorizer hostNameAuthorizer)
    {
        this.hostNameAuthorizer = hostNameAuthorizer;
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withClientProvider(ESTClientProvider clientProvider)
    {
        this.clientProvider = clientProvider;
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withTimeout(int timeoutMillis)
    {
        this.timeoutMillis = timeoutMillis;
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withReadLimit(long absoluteLimit)
    {
    ...
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withChannelBindingProvider(ChannelBindingProvider channelBindingProvider)
    {
        this.bindingProvider = channelBindingProvider;
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder addCipherSuites(String name)
    {
        this.supportedSuites.add(name);
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder addCipherSuites(String[] names)
    {
        this.supportedSuites.addAll(Arrays.asList(names));
        return this;
    }

    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withTLSVersion(String tlsVersion)
    {
    ...
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withSecureRandom(SecureRandom secureRandom)
    {
        if (this.socketFactoryCreator != null)
        {
            throw new IllegalStateException("Socket Factory Creator was defined in the constructor.");
     ...
     */
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withProvider(String tlsProviderName)
     ...
     * @return the current builder instance.
     */
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withProvider(Provider tlsProvider)
    {
        if (this.socketFactoryCreator != null)
        {
            throw new IllegalStateException("Socket Factory Creator was defined in the constructor.");
    ...
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withKeyManager(KeyManager keyManager)
    {
        if (this.socketFactoryCreator != null)
        {
            throw new IllegalStateException("Socket Factory Creator was defined in the constructor.");
    ...
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withKeyManagers(KeyManager[] keyManagers)
    {
        if (this.socketFactoryCreator != null)
        {
            throw new IllegalStateException("Socket Factory Creator was defined in the constructor.");
     ...
     * @return this;
     */
    public org.bouncycastle.est.jcajce.JsseESTServiceBuilder withFilterCipherSuites(boolean filter)
    {
