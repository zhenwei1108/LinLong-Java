...
import com.github.zhenwei.core.asn1.x509.DisplayText;
import com.github.zhenwei.core.asn1.x509.NoticeReference;
    ...
    while (e.hasMoreElements()) {
      ...
      if (object instanceof DisplayText || object instanceof ASN1String) {
        ...
        throw new IllegalArgumentException(
            "Invalid element in 'SPUserNotice': " + object.getClass().getName());
      }
    }
  }
