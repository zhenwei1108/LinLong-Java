...
/**
 * Implementation of the Archive Timestamp type defined in RFC4998. {@see <a
 * href="https://tools.ietf.org/html/rfc4998">RFC 4998</a>}
 * <p>
 * ASN.1 Archive Timestamp
 * <p>
 * ArchiveTimeStamp ::= SEQUENCE { digestAlgorithm [Ø] AlgorithmIdentifier OPTIONAL, attributes
 * [1] Attributes OPTIONAL, reducedHashtree [2] SEQUENCE OF PartialHashtree OPTIONAL, timeStamp
 * ContentInfo}
 * <p>
  ...
  public AlgorithmIdentifier getDigestAlgorithmIdentifier() {
    if (digestAlgorithm != null) {
      ...
      if (timeStamp.getContentType().equals(CMSObjectIdentifiers.signedData)) {
        ...
        if (tsData.getEncapContentInfo().getContentType()
            .equals(PKCSObjectIdentifiers.id_ct_TSTInfo)) {
