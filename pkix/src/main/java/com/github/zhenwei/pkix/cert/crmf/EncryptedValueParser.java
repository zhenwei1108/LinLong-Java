...
public class EncryptedValueParser {
  ...
  /**
   * Create a parser to read the passed in value, assuming the padder was applied to the data prior
   * to encryption.
   *
   * @param value  the value to be parsed.
   ...
   * @throws CRMFException if the decrypted data cannot be parsed, or a decryptor cannot be
   *                       generated.
   */
