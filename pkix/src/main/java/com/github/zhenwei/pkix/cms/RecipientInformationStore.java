...
public class RecipientInformationStore
  ...
  /**
   * Return the first RecipientInformation object that matches the passed in selector. Null if there
   * are no matches.
   *
  ...
  public Collection<RecipientInformation> getRecipients(
    ...
    if (selector instanceof KeyTransRecipientId) {
      ...
      if (issuer != null && subjectKeyId != null) {
        ...
        Collection<RecipientInformation> match2 = getRecipients(
            new KeyTransRecipientId(subjectKeyId));
        if (match2 != null) {
