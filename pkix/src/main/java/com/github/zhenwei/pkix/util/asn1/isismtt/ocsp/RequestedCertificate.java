...
/**
 * ISIS-MTT-Optional: The certificate requested by the client by inserting the RetrieveIfAllowed
 * extension in the request, will be returned in this extension.
 * <p>
 * ISIS-MTT-SigG: The signature act allows publishing certificates only then, when the certificate
 * owner gives his explicit permission. Accordingly, there may be �nondownloadable� certificates,
 * about which the responder must provide status information, but MUST NOT include them in the
 * response. Clients may get therefore the following three kind of answers on a single request
