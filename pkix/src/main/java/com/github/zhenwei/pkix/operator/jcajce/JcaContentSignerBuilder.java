...
public class JcaContentSignerBuilder
{
    ...
    public org.bouncycastle.operator.jcajce.JcaContentSignerBuilder setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.operator.jcajce.JcaContentSignerBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.operator.jcajce.JcaContentSignerBuilder setSecureRandom(SecureRandom random)
    {
        this.random = random;
