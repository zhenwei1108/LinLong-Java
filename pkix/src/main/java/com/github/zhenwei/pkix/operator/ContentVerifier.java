...
/**
 * General interface for an operator that is able to verify a signature based on data in a stream of
 * output.
 */
public interface ContentVerifier {

  /**
   * Return the algorithm identifier describing the signature algorithm and parameters this verifier
   * supports.
   *
  ...
  /**
   * Returns a stream that will accept data for the purpose of calculating a signature for later
