...
public class DefaultDigestAlgorithmIdentifierFinder
  ...
  static {
    ...
    digestOids.put(PKCSObjectIdentifiers.sha512_224WithRSAEncryption,
        NISTObjectIdentifiers.id_sha512_224);
    digestOids.put(PKCSObjectIdentifiers.sha512_256WithRSAEncryption,
    ...
    digestOids.put(BSIObjectIdentifiers.ecdsa_plain_RIPEMD160,
...
//        digestOids.put(GMObjectIdentifiers.sm2sign_with_sha512, NISTObjectIdentifiers.id_sha512);
    ...
    digestNameToOids.put("GOST3411-2012-256",
        RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256);
    digestNameToOids.put("GOST3411-2012-512",
        RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512);
  ...
  public AlgorithmIdentifier find(AlgorithmIdentifier sigAlgId) {
    ...
    if (sigAlgOid.equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
      digAlgOid = RSASSAPSSparams.getInstance(sigAlgId.getParameters()).getHashAlgorithm()
          .getAlgorithm();
