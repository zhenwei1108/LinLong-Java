...
public class EvidenceRecord
  ...
  public EvidenceRecord(
    ...
    this.archiveTimeStampSequence = new ArchiveTimeStampSequence(
  ...
  private EvidenceRecord(final ASN1Sequence sequence) {
        ...
        switch (asn1TaggedObject.getTagNo()) {
          ...
          default:
            throw new IllegalArgumentException(
                "unknown tag in getInstance: " + asn1TaggedObject.getTagNo());
        }
      } else {
    ...
    archiveTimeStampSequence = ArchiveTimeStampSequence.getInstance(
        sequence.getObjectAt(sequence.size() - 1));
  }
   ...
   * @param newChain states whether this new archive timestamp must be added as part of a new
   *                 sequence (i.e. in the case of hashtree renewal) or not (i.e. in the case of
   *                 timestamp renewal)
