...
public class PKCS10CertificationRequest
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof org.bouncycastle.pkcs.PKCS10CertificationRequest))
        {
            return false;
        }

        org.bouncycastle.pkcs.PKCS10CertificationRequest other = (org.bouncycastle.pkcs.PKCS10CertificationRequest)o;
