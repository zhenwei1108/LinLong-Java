    ...
    extends ASN1Object
{
    ...
    public static crmf.EncryptedValue getInstance(Object o)
    {
        if (o instanceof crmf.EncryptedValue)
        {
            return (crmf.EncryptedValue)o;
        }
        else if (o != null)
        {
            return new crmf.EncryptedValue(ASN1Sequence.getInstance(o));
        }
