 ...
 * EncapsulatedContentInfo and no SignerInfos attached.
 * </p>
 */
public class SimplePKIResponse
  ...
  /**
   * Return any X.509 certificate objects in this SimplePKIResponse structure as a Store of
  ...
  /**
   * Return any X.509 CRL objects in this SimplePKIResponse structure as a Store of X509CRLHolder
   * objects.
   *
