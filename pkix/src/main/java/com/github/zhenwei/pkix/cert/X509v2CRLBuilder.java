...
public class X509v2CRLBuilder
{
     ...
     */
    public org.bouncycastle.cert.X509v2CRLBuilder setNextUpdate(
        Date    date)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.cert.X509v2CRLBuilder addCRLEntry(BigInteger userCertificateSerial, Date revocationDate, int reason)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.cert.X509v2CRLBuilder addCRLEntry(BigInteger userCertificateSerial, Date revocationDate, int reason, Date invalidityDate)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.cert.X509v2CRLBuilder addCRLEntry(BigInteger userCertificateSerial, Date revocationDate, Extensions extensions)
    {
     ...
     * @return the current builder.
     */
    public org.bouncycastle.cert.X509v2CRLBuilder addCRL(X509CRLHolder other)
    {
     ...
     */
    public org.bouncycastle.cert.X509v2CRLBuilder addExtension(
     ...
     */
    public org.bouncycastle.cert.X509v2CRLBuilder replaceExtension(
        ASN1ObjectIdentifier oid,
        boolean isCritical,
        ASN1Encodable value)
        throws CertIOException
     ...
     */
    public org.bouncycastle.cert.X509v2CRLBuilder removeExtension(ASN1ObjectIdentifier oid)
    {
