...
public class JceCRMFEncryptorBuilder
{
    ...
    public org.bouncycastle.cert.crmf.jcajce.JceCRMFEncryptorBuilder setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.cert.crmf.jcajce.JceCRMFEncryptorBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.cert.crmf.jcajce.JceCRMFEncryptorBuilder setSecureRandom(SecureRandom random)
    {
        this.random = random;
