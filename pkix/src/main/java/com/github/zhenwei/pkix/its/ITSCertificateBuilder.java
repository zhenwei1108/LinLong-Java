...
import com.github.zhenwei.pkix.util.oer.its.CrlSeries;
import com.github.zhenwei.pkix.util.oer.its.HashedId;
import com.github.zhenwei.pkix.util.oer.its.PsidGroupPermissions;
import com.github.zhenwei.pkix.util.oer.its.PsidSsp;
import com.github.zhenwei.pkix.util.oer.its.SequenceOfPsidGroupPermissions;
import com.github.zhenwei.pkix.util.oer.its.SequenceOfPsidSsp;
...
public class ITSCertificateBuilder {
  ...
  public ITSCertificateBuilder(ITSCertificate issuer,
      ToBeSignedCertificate.Builder tbsCertificateBuilder) {
    this.issuer = issuer;
  ...
  /**
   * Set the cracaId. The default value for the field is 000000'H in line with ETSI TS 103 097
   * V1.4.1 (2020-10) default/constraint - Section 6.
   *
  ...
  /**
   * Set the crlSeries. The default value for the field is 0'D in line with ETSI TS 103 097 V1.4.1
   * (2020-10) default/constraint - Section 6.
   *
  ...
  public ITSCertificateBuilder setCertIssuePermissions(PsidGroupPermissions... permissions) {
    tbsCertificateBuilder.setCertIssuePermissions(
        SequenceOfPsidGroupPermissions.builder().addGroupPermission(permissions)
