...
public class PackedDate {
  ...
  /**
   * Base constructor from a java.util.date object. You may need to use this constructor if the
   * default locale doesn't use a Gregorian calender so that the PackedDate produced is compatible
   * with other ASN.1 implementations.
   *
   * @param time   a date object representing the time of interest.
