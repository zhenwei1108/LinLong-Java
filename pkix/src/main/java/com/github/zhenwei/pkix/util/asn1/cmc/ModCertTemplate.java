    ...
    extends ASN1Object
{
    ...
    public static cmc.ModCertTemplate getInstance(Object o)
    {
        if (o instanceof cmc.ModCertTemplate)
        {
            return (cmc.ModCertTemplate)o;
        }

        if (o != null)
        {
            return new cmc.ModCertTemplate(ASN1Sequence.getInstance(o));
        }
