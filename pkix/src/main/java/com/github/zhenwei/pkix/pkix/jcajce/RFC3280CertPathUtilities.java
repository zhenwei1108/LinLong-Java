        ...
        throws AnnotatedException, CRLNotFoundException
    {
        ...
        while (crl_iter.hasNext() && certStatus.getCertStatus() == CertStatus.UNREVOKED && !reasonMask.isAllReasons())
        {
            try
            {
                ...
                // (d)
                ReasonsMask interimReasonsMask = org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLD(crl, dp);
                ...
                // (f)
                Set keys = org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLF(crl, cert, defaultCRLSignCert, defaultCRLSignKey,
                    paramsPKIX, certPathCerts, helper);
                // (g)
                PublicKey key = org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLG(crl, keys);
                ...
                if (paramsPKIX.isUseDeltasEnabled())
                {
                    ...
                    // (h)
                    deltaCRL = org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLH(deltaCRLs, key);
                }
                ...
                org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLB1(dp, cert, crl);

                // (b) (2)
                org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLB2(dp, cert, crl);

                // (c)
                org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLC(deltaCRL, crl, paramsPKIX);

                // (i)
                org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLI(validityDate, deltaCRL, cert, certStatus, paramsPKIX);

                // (j)
                org.bouncycastle.pkix.jcajce.RFC3280CertPathUtilities.processCRLJ(validityDate, crl, cert, certStatus);
