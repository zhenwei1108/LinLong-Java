...
public class SignerInformationStore
  ...
  /**
   * Return the first SignerInformation object that matches the passed in selector. Null if there
   * are no matches.
   *
  ...
  public Collection<SignerInformation> getSigners(
    ...
    if (selector.getIssuer() != null && selector.getSubjectKeyIdentifier() != null) {
      ...
      Collection match1 = getSigners(
          new SignerId(selector.getIssuer(), selector.getSerialNumber()));
