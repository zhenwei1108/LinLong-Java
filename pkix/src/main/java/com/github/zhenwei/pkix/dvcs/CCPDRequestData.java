...
/**
 * Data piece of DVCRequest for CCPD service (Certify Claim of Possession of Data). It contains
 * CCPD-specific selector interface.
 * <p>
...
public class CCPDRequestData
  ...
  /**
   * Construct from corresponding ASN.1 Data structure. Note, that data should have messageImprint
   * choice, otherwise DVCSConstructionException is thrown.
   *
   * @param data
  ...
  private void initDigest()
    ...
    if (data.getMessageImprint() == null) {
      throw new DVCSConstructionException(
          "DVCSRequest.data.messageImprint should be specified for CCPD service");
    }
  }
