    ...
    implements PKMACValuesCalculator
{
    ...
    public org.bouncycastle.cert.crmf.jcajce.JcePKMACValuesCalculator setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.cert.crmf.jcajce.JcePKMACValuesCalculator setProvider(String providerName)
    {
