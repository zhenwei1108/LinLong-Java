...
import com.github.zhenwei.pkix.cert.X509v1CertificateBuilder;
...
public class JcaX509v1CertificateBuilder
   ...
   */
  public JcaX509v1CertificateBuilder(X500Name issuer, BigInteger serial, Date notBefore,
   ...
   * @param publicKey the public key to be associated with the certificate.
   */
  public JcaX509v1CertificateBuilder(X500Principal issuer, BigInteger serial, Date notBefore,
