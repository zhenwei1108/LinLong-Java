...
public class JceOpenSSLPKCS8EncryptorBuilder
{
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setRandom(SecureRandom random)
    {
        this.random = random;
     ...
     */
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setPasssword(char[] password)
    {
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setPassword(char[] password)
    {
        this.password = password;
     ...
     */
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setPRF(AlgorithmIdentifier prf)
    {
        this.prf = prf;
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setIterationCount(int iterationCount)
    {
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8EncryptorBuilder setProvider(Provider provider)
    {
