...
public class BasicOCSPRespBuilder {
  ...
  private class ResponseObject {
    ...
    public ResponseObject(
      ...
      if (certStatus == null) {
        ...
        if (rs.hasRevocationReason()) {
          this.certStatus = new CertStatus(
              new RevokedInfo(new ASN1GeneralizedTime(rs.getRevocationTime()),
    ...
    public SingleResponse toResponse()
        throws Exception {
      return new SingleResponse(certId.toASN1Primitive(), certStatus, thisUpdate, nextUpdate,
          extensions);
    }
  }
  ...
  public BasicOCSPResp build(
    ...
    ResponseData tbsResp = new ResponseData(responderID.toASN1Primitive(),
        new ASN1GeneralizedTime(producedAt), new DERSequence(responses), responseExtensions);
    DERBitString bitSig;
