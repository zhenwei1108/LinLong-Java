...
public class JcaHttpAuthBuilder
{
     ...
     */
    public org.bouncycastle.est.jcajce.JcaHttpAuthBuilder setProvider(Provider provider)
    {
     ...
     * @return this builder instance.
     */
    public org.bouncycastle.est.jcajce.JcaHttpAuthBuilder setProvider(String providerName)
    {
     ...
     * @return this builder instance.
     */
    public org.bouncycastle.est.jcajce.JcaHttpAuthBuilder setNonceGenerator(SecureRandom random)
    {
        this.random = random;
