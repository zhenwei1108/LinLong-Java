...
public class X509AttributeCertificateHolderSelectorBuilder {
  ...
  /**
   * Set the attribute certificate to be matched. If <code>null</code> is given any will do.
   *
  ...
  /**
   * Set the time, when the certificate must be valid. If <code>null</code> is given any will do.
   *
  ...
  /**
   * Sets the issuer the attribute certificate must have. If <code>null</code> is given any will
   * do.
   *
  ...
  /**
   * Adds a target name criterion for the attribute certificate to the target information extension
   * criteria. The <code>X509AttributeCertificateHolder</code> must contain at least one of the
   * specified target names.
   * <p>
   * Each attribute certificate may contain a target information extension limiting the servers
  ...
  /**
   * Adds a collection with target names criteria. If <code>null</code> is given any will do.
   * <p>
   * The collection consists of either GeneralName objects or byte[] arrays representing DER encoded
   * GeneralName structures.
   *
   * @param names A collection of target names.
   * @throws IOException if a parsing error occurs.
   * @see #addTargetName(com.github.zhenwei.core.asn1.x509.GeneralName)
   */
  ...
  /**
   * Adds a collection with target groups criteria. If <code>null</code> is given any will do.
   * <p>
   * The collection consists of <code>GeneralName</code> objects or <code>byte[]</code> representing
   * DER encoded GeneralNames.
   *
   * @param names A collection of target groups.
   * @throws IOException if a parsing error occurs.
   * @see #addTargetGroup(com.github.zhenwei.core.asn1.x509.GeneralName)
   */
  ...
  public X509AttributeCertificateHolderSelector build() {
    X509AttributeCertificateHolderSelector sel = new X509AttributeCertificateHolderSelector(
        holder, issuer, serialNumber, attributeCertificateValid, attributeCert,
        Collections.unmodifiableCollection(new HashSet(targetNames)),
        Collections.unmodifiableCollection(new HashSet(targetGroups)));
