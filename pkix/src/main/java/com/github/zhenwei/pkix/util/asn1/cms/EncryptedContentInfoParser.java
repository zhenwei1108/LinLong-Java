...
/**
 * Parser for <a href="https://tools.ietf.org/html/rfc5652#section-6.1">RFC 5652</a>
...
public class EncryptedContentInfoParser {
  ...
  public EncryptedContentInfoParser(
    ...
    _contentEncryptionAlgorithm = AlgorithmIdentifier.getInstance(
        seq.readObject().toASN1Primitive());
