...
public class PasswordRecipientInfo
  ...
  private PasswordRecipientInfo(
    ...
    if (seq.getObjectAt(1) instanceof ASN1TaggedObject) {
      keyDerivationAlgorithm = AlgorithmIdentifier.getInstance(
          (ASN1TaggedObject) seq.getObjectAt(1), false);
   ...
   * <li> {@link com.github.zhenwei.core.asn1.ASN1Sequence#getInstance(Object) ASN1Sequence} input formats with PasswordRecipientInfo structure inside
   * </ul>
   *
