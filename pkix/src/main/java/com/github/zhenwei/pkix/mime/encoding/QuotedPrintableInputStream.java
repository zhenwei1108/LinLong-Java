...
/**
 * Input stream that processes quoted-printable data, converting it into what was originally
 * intended.
 */
      ...
      if (j == '\r') {
        ...
        if (j >= '0' && j <= '9') {
          ...
          throw new IllegalStateException(
              "Expecting '0123456789ABCDEF after quote that was not immediately followed by LF or CRLF");
        }
        ...
        if (j >= '0' && j <= '9') {
          ...
          throw new IllegalStateException(
              "Expecting second '0123456789ABCDEF after quote that was not immediately followed by LF or CRLF");
        }
