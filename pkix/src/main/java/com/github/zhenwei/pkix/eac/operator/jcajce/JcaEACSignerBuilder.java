...
public class JcaEACSignerBuilder
{
    ...
    public org.bouncycastle.eac.operator.jcajce.JcaEACSignerBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.eac.operator.jcajce.JcaEACSignerBuilder setProvider(Provider provider)
    {
