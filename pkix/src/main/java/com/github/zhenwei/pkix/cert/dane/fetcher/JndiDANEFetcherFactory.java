    ...
    implements DANEEntryFetcherFactory
{
     ...
     */
    public org.bouncycastle.cert.dane.fetcher.JndiDANEFetcherFactory usingDNSServer(String dnsServer)
    {
     ...
     * @return the current factory..
     */
    public org.bouncycastle.cert.dane.fetcher.JndiDANEFetcherFactory setAuthoritative(boolean isAuthoritative)
    {
