...
public class X509v2AttributeCertificateBuilder
{
     ...
     */
    public org.bouncycastle.cert.X509v2AttributeCertificateBuilder addAttribute(ASN1ObjectIdentifier attrType, ASN1Encodable attrValue)
    {
     ...
     * @return this builder object.
     */
    public org.bouncycastle.cert.X509v2AttributeCertificateBuilder addAttribute(ASN1ObjectIdentifier attrType, ASN1Encodable[] attrValues)
    {
     ...
     * @return this builder object.
     */
    public org.bouncycastle.cert.X509v2AttributeCertificateBuilder addExtension(
     ...
     */
    public org.bouncycastle.cert.X509v2AttributeCertificateBuilder replaceExtension(
        ASN1ObjectIdentifier oid,
        boolean isCritical,
        ASN1Encodable value)
        throws CertIOException
     ...
     */
    public org.bouncycastle.cert.X509v2AttributeCertificateBuilder removeExtension(ASN1ObjectIdentifier oid)
    {
