...
import com.github.zhenwei.core.asn1.x509.AttCertIssuer;
import com.github.zhenwei.core.asn1.x509.Attribute;
...
import com.github.zhenwei.core.asn1.x509.V2AttributeCertificateInfoGenerator;
...
public class X509v2AttributeCertificateBuilder {
  ...
  public X509v2AttributeCertificateBuilder(AttributeCertificateHolder holder,
      AttributeCertificateIssuer issuer, BigInteger serialNumber, Date notBefore, Date notAfter) {
  ...
  /**
   * Base constructor with locale for interpreting dates. You may need to use this constructor if
   * the default locale doesn't use a Gregorian calender so that the GeneralizedTime produced is
   * compatible with other ASN.1 implementations.
   *
   * @param holder       holder certificate details
   * @param issuer       issuer of this attribute certificate.
   * @param serialNumber serial number of this attribute certificate.
  ...
  /**
   * Add a given extension field for the standard extensions tag made up of the passed in
   * parameters.
   *
  ...
  /**
   * Add a given extension field for the standard extensions using a byte encoding of the extension
   * value.
   *
   * @param oid          the OID defining the extension type.
   * @param isCritical   true if the extension is critical, false otherwise.
