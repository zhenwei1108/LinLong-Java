...
/**
 * General interface for an operator that is able to produce an InputStream that will decrypt a
 * stream of encrypted data.
 */
public interface InputDecryptor {

  /**
   * Return the algorithm identifier describing the encryption algorithm and parameters this
   * decryptor can process.
   *
  ...
  /**
   * Wrap the passed in input stream encIn, returning an input stream that decrypts what it reads
   * from encIn before returning it.
   *
