...
public class KeyTransRecipientId
  ...
  /**
   * Construct a key trans recipient ID based on the issuer and serial number of the recipient's
   ...
   * @param issuer       the issuer of the recipient's associated certificate.
   * @param serialNumber the serial number of the recipient's associated certificate.
   * @param subjectKeyId the subject key identifier to use to match the recipients associated
   *                     certificate.
   */
