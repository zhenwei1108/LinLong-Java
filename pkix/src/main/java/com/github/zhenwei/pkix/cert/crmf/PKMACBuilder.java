...
public class PKMACBuilder
{
     ...
     */
    public org.bouncycastle.cert.crmf.PKMACBuilder setSaltLength(int saltLength)
    {
        if (saltLength < 8)
        {
    ...
    public org.bouncycastle.cert.crmf.PKMACBuilder setIterationCount(int iterationCount)
    {
    ...
    public org.bouncycastle.cert.crmf.PKMACBuilder setSecureRandom(SecureRandom random)
    {
        this.random = random;
    ...
    public org.bouncycastle.cert.crmf.PKMACBuilder setParameters(PBMParameter parameters)
    {
