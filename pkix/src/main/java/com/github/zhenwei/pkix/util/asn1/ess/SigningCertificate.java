    ...
    extends ASN1Object
{
    ...
    public static ess.SigningCertificate getInstance(Object o)
    {
        if (o instanceof ess.SigningCertificate)
        {
            return (ess.SigningCertificate) o;
        }
        else if (o != null)
        {
            return new ess.SigningCertificate(ASN1Sequence.getInstance(o));
        }
