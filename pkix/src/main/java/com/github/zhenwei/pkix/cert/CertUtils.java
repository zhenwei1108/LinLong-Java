...
class CertUtils {
  ...
  static X509AttributeCertificateHolder generateFullAttrCert(ContentSigner signer,
    ...
    try {
      return new X509AttributeCertificateHolder(
          generateAttrStructure(attrInfo, signer.getAlgorithmIdentifier(),
  ...
  private static CertificateList generateCRLStructure(TBSCertList tbsCertList,
      AlgorithmIdentifier sigAlgId, byte[] signature) {
    ASN1EncodableVector v = new ASN1EncodableVector();
  ...
  static ExtensionsGenerator doRemoveExtension(ExtensionsGenerator extGenerator,
