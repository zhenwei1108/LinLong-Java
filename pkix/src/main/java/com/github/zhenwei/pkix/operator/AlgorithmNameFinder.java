...
public interface AlgorithmNameFinder {
  ...
  /**
   * Return a string representation of the passed in AlgorithmIdentifier, based on the OID in the
   * AlgorithmField, with the parameters included where appropriate.
   *
   * @param algorithmIdentifier the AlgorithmIdentifier of interest.
   * @return a "human friendly" representation of the algorithmIdentifier, the identifiers OID as a
