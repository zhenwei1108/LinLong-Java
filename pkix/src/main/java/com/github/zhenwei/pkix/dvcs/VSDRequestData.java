...
/**
 * Data piece of DVCS request to VSD service (Verify Signed Document). It contains VSD-specific
 * selector interface. Note: the request should contain CMS SignedData object as message.
 * <p>
    ...
    if (doc == null) {
      if (data.getMessage() == null) {
        throw new DVCSConstructionException(
            "DVCSRequest.data.message should be specified for VSD service");
      }
      try {
