package com.github.zhenwei.pkix.util.oer.its.template;


import com.github.zhenwei.pkix.util.oer.OERDefinition;
...
public class Ieee1609Dot2BaseTypes {
  ...
  public static final OERDefinition.Builder SequenceOfHashedId3 = OERDefinition.seqof(HashedId3)
      .label("SequenceOfHashedId3");
  ...
  /**
   * Duration ::= CHOICE { microseconds  Uint16, milliseconds  Uint16, seconds       Uint16, minutes
   * Uint16, hours         Uint16, sixtyHours    Uint16, years         Uint16 }
   */
   ...
   */
  public static final OERDefinition.Builder ValidityPeriod = OERDefinition.seq(Time32, Duration)
   ...
   */
  public static final OERDefinition.Builder Hostname = OERDefinition.utf8String(0, 255)
      .label("Hostname");

  /**
   * LinkageValue ::= OCTET STRING (SIZE(9))
   */
  public static final OERDefinition.Builder LinkageValue = OERDefinition.octets(9)
      .label("LinkageValue");
  ...
  public static final OERDefinition.Builder GroupLinkageValue = OERDefinition.seq(
      OERDefinition.octets(4), OERDefinition.octets(9)).label("GroupLinkageValue");
   ...
   */
  public static final OERDefinition.Builder LinkageSeed = OERDefinition.octets(16)
      .label("LinkageSeed");
  ...
  //
  /**
   * EccP256CurvePoint ::= CHOICE { x-only           OCTET STRING (SIZE (32)), fill
   * NULL, compressed-y-0   OCTET STRING (SIZE (32)), compressed-y-1   OCTET STRING (SIZE (32)),
  ...
  public static final OERDefinition.Builder EccP256CurvePoint = OERDefinition.choice(
      OERDefinition.octets(32), OERDefinition.nullValue(), OERDefinition.octets(32),
      OERDefinition.octets(32),
      OERDefinition.seq(OERDefinition.octets(32), OERDefinition.octets(32))
  ...
  public static final OERDefinition.Builder EcdsaP256Signature = OERDefinition.seq(
      EccP256CurvePoint, OERDefinition.octets(32)).label("EcdsaP256Signature");
  /**
  ...
  public static final OERDefinition.Builder EccP384CurvePoint = OERDefinition.choice(
      OERDefinition.octets(48), OERDefinition.nullValue(), OERDefinition.octets(48),
      OERDefinition.octets(48),
      OERDefinition.seq(OERDefinition.octets(48), OERDefinition.octets(48))
  ).label("EccP384CurvePoint");
  /**
   * EcdsaP384Signature ::= SEQUENCE { rSig  EccP384CurvePoint, sSig  OCTET STRING (SIZE (48)) }
   */
  public static final OERDefinition.Builder EcdsaP384Signature = OERDefinition.seq(
      EccP384CurvePoint, OERDefinition.octets(48)).label("EcdsaP384Signature");
  /**
   * Signature ::= CHOICE { ecdsaNistP256Signature         EcdsaP256Signature,
   * ecdsaBrainpoolP256r1Signature  EcdsaP256Signature, ..., ecdsaBrainpoolP384r1Signature
   * EcdsaP384Signature }
   */
  ...
  /**
   * EciesP256EncryptedKey ::= SEQUENCE { v  EccP256CurvePoint, c  OCTET STRING (SIZE (16)), t
   ...
   */
  public static final OERDefinition.Builder PublicEncryptionKey = OERDefinition.seq(SymmAlgorithm,
      BasePublicEncryptionKey).label("PublicEncryptionKey");
  /**
  ...
  public static final OERDefinition.Builder EncryptionKey = OERDefinition.choice(
          PublicEncryptionKey.label("public"), SymmetricEncryptionKey.label("symmetric"))
      .label("EncryptionKey");
  /**
   * PublicVerificationKey ::= CHOICE { ecdsaNistP256         EccP256CurvePoint,
   * ecdsaBrainpoolP256r1  EccP256CurvePoint, ..., ecdsaBrainpoolP384r1  EccP384CurvePoint }
   */
   ...
   * Psid ::= INTEGER (0..MAX)
   */
  public static final OERDefinition.Builder Psid = OERDefinition.integer().rangeToMAXFrom(0)
      .label("Psid");
  /**
   * BitmapSsp ::= OCTET STRING (SIZE(0..31))
   */
  public static final OERDefinition.Builder BitmapSsp = OERDefinition.octets(0, 31)
      .label("BitmapSsp");
  /**
   * ServiceSpecificPermissions ::= CHOICE { opaque     OCTET STRING (SIZE(0..MAX)), ..., bitmapSsp
   * BitmapSsp }
   */
   ...
   */
  public static final OERDefinition.Builder PsidSsp = OERDefinition.seq(Psid,
      OERDefinition.optional(ServiceSpecificPermissions)).label("PsidSsp");
  /**
   * SequenceOfPsidSsp ::= SEQUENCE OF PsidSsp
   */
  public static final OERDefinition.Builder SequenceOfPsidSsp = OERDefinition.seqof(PsidSsp)
      .label("SequenceOfPsidSsp");
  /**
   * SequenceOfPsid ::= SEQUENCE OF Psid
   */
  public static final OERDefinition.Builder SequenceOfPsid = OERDefinition.seqof(Psid)
      .label("SequenceOfPsid");
  /**
   * SequenceOfOctetString ::= SEQUENCE (SIZE (0..MAX)) OF OCTET STRING (SIZE(0..MAX))
   */
  public static final OERDefinition.Builder SequenceOfOctetString = OERDefinition.seqof(
      OERDefinition.octets().rangeToMAXFrom(0)).label("SequenceOfOctetString");
  /**
   * BitmapSspRange ::= SEQUENCE { sspValue    OCTET STRING (SIZE(1..32)), sspBitmask  OCTET STRING
   * (SIZE(1..32)) }
   */
   ...
   */
  public static final OERDefinition.Builder PsidSspRange = OERDefinition.seq(Psid.label("psid"),
      OERDefinition.optional(SspRange.label("sspRange"))).label("PsidSspRange");
   ...
   */
  public static final OERDefinition.Builder SequenceOfPsidSspRange = OERDefinition.seqof(
      PsidSspRange).label("SequenceOfPsidSspRange");
  /**
   * SubjectAssurance ::= OCTET STRING (SIZE(1))
   */
  public static final OERDefinition.Builder SubjectAssurance = OERDefinition.octets(1)
      .label("SubjectAssurance");
  /**
   * CrlSeries ::= Uint16
   */
   ...
   */
  public static OERDefinition.Builder CountryAndRegions = OERDefinition.seq(CountryOnly,
      OERDefinition.seqof(UINT8)).label("CountryAndRegions");
  /**
   * RegionAndSubregions ::= SEQUENCE { region      Uint8, subregions  SequenceOfUint16 }
   */
  public static OERDefinition.Builder RegionAndSubregions = OERDefinition.seq(UINT8,
      OERDefinition.seqof(UINT16)).label("RegionAndSubregions");
  /**
   * SequenceOfRegionAndSubregions ::= SEQUENCE OF RegionAndSubregions
   */
  public static OERDefinition.Builder SequenceOfRegionAndSubregions = OERDefinition.seqof(
      RegionAndSubregions).label("SequenceOfRegionAndSubregions");
  /**
   * CountryAndSubregions ::= SEQUENCE { country              CountryOnly, regionAndSubregions
   * SequenceOfRegionAndSubregions }
   */
  public static OERDefinition.Builder CountryAndSubregions = OERDefinition.seq(CountryOnly,
      SequenceOfRegionAndSubregions).label("CountryAndSubregions");
  /**
   * OneEightyDegreeInt ::= INTEGER { min          (-1799999999), max          (1800000000), unknown
   * (1800000001) } (-1799999999..1800000001)
   */
  public static OERDefinition.Builder OneEightyDegreeInt = OERDefinition.integer(-1799999999,
      1800000001).label("OneEightyDegreeInt");
  public static OERDefinition.Builder KnownLongitude = OneEightyDegreeInt.copy()
      .label("KnownLongitude(OneEightyDegreeInt)");
  public static OERDefinition.Builder UnknownLongitude = OERDefinition.integer(1800000001)
      .label("UnknownLongitude");
  /**
   * NinetyDegreeInt ::= INTEGER { min         (-900000000), max         (900000000), unknown
   * (900000001) } (-900000000..900000001)
   */
  public static OERDefinition.Builder NinetyDegreeInt = OERDefinition.integer(-900000000, 900000001)
      .label("NinetyDegreeInt");
  public static OERDefinition.Builder KnownLatitude = NinetyDegreeInt.copy()
      .label("KnownLatitude(NinetyDegreeInt)");
  ...
  public static OERDefinition.Builder Longitude = OneEightyDegreeInt.copy()
      .label("Longitude(OneEightyDegreeInt)");
  public static OERDefinition.Builder Latitude = NinetyDegreeInt.copy()
      .label("Latitude(NinetyDegreeInt)");
  public static OERDefinition.Builder ThreeDLocation = OERDefinition.seq(Latitude, Longitude,
      Elevation).label("ThreeDLocation");
  /**
   * TwoDLocation ::= SEQUENCE { latitude   Latitude, longitude  Longitude }
   */
  public static OERDefinition.Builder TwoDLocation = OERDefinition.seq(Latitude, Longitude)
      .label("TwoDLocation");
  /**
   * RectangularRegion ::= SEQUENCE { northWest  TwoDLocation, southEast  TwoDLocation }
   */
  public static OERDefinition.Builder RectangularRegion = OERDefinition.seq(TwoDLocation,
      TwoDLocation).label("RectangularRegion");
  /**
   * SequenceOfRectangularRegion ::= SEQUENCE OF RectangularRegion
   */
  public static OERDefinition.Builder SequenceOfRectangularRegion = OERDefinition.seqof(
      RectangularRegion).label("SequenceOfRectangularRegion");
  /**
   * CircularRegion ::= SEQUENCE { center  TwoDLocation, radius  Uint16 }
   */
  public static OERDefinition.Builder CircularRegion = OERDefinition.seq(TwoDLocation, UINT16)
      .label("CircularRegion");
  /**
   * PolygonalRegion ::= SEQUENCE SIZE (3..MAX) OF TwoDLocation -- treated as sequence of.
   */
  public static OERDefinition.Builder PolygonalRegion = OERDefinition.seqof(TwoDLocation)
      .rangeToMAXFrom(3).label("PolygonalRegion");
  /**
   * IdentifiedRegion ::= CHOICE { countryOnly           CountryOnly, countryAndRegions
   * CountryAndRegions, countryAndSubregions  CountryAndSubregions, ... }
   */
   ...
   */
  public static OERDefinition.Builder SequenceOfIdentifiedRegion = OERDefinition.seqof(
      IdentifiedRegion).label("SequenceOfIdentifiedRegion");
  /**
   * GeographicRegion ::= CHOICE { circularRegion     CircularRegion, rectangularRegion
   * SequenceOfRectangularRegion, polygonalRegion    PolygonalRegion, identifiedRegion
