...
import com.github.zhenwei.core.asn1.x509.PolicyConstraints;
...
public class CertificatePoliciesValidation
  ...
  CertificatePoliciesValidation(int pathLength, boolean isExplicitPolicyRequired,
      boolean isAnyPolicyInhibited, boolean isPolicyMappingInhibited) {
    //
    // (d)
    //
  ...
  public void validate(CertPathValidationContext context, X509CertificateHolder certificate)
    ...
    if (!context.isEndEntity()) {
      if (!ValidationUtils.isSelfIssued(certificate)) {
        ...
        // I (1), (2)
        //
        PolicyConstraints policyConstraints = PolicyConstraints.fromExtensions(
