...
public class JcaContentVerifierProviderBuilder
{
    ...
    public org.bouncycastle.operator.jcajce.JcaContentVerifierProviderBuilder setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.operator.jcajce.JcaContentVerifierProviderBuilder setProvider(String providerName)
    {
