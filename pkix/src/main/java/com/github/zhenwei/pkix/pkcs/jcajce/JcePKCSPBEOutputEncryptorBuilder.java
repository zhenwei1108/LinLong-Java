...
public class JcePKCSPBEOutputEncryptorBuilder
{
    ...
    public org.bouncycastle.pkcs.jcajce.JcePKCSPBEOutputEncryptorBuilder setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.pkcs.jcajce.JcePKCSPBEOutputEncryptorBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.pkcs.jcajce.JcePKCSPBEOutputEncryptorBuilder setRandom(SecureRandom random)
    {
        this.random = random;
     ...
     */
    public org.bouncycastle.pkcs.jcajce.JcePKCSPBEOutputEncryptorBuilder setKeySizeProvider(SecretKeySizeProvider keySizeProvider)
    {
     ...
     * @throws IllegalStateException if this builder was intialised with a PBKDFDef
     */
    public org.bouncycastle.pkcs.jcajce.JcePKCSPBEOutputEncryptorBuilder setIterationCount(int iterationCount)
    {
        if (pbkdf != null)
        {
