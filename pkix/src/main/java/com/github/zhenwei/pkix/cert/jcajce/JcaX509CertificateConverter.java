...
/**
 * Converter for producing X509Certificate objects tied to a specific provider from
...
public class JcaX509CertificateConverter {
  ...
  /**
   * Use the configured converter to produce a X509Certificate object from a X509CertificateHolder
   * object.
   *
  ...
  public X509Certificate getCertificate(X509CertificateHolder certHolder)
    ...
    try {
      ...
      throw new ExCertificateParsingException("exception parsing certificate: " + e.getMessage(),
          e);
