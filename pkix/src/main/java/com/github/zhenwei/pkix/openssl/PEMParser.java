        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.github.zhenwei.core.asn1.sec.ECPrivateKey pKey = com.github.zhenwei.core.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey keyStruct = com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey.getInstance(seq);
