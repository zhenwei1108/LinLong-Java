    ...
    extends ASN1Object
{
    ...
    public static cmc.CMCStatusInfoV2 getInstance(Object o)
    {
        if (o instanceof cmc.CMCStatusInfoV2)
        {
            return (cmc.CMCStatusInfoV2)o;
        }

        if (o != null)
        {
            return new cmc.CMCStatusInfoV2(ASN1Sequence.getInstance(o));
        }
