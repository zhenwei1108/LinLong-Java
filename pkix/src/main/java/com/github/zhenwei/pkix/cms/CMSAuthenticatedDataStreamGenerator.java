...
//    private Object              _unprotectedAttributes = null;
  ...
  /**
   * Use a BER Set to store the recipient information. By default recipients are stored in a DER
   * encoding.
   *
  ...
  public OutputStream open(
    ...
    try {
      ...
      return new CmsAuthenticatedDataOutputStream(macCalculator, digestCalculator, dataType, mOut,
          cGen, authGen, eiGen);
    } catch (IOException e) {
    ...
    public void close()
      ...
      if (digestCalculator != null) {
        parameters = Collections.unmodifiableMap(
            getBaseParameters(contentType, digestCalculator.getAlgorithmIdentifier(),
      ...
      if (unauthGen != null) {
        envGen.addObject(new DERTaggedObject(false, 3,
            new BERSet(unauthGen.getAttributes(parameters).toASN1EncodableVector())));
      }
