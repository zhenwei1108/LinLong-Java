    ...
    extends AsymmetricKeyUnwrapper
{
    ...
    public org.bouncycastle.operator.jcajce.JceAsymmetricKeyUnwrapper setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.operator.jcajce.JceAsymmetricKeyUnwrapper setProvider(String providerName)
    {
     ...
     */
    public org.bouncycastle.operator.jcajce.JceAsymmetricKeyUnwrapper setMustProduceEncodableUnwrappedKey(boolean unwrappedKeyMustBeEncodable)
    {
