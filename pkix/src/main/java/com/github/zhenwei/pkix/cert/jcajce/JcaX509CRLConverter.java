...
public class JcaX509CRLConverter
{
     ...
     */
    public org.bouncycastle.cert.jcajce.JcaX509CRLConverter setProvider(Provider provider)
    {
     ...
     * @return the converter instance.
     */
    public org.bouncycastle.cert.jcajce.JcaX509CRLConverter setProvider(String providerName)
    {
