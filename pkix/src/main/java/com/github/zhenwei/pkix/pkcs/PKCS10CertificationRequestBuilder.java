...
public class PKCS10CertificationRequestBuilder {
  ...
  /**
   * Set an attribute to the certification request we are building. Removed existing attributes with
   * the same attrType.
   *
   ...
   */
  public PKCS10CertificationRequestBuilder setAttribute(ASN1ObjectIdentifier attrType,
  ...
  /**
   * Add an attribute with multiple values to the certification request we are building. Removed
   * existing attributes with the same attrType.
   *
   * @param attrType  the OID giving the type of the attribute.
   * @param attrValue the ASN.1 structure that forms the value of the attribute.
   * @return this builder object.
   ...
   *
   * @param leaveOffEmpty true if empty attributes should be left out of the encoding false
   *                      otherwise.
   * @return this builder object.
   */
  ...
  public PKCS10CertificationRequest build(
    ...
    try {
      ...
      return new PKCS10CertificationRequest(
          new CertificationRequest(info, signer.getAlgorithmIdentifier(),
