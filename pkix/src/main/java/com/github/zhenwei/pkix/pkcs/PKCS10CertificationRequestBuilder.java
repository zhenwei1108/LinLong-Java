...
public class PKCS10CertificationRequestBuilder
{
    ...
    public PKCS10CertificationRequestBuilder(
        org.bouncycastle.pkcs.PKCS10CertificationRequestBuilder original)
    {
     ...
     * @return this builder object.
     */
    public org.bouncycastle.pkcs.PKCS10CertificationRequestBuilder addAttribute(ASN1ObjectIdentifier attrType, ASN1Encodable attrValue)
    {
     ...
     * @return this builder object.
     */
    public org.bouncycastle.pkcs.PKCS10CertificationRequestBuilder addAttribute(ASN1ObjectIdentifier attrType, ASN1Encodable[] attrValues)
    {
     ...
     * @return this builder object.
     */
    public org.bouncycastle.pkcs.PKCS10CertificationRequestBuilder setLeaveOffEmptyAttributes(boolean leaveOffEmpty)
    {
