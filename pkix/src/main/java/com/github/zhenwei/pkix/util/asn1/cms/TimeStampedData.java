...
public class TimeStampedData
  ...
  public TimeStampedData(ASN1IA5String dataUri, MetaData metaData, ASN1OctetString content,
  ...
  private TimeStampedData(ASN1Sequence seq) {
    ...
    if (seq.getObjectAt(index) instanceof MetaData || seq.getObjectAt(
        index) instanceof ASN1Sequence) {
