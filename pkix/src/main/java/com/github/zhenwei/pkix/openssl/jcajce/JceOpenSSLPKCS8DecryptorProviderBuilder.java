...
public class JceOpenSSLPKCS8DecryptorProviderBuilder
{
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8DecryptorProviderBuilder setProvider(String providerName)
    {
    ...
    public org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8DecryptorProviderBuilder setProvider(Provider provider)
    {
