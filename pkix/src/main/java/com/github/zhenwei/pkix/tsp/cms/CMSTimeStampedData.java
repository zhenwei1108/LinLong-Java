...
public class CMSTimeStampedData
{
     ...
     * @throws CMSException
     */
    public org.bouncycastle.tsp.cms.CMSTimeStampedData addTimeStamp(TimeStampToken token)
        throws CMSException
    {
        ...
        return new org.bouncycastle.tsp.cms.CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData, new TimeStampedData(timeStampedData.getDataUri(), timeStampedData.getMetaData(), timeStampedData.getContent(), new Evidence(new TimeStampTokenEvidence(newTimeStamps)))));
    }
