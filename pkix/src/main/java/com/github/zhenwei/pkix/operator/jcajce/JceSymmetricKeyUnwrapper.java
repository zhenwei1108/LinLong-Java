    ...
    extends SymmetricKeyUnwrapper
{
    ...
    public org.bouncycastle.operator.jcajce.JceSymmetricKeyUnwrapper setProvider(Provider provider)
    {
    ...
    public org.bouncycastle.operator.jcajce.JceSymmetricKeyUnwrapper setProvider(String providerName)
    {
