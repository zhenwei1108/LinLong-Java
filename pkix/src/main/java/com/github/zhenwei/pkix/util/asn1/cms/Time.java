 ...
 * </pre>
 * <p>
 * This has a constructor using java.util.Date for input which generates a {@link
 * com.github.zhenwei.core.asn1.DERUTCTime DERUTCTime} object if the supplied datetime is in range
 * 1950-01-01-00:00:00 UTC until 2049-12-31-23:59:60 UTC. If the datetime value is outside that
 * range, the generated object will be {@link com.github.zhenwei.core.asn1.DERGeneralizedTime
 * DERGeneralizedTime}.
 */
public class Time
    extends ASN1Object
  ...
  /**
   * Creates a time object from a given date - if the date is between 1950 and 2049 a UTCTime object
   * is generated, otherwise a GeneralizedTime is used.
   *
  ...
  /**
   * Creates a time object from a given date and locale - if the date is between 1950 and 2049 a
   * UTCTime object is generated, otherwise a GeneralizedTime is used. You may need to use this
   * constructor if the default locale doesn't use a Gregorian calender so that the GeneralizedTime
   * produced is compatible with other ASN.1 implementations.
   *
   * @param time   a date object representing the time of interest.
   ...
   * <li> null &rarr; null
   * <li> {@link Time} object
   * <li> {@link com.github.zhenwei.core.asn1.DERUTCTime DERUTCTime} object
   * <li> {@link com.github.zhenwei.core.asn1.DERGeneralizedTime DERGeneralizedTime} object
   * </ul>
   *
