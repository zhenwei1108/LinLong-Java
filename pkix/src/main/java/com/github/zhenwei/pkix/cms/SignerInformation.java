...
public class SignerInformation
{
     ...
     */
    protected SignerInformation(org.bouncycastle.cms.SignerInformation baseInfo)
    {
     ...
     */
    protected SignerInformation(org.bouncycastle.cms.SignerInformation baseInfo, SignerInfo info)
    {
        this.info = info;
        ...
        SignerInformationStore   counterSigners)
    {
        ...
        {
            sigs.add(((org.bouncycastle.cms.SignerInformation)it.next()).toASN1Structure());
        }
