    ...
    extends MimeWriter
{
    public static class Builder
    {
        ...
        public org.bouncycastle.mime.smime.SMIMEEnvelopedWriter build(OutputStream mimeOut, OutputEncryptor outEnc)
        {
            return new org.bouncycastle.mime.smime.SMIMEEnvelopedWriter(this, outEnc, SMimeUtils.autoBuffer(mimeOut));
        }
    }
