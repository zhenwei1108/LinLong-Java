...
/**
 * JCA helper class to allow BC lightweight objects to be used in the construction of a Version 1
 * certificate.
 */
public class BcX509v1CertificateBuilder
   ...
   */
  public BcX509v1CertificateBuilder(X500Name issuer, BigInteger serial, Date notBefore,
