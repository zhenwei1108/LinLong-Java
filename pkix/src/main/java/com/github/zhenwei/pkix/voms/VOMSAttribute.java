...
import com.github.zhenwei.core.asn1.x509.IetfAttrSyntax;
import com.github.zhenwei.pkix.cert.X509AttributeCertificateHolder;
import java.util.ArrayList;
import java.util.List;

/**
 * Representation of the authorization information (VO, server address and list of Fully Qualified
 * Attribute Names, or FQANs) contained in a VOMS attribute certificate.
 */
public class VOMSAttribute {
  ...
  public VOMSAttribute(X509AttributeCertificateHolder ac) {
    ...
    try {
      for (int i = 0; i != l.length; i++) {
        ...
        String url = ((ASN1IA5String) attr.getPolicyAuthority()
  ...
  /**
   * @return List of String of the VOMS fully qualified attributes names (FQANs):<br>
  ...
  /**
   * @return List of FQAN of the VOMS fully qualified attributes names (FQANs)
   */
