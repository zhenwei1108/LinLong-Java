...
public class SecT193R2Curve extends AbstractF2m {
  ...
  private static final ECFieldElement[] SECT193R2_AFFINE_ZS = new ECFieldElement[]{
  ...
  public SecT193R2Curve() {
    ...
    this.a = fromBigInteger(
        new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
    this.b = fromBigInteger(
        new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
