...
public class Fingerprint {
  ...
  /**
   * Base constructor - use SHAKE-256 (160 bits). This is the recommended one as it is also produced
   * by the FIPS API.
   *
  ...
  /**
   * Constructor with length - use SHAKE-256 (bitLength bits). This is the recommended one as it is
   * also produced by the FIPS API.
   *
   * @param source original data to calculate the fingerprint from.
   */
