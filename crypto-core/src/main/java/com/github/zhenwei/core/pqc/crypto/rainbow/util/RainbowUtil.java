...
/**
 * This class is needed for the conversions while encoding and decoding, as well as for comparison
 * between arrays of some dimensions
 */
public class RainbowUtil {
  ...
  /**
   * This function converts an one-dimensional array of bytes into a one-dimensional array of type
   * short
   *
   * @param in the array to be converted
  ...
  /**
   * This function converts a 3-dimensional array of type short into a 3-dimensional array of type
   * byte
   *
   * @param in the array to be converted
   * @return out the byte-array that corresponds the input
