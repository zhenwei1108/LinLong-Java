 ...
 * </pre>
 *
 * @see com.github.zhenwei.core.asn1.x509.Target
 * @see com.github.zhenwei.core.asn1.x509.TargetInformation
 */
public class Targets
   ...
   * @throws IllegalArgumentException if the contents of the sequence are invalid.
   */
