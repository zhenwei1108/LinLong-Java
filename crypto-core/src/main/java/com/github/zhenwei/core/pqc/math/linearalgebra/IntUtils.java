...
public final class IntUtils {
  ...
  /**
   * Sorts this array of integers according to the Quicksort algorithm. After calling this method
   * this array is sorted in ascending order with the smallest integer taking position 0 in the
   * array.
   * <p>
  ...
  /**
   * Split a subarray of a source array into two partitions. The left partition contains elements
   * that have value less than or equal to the pivot element, the right partition contains the
   * elements that have larger value.
   *
