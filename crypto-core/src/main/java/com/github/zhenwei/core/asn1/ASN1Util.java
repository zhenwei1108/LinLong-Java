...
public abstract class ASN1Util {
  ...
  static ASN1TaggedObjectParser checkTag(ASN1TaggedObjectParser taggedObjectParser, int tagClass,
      int tagNo) {
  ...
  public static ASN1TaggedObject getImplicitBaseTagged(ASN1TaggedObject taggedObject, int tagClass,
      int tagNo,
  ...
  public static ASN1TaggedObject getImplicitContextBaseTagged(ASN1TaggedObject taggedObject,
      int tagNo,
      int baseTagClass, int baseTagNo) {
    return getImplicitBaseTagged(taggedObject, BERTags.CONTEXT_SPECIFIC, tagNo, baseTagClass,
        baseTagNo);
  }
  ...
  public static ASN1TaggedObject tryGetImplicitContextBaseTagged(ASN1TaggedObject taggedObject,
      int tagNo,
      int baseTagClass, int baseTagNo) {
    return tryGetImplicitBaseTagged(taggedObject, BERTags.CONTEXT_SPECIFIC, tagNo, baseTagClass,
        baseTagNo);
  }
  ...
  public static ASN1TaggedObjectParser parseImplicitBaseTagged(
    ...
    return checkTag(taggedObjectParser, tagClass, tagNo).parseImplicitBaseTagged(baseTagClass,
        baseTagNo);
  }
  ...
  public static ASN1TaggedObjectParser parseImplicitContextBaseTagged(
    ...
    return parseImplicitBaseTagged(taggedObjectParser, BERTags.CONTEXT_SPECIFIC, tagNo,
        baseTagClass, baseTagNo);
  }
  ...
  public static ASN1TaggedObjectParser tryParseImplicitContextBaseTagged(
      ASN1TaggedObjectParser taggedObjectParser,
      int tagNo, int baseTagClass, int baseTagNo) throws IOException {
    return tryParseImplicitBaseTagged(taggedObjectParser, BERTags.CONTEXT_SPECIFIC, tagNo,
        baseTagClass, baseTagNo);
  }
  ...
  public static ASN1Encodable parseBaseUniversal(ASN1TaggedObjectParser taggedObjectParser,
    ...
    return checkTag(taggedObjectParser, tagClass, tagNo).parseBaseUniversal(declaredExplicit,
        baseTagNo);
  }
  ...
  public static ASN1Encodable parseExplicitContextBaseObject(
      ASN1TaggedObjectParser taggedObjectParser, int tagNo)
      throws IOException {
  ...
  public static ASN1Encodable tryParseExplicitContextBaseObject(
      ASN1TaggedObjectParser taggedObjectParser, int tagNo)
      throws IOException {
