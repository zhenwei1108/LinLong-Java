...
public class PBKDF2Config
   ...
   */
  public static final AlgorithmIdentifier PRF_SHA256 = new AlgorithmIdentifier(
      PKCSObjectIdentifiers.id_hmacWithSHA256, DERNull.INSTANCE);

  /**
   * AlgorithmIdentifier for a PRF using HMac with SHA-512
   */
  public static final AlgorithmIdentifier PRF_SHA512 = new AlgorithmIdentifier(
   ...
   */
  public static final AlgorithmIdentifier PRF_SHA3_512 = new AlgorithmIdentifier(
