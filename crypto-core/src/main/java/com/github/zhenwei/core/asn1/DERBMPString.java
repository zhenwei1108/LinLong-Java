...
/**
 * DER BMPString object encodes BMP (<i>Basic Multilingual Plane</i>) subset (aka UCS-2) of UNICODE
 * (ISO 10646) characters in codepoints 0 to 65535.
 * <p>
...
public class DERBMPString
   ...
   * @deprecated Use {@link ASN1BMPString#getInstance(ASN1TaggedObject, boolean)} instead.
   */
  public static DERBMPString getInstance(
