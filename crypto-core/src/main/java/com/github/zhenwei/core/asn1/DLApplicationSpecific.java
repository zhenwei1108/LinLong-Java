...
public class DLApplicationSpecific
  ...
  public DLApplicationSpecific(int tagNo, byte[] contentsOctets) {
    super(
        new DLTaggedObject(false, BERTags.APPLICATION, tagNo, new DEROctetString(contentsOctets)));
  }
   ...
   * @param baseEncodable the object to be contained.
   */
  public DLApplicationSpecific(boolean explicit, int tagNo, ASN1Encodable baseEncodable)
      throws IOException {
  ...
  public DLApplicationSpecific(int tagNo, ASN1EncodableVector contentsElements) {
    super(new DLTaggedObject(false, BERTags.APPLICATION, tagNo,
