...
public class FixedPointPreCompInfo implements PreCompInfo {
  ...
  /**
   * The width used for the precomputation. If a larger width precomputation is already available
   * this may be larger than was requested, so calling code should refer to the actual width.
   */
