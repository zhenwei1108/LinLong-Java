...
public class PBKDF2Params
  ...
  /**
   * Create a PBKDF2Params with the specified salt, iteration count, and algid-hmacWithSHA1 for the
   * prf.
   *
  ...
  /**
   * Create a PBKDF2Params with the specified salt, iteration count, keyLength, and
