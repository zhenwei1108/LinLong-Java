...
/**
 * The specification for RC5 came from the <code>RC5 Encryption Algorithm</code> publication in RSA
 * CryptoBytes, Spring of 1995.
...
public class RC564Engine
  ...
  /**
   * Encrypt the given block starting at the given offset and place the result in the provided
  ...
  /**
   * Perform a left "spin" of the word. The rotation of the given word <em>x</em> is rotated left by
   * <em>y</em> bits. Only the <em>lg(wordSize)</em> low-order bits of <em>y</em> are used to
   * determine the rotation amount. Here it is assumed that the wordsize used is a power of 2.
   * <p>
   *
  ...
  /**
   * Perform a right "spin" of the word. The rotation of the given word <em>x</em> is rotated left
   * by <em>y</em> bits. Only the <em>lg(wordSize)</em> low-order bits of <em>y</em> are used to
   * determine the rotation amount. Here it is assumed that the wordsize used is a power of 2.
   * <p>
   *
   * @param x word to rotate
