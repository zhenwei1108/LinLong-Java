...
public final class BigEndianConversions {
  ...
  /**
   * Convert an integer to an octet string according to IEEE 1363, Section 5.5.3. Length checking is
   * performed.
   *
   * @param x    the integer to convert
   * @param oLen the desired length of the octet string
   * @return an octet string of length <tt>oLen</tt> representing the integer <tt>x</tt>, or
   * <tt>null</tt> if the integer is
   * negative
   * @throws ArithmeticException if <tt>x</tt> can't be encoded into <tt>oLen</tt> octets.
   */
  ...
  /**
   * Convert an integer to an octet string of the specified length according to IEEE 1363, Section
   * 5.5.3. No length checking is performed (i.e., if the integer cannot be encoded into
  ...
  /**
   * Convert a byte array of length 4 beginning at <tt>offset</tt> into an integer.
   *
  ...
  /**
   * Convert a byte array of length 8 beginning at <tt>inOff</tt> into a long integer.
   *
   * @param input the byte array
   * @param inOff the offset into the byte array
  ...
  /**
   * Convert an int array into a byte array of the specified length. No length checking is performed
   * (i.e., if the last integer cannot be encoded into
