...
public class CipherFactory {
   ...
   */
  public static Object createContentCipher(boolean forEncryption, CipherParameters encKey,
    ...
    if (encAlg.equals(PKCSObjectIdentifiers.rc4)) {
      ...
      AEADParameters aeadParameters = new AEADParameters((KeyParameter) encKey,
      ...
      AEADParameters aeadParameters = new AEADParameters((KeyParameter) encKey,
          ccmParameters.getIcvLen() * 8, ccmParameters.getNonce());
      cipher.init(forEncryption, aeadParameters);
      return cipher;
    } else {
        ...
        if (encAlg.equals(PKCSObjectIdentifiers.des_EDE3_CBC)
          ...
          cipher.init(forEncryption, new ParametersWithIV(
              new RC2Parameters(((KeyParameter) encKey).getKey(),
                  rc2Ekb[cbcParams.getRC2ParameterVersion().intValue()]), cbcParams.getIV()));
        } else {
