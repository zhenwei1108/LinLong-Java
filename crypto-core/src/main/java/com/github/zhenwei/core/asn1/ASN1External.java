...
public abstract class ASN1External
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1External.class,
      BERTags.EXTERNAL) {
    ...
    if (obj == null || obj instanceof ASN1External) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "failed to construct external from byte[]: " + e.getMessage());
      }
    }
  ...
  ASN1External(ASN1ObjectIdentifier directReference, ASN1Integer indirectReference,
      ASN1Primitive dataValueDescriptor,
  ...
  ASN1Primitive toDERObject() {
    return new DERExternal(directReference, indirectReference, dataValueDescriptor, encoding,
        externalContent);
  }

  ASN1Primitive toDLObject() {
    return new DLExternal(directReference, indirectReference, dataValueDescriptor, encoding,
        externalContent);
  }
