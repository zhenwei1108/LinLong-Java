 ...
 * or in <i>polynomial</i> representation. It is extended by the classes <a href =
 * GF2nONBElement.html><tt> GF2nONBElement</tt></a> and <a href = GF2nPolynomialElement.html>
...
public abstract class GF2nElement
  ...
  /**
   * Compute the difference of this element and <tt>minuend</tt>, overwriting this element.
   *
   * @param minuend the minuend
   */
  ...
  /**
   * Compute the square root of this element and return the result in a new {@link GF2nElement}.
   *
