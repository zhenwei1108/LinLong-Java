...
public class DSTU4145NamedCurves {
  ...
  static {
    ...
    n_s[7] = new BigInteger(
        "3FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC079C2F3825DA70D390FBBA588D4604022B7B7", 16);
    ...
    curves[0] = new ECCurve.F2m(163, 3, 6, 7, ONE,
        new BigInteger("5FF6108462A2DC8210AB403925E638A19C1455D21", 16), n_s[0], h_s[0]);
    curves[1] = new ECCurve.F2m(167, 6, ONE,
        new BigInteger("6EE3CEEB230811759F20518A0930F1A4315A827DAC", 16), n_s[1], h_s[1]);
    ...
    curves[4] = new ECCurve.F2m(191, 9, ONE,
        new BigInteger("7BC86E2102902EC4D5890E8B6B4981ff27E0482750FEFC03", 16), n_s[4], h_s[4]);
    curves[5] = new ECCurve.F2m(233, 1, 4, 9, ONE,
        new BigInteger("06973B15095675534C7CF7E64A21BD54EF5DD3B8A0326AA936ECE454D2C", 16), n_s[5],
        h_s[5]);
    curves[6] = new ECCurve.F2m(257, 12, ZERO,
        new BigInteger("1CEF494720115657E18F938D7A7942394FF9425C1458C57861F9EEA6ADBE3BE10", 16),
        n_s[6], h_s[6]);
    curves[7] = new ECCurve.F2m(307, 2, 4, 8, ONE, new BigInteger(
        "393C7F7D53666B5054B5E6C6D3DE94F4296C0C599E2E2E241050DF18B6090BDC90186904968BB", 16),
        n_s[7], h_s[7]);
    curves[8] = new ECCurve.F2m(367, 21, ONE, new BigInteger(
    ...
    points[7] = curves[7].createPoint(new BigInteger(
            "216EE8B189D291A0224984C1E92F1D16BF75CCD825A087A239B276D3167743C52C02D6E7232AA", 16),
        new BigInteger(
            "5D9306BACD22B7FAEB09D2E049C6E2866C5D1677762A8F2F2DC9A11C7F7BE8340AB2237C7F2A0", 16));
  ...
  /**
   * All named curves have the following oid format: 1.2.804.2.1.1.1.1.3.1.1.2.X where X is the
   * curve number 0-9
   */
