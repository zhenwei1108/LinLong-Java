...
public class DLExternal
  ...
  /**
   * Construct a Definite-Length EXTERNAL object, the input encoding vector must have exactly two
   * elements on it.
   * <p>
  ...
  /**
   * Construct a Definite-Length EXTERNAL object, the input sequence must have exactly two elements
   * on it.
   * <p>
   * Acceptable input formats are:
   * <ul>
  ...
  /**
   * Creates a new instance of DERExternal See X.690 for more informations about the meaning of
   * these parameters
   *
  ...
  /**
   * Creates a new instance of Definite-Length External. See X.690 for more informations about the
