...
/**
 * This interface provides a profile to conform to when DNs are being converted into strings and
 * back. The idea being that we'll be able to deal with the number of standard ways the fields in a
 * DN should be encoded into their ASN.1 counterparts - a number that is rapidly approaching the
