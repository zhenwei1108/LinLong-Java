 ...
 * <p>
 * Note: This does not know which syntax the set is! (The difference: ordering of SET elements or
 * not ordering.)
 * </p><p>
 ...
 * encoding of a data value from each of the types listed in the ASN.1 definition of the set type,
 * in an order chosen by the sender, unless the type was referenced with the keyword
 ...
 * <b>OPTIONAL</b> or the keyword <b>DEFAULT</b>.
 * <blockquote>
 * NOTE &mdash; The order of data values in a set value is not significant, and places no
 * constraints on the order during transfer
 * </blockquote>
 ...
 * one or more complete encodings of data values from the type listed in the ASN.1 definition.</i>
 * </p><p>
 ...
 * tags as specified in 8.6 of ITU-T Rec. X.680 | ISO/IEC 8824-1. Additionally, for the purposes of
 * determining the order in which components are encoded when one or more component is an untagged
 * choice type, each untagged choice type is ordered as though it has a tag equal to that of the
 * smallest tag in that choice type or any untagged choice types nested within.
 *
 ...
 * <blockquote>
 * NOTE &mdash; Where a component of the set is an untagged choice type, the location of that
 * component in the ordering will depend on the tag of the choice component being encoded.
 * </blockquote>
 *
 ...
 * <blockquote>
 * NOTE &mdash; The padding octets are for comparison purposes only and do not appear in the
 * encodings.
 * </blockquote>
 */
...
//        return Arrays.hashCode(elements);
  ...
  /**
   * Change current SET object to be encoded as {@link DERSet}. This is part of Distinguished
   * Encoding Rules form serialization.
   */
  ...
  /**
   * Change current SET object to be encoded as {@link DLSet}. This is part of Direct Length form
   * serialization.
   */
