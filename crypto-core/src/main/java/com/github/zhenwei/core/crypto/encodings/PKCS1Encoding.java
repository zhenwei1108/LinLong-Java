...
/**
 * this does your basic PKCS 1 v1.5 padding - whether or not you should be using this depends on
 * your application - see PKCS1 Version 2 for details.
 */
public class PKCS1Encoding
   ...
   */
  public static final String STRICT_LENGTH_ENABLED_PROPERTY = "com.github.zhenwei.pkix.pkcs1.strict";

  /**
   * some providers fail to include the leading zero in PKCS1 encoded blocks. If you need to work
   * with one of these set the system property com.github.zhenwei.pkix.pkcs1.not_strict to true.
   * <p>
   * The system property is checked during construction of the encoding object, it is set to false
   * by default.
   * </p>
   */
  public static final String NOT_STRICT_LENGTH_ENABLED_PROPERTY = "com.github.zhenwei.pkix.pkcs1.not_strict";
  ...
  /**
   * Constructor for decryption with a fixed plaintext length and a fallback value that is returned,
  ...
  private byte[] decodeBlockOrRandom(byte[] in, int inOff, int inLen)
    ...
    byte[] data =
        (useStrictLength & (block.length != engine.getOutputBlockSize())) ? blockBuffer : block;
