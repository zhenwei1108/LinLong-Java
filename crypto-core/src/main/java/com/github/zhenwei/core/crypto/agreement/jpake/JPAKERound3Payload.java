...
/**
 * The payload sent/received during the optional third round of a J-PAKE exchange, which is for
 * explicit key confirmation.
 * <p>
 * Each {@link JPAKEParticipant} creates and sends an instance of this payload to the other {@link
 * JPAKEParticipant}. The payload to send should be created via {@link
...
public class JPAKERound3Payload {
   ...
   * BigInteger, com.github.zhenwei.core.crypto.Digest)
   */
