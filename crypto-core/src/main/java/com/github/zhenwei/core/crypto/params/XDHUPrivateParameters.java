...
public class XDHUPrivateParameters
  ...
  public XDHUPrivateParameters(
    ...
    if (!(staticPrivateKey instanceof X448PrivateKeyParameters
        || staticPrivateKey instanceof X25519PrivateKeyParameters)) {
    ...
    if (ephemeralPublicKey == null) {
      ...
      if (ephemeralPublicKey instanceof X448PublicKeyParameters
          && !(staticPrivateKey instanceof X448PrivateKeyParameters)) {
        throw new IllegalArgumentException("ephemeral public key has different domain parameters");
      }
      if (ephemeralPublicKey instanceof X25519PublicKeyParameters
          && !(staticPrivateKey instanceof X25519PrivateKeyParameters)) {
        throw new IllegalArgumentException("ephemeral public key has different domain parameters");
      }
    }
