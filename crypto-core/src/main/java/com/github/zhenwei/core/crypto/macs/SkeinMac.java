...
public class SkeinMac
   ...
   * @param digestSizeBits the output/MAC size to produce in bits, which must be an integral number
   *                       of bytes.
   */
  ...
  public void init(CipherParameters params)
    ...
    if (params instanceof SkeinParameters) {
      ...
      skeinParameters = new SkeinParameters.Builder().setKey(((KeyParameter) params).getKey())
          .build();
    } else {
