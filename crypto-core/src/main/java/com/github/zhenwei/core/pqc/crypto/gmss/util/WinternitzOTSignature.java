...
/**
 * This class implements key pair generation and signature generation of the Winternitz one-time
 * signature scheme (OTSS), described in C.Dods, N.P. Smart, and M. Stam, "Hash Based Digital
 * Signature Schemes", LNCS 3796, pages 96&#8211;115, 2005. The class is used by the GMSS classes.
 */
...
public class WinternitzOTSignature {
  ...
  /**
   * The constructor generates an OTS key pair, using <code>seed0</code> and the PRNG
   *
   * @param seed0  the seed for the PRGN
   * @param digest an array of strings, containing the name of the used hash function, the name of
   *               the PRGN and the names of the corresponding providers
