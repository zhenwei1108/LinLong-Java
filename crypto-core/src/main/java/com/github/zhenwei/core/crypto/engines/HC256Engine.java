...
/**
 * HC-256 is a software-efficient stream cipher created by Hongjun Wu. It generates keystream from a
 * 256-bit secret key and a 256-bit initialization vector.
 * <p>
 * https://www.ecrypt.eu.org/stream/p3ciphers/hc/hc256_p3.pdf
 * </p><p>
 * Its brother, HC-128, is a third phase candidate in the eStream contest. The algorithm is
 * patent-free. No attacks are known as of today (April 2007). See
 * <p>
