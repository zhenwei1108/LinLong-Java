...
class SP80038G {
  ...
  static byte[] decryptFF1(BlockCipher cipher, int radix, byte[] tweak, byte[] buf, int off,
      int len) {
  ...
  static short[] decryptFF1w(BlockCipher cipher, int radix, byte[] tweak, short[] buf, int off,
      int len) {
    checkArgs(cipher, true, radix, buf, off, len);
  ...
  static short[] decFF1(BlockCipher cipher, int radix, byte[] T, int n, int u, int v, short[] A,
      short[] B) {
    int t = T.length;
  ...
  static byte[] decryptFF3(BlockCipher cipher, int radix, byte[] tweak64, byte[] buf, int off,
      int len) {
  ...
  static byte[] decryptFF3_1(BlockCipher cipher, int radix, byte[] tweak56, byte[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
  ...
  static short[] decryptFF3_1w(BlockCipher cipher, int radix, byte[] tweak56, short[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
...
//    checkArgs(cipher, true, radix, buf, off, len);
  ...
  private static short[] encFF1(BlockCipher cipher, int radix, byte[] T, int n, int u, int v,
      short[] A, short[] B) {
    int t = T.length;
  ...
  static byte[] encryptFF3(BlockCipher cipher, int radix, byte[] tweak64, byte[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
  ...
  static short[] encryptFF3w(BlockCipher cipher, int radix, byte[] tweak64, short[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
  ...
  static short[] encryptFF3_1w(BlockCipher cipher, int radix, byte[] tweak56, short[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
  ...
  static byte[] encryptFF3_1(BlockCipher cipher, int radix, byte[] tweak56, byte[] buf, int off,
      int len) {
    checkArgs(cipher, false, radix, buf, off, len);
  ...
  protected static BigInteger calculateY_FF1(BlockCipher cipher, BigInteger bigRadix, byte[] T,
      int b, int d, int round, byte[] P, short[] AB) {
    int t = T.length;
  ...
  protected static BigInteger calculateY_FF3(BlockCipher cipher, BigInteger bigRadix, byte[] T,
      int wOff, int round, short[] AB) {
    // ii.
    byte[] P = new byte[BLOCK_SIZE];
  ...
  protected static void checkArgs(BlockCipher cipher, boolean isFF1, int radix, short[] buf,
      int off, int len) {
    checkCipher(cipher);
  ...
  protected static void checkArgs(BlockCipher cipher, boolean isFF1, int radix, byte[] buf, int off,
      int len) {
    checkCipher(cipher);
  ...
  protected static byte[] implDecryptFF3(BlockCipher cipher, int radix, byte[] tweak64, byte[] buf,
      int off, int len) {
    // Algorithm 10
    byte[] T = tweak64;
    int n = len;
  ...
  protected static short[] implDecryptFF3w(BlockCipher cipher, int radix, byte[] tweak64,
      short[] buf, int off, int len) {
    // Algorithm 10
    byte[] T = tweak64;
    int n = len;
    int v = n / 2, u = n - v;
  ...
  private static short[] decFF3_1(BlockCipher cipher, int radix, byte[] T, int n, int v, int u,
      short[] A, short[] B) {
    BigInteger bigRadix = BigInteger.valueOf(radix);
  ...
  protected static byte[] implEncryptFF3(BlockCipher cipher, int radix, byte[] tweak64, byte[] buf,
      int off, int len) {
    // Algorithm 9
    byte[] T = tweak64;
    int n = len;
  ...
  protected static short[] implEncryptFF3w(BlockCipher cipher, int radix, byte[] tweak64,
      short[] buf, int off, int len) {
    // Algorithm 9
    byte[] T = tweak64;
    int n = len;
  ...
  private static short[] encFF3_1(BlockCipher cipher, int radix, byte[] t, int n, int v, int u,
      short[] a, short[] b) {
    BigInteger bigRadix = BigInteger.valueOf(radix);
    BigInteger[] modVU = calculateModUV(bigRadix, v, u);
