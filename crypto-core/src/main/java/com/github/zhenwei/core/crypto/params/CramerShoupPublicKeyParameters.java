...
public class CramerShoupPublicKeyParameters
  ...
  public CramerShoupPublicKeyParameters(CramerShoupParameters params, BigInteger c, BigInteger d,
      BigInteger h) {
    super(false, params);
  ...
  public boolean equals(Object obj) {
    ...
    return other.getC().equals(c) && other.getD().equals(d) && other.getH().equals(h)
        && super.equals(obj);
  }
}