 ...
 * Password Scheme" of Niels Provos and David Mazières, see: https://www.usenix.org/legacy/events/usenix99/provos/provos_html/node1.html.
 * In contrast to the paper, the order of key setup and salt setup is reversed: state &lt;-
 * ExpandKey(state, 0, key) state &lt;- ExpandKey(state, 0, salt) This corresponds to the OpenBSD
 * reference implementation of Bcrypt.
 * </p><p>
...
public final class BCrypt {
  ...
  /**
   * Calculates the <b>bcrypt</b> hash of an input - note for processing general passwords you want
   * to make sure the password is terminated in a manner similar to what is done by
   * passwordToByteArray().
   * <p>
   * This implements the raw <b>bcrypt</b> function as defined in the bcrypt specification, not the
   * crypt encoded version implemented in OpenBSD.
   * </p>
   *
