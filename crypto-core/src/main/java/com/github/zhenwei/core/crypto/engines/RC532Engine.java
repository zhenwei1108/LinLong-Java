...
public class RC532Engine
   ...
   * <em>y</em> bits. Only the <em>lg(32)</em> low-order bits of <em>y</em> are used to determine
   * the rotation amount. Here it is assumed that the wordsize used is a power of 2.
   * <p>
   *
   ...
   * by <em>y</em> bits. Only the <em>lg(32)</em> low-order bits of <em>y</em> are used to determine
   * the rotation amount. Here it is assumed that the wordsize used is a power of 2.
   * <p>
   *
   * @param x word to rotate
