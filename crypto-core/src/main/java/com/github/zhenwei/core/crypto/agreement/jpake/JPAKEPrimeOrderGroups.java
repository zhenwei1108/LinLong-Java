...
/**
 * Standard pre-computed prime order groups for use by J-PAKE. (J-PAKE can use pre-computed prime
 * order groups, same as DSA and Diffie-Hellman.)
 * <p>
 * This class contains some convenient constants for use as input for constructing {@link
 * JPAKEParticipant}s.
 * <p>
 ...
 * <a href="https://csrc.nist.gov/groups/ST/toolkit/documents/Examples/DSA2_All.pdf">published by
 * NIST</a>.
 */
public class JPAKEPrimeOrderGroups {

  /**
   * From Sun's JDK JavaDoc (docs/guide/security/CryptoSpec.html#AppB) 1024-bit p, 160-bit q and
   * 1024-bit g for 80-bit security.
   */
