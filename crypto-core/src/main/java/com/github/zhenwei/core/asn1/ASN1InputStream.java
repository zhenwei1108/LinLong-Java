...
/**
 * A general purpose ASN.1 decoder - note: this class differs from the others in that it returns
 * null after it has read the last object in the stream. If an ASN.1 NULL is encountered a DER/BER
...
public class ASN1InputStream
  ...
  /**
   * Create an ASN1InputStream based on the input byte array. The length of DER objects in the
   * stream is automatically limited to the length of the input array.
   *
  ...
  ASN1OctetString buildConstructedOctetString(ASN1EncodableVector contentsElements)
      throws IOException {
  ...
  ASN1Primitive readTaggedObjectDL(int tagClass, int tagNo, boolean constructed,
