...
/**
 * DER T61String (also the teletex string), try not to use this if you don't need to. The standard
...
public class DERT61String
   ...
   * @deprecated Use {@link ASN1T61String#getInstance(ASN1TaggedObject, boolean)} instead.
   */
  public static DERT61String getInstance(
