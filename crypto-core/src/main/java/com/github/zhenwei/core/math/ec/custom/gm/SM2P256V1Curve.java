...
public class SM2P256V1Curve extends ECCurve.AbstractFp {
  ...
  private static final ECFieldElement[] SM2P256V1_AFFINE_ZS = new ECFieldElement[]{
      new SM2P256V1FieldElement(ECConstants.ONE)};
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    return new AbstractECLookupTable() {
      ...
      private ECPoint createPoint(int[] x, int[] y) {
        return createRawPoint(new SM2P256V1FieldElement(x), new SM2P256V1FieldElement(y),
            SM2P256V1_AFFINE_ZS);
      }
    };
  }
