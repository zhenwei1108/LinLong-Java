 ...
 * PKCS5/PKCS7 padding. The PaddedBlockCipher outputs a block only when the buffer is full and more
 ...
 *
 * @deprecated use com.github.zhenwei.core.crypto.paddings.PaddedBufferedBlockCipher instead.
 */
