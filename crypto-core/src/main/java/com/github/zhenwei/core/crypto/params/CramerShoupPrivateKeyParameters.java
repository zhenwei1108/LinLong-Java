...
public class CramerShoupPrivateKeyParameters
  ...
  public CramerShoupPrivateKeyParameters(CramerShoupParameters params, BigInteger x1, BigInteger x2,
  ...
  public int hashCode() {
    return x1.hashCode() ^ x2.hashCode() ^ y1.hashCode() ^ y2.hashCode() ^ z.hashCode()
        ^ super.hashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return other.getX1().equals(this.x1) && other.getX2().equals(this.x2) && other.getY1()
        .equals(this.y1) && other.getY2().equals(this.y2) && other.getZ().equals(this.z)
        && super.equals(obj);
  }
}