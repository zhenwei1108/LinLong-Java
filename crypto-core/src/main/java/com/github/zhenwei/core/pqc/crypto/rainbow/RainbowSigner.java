...
/**
 * It implements the sign and verify functions for the Rainbow Signature Scheme. Here the message,
 * which has to be signed, is updated. The use of different hash functions is possible.
 * <p>
 * Detailed information about the signature and the verify-method is to be found in the paper of
 * Jintai Ding, Dieter Schmidt: Rainbow, a New Multivariable Polynomial Signature Scheme. ACNS 2005:
 * 164-175 (https://dx.doi.org/10.1007/11496137_12)
 */
public class RainbowSigner
   ...
   * @return Y_ the modified document needed for solving LES, (Y_ = A1^{-1}*(Y-b1)) linear map L1 =
   * A1 x + b1.
   */
   ...
   * layer in order to find the Oil-variables in the layer.
   * <p>
