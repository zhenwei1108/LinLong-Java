...
public class KeyPurposeId
   ...
   * { 2 5 29 37 0 }
   */
  public static final KeyPurposeId anyExtendedKeyUsage = new KeyPurposeId(
   ...
   * { id-kp 11 }
   */
  public static final KeyPurposeId id_kp_sbgpCertAAServerAuth = new KeyPurposeId(
      id_kp.branch("11"));
  /**
   * { id-kp 12 }
   */
   ...
   *
   */
  public static final KeyPurposeId id_kp_macAddress = new KeyPurposeId(
      new ASN1ObjectIdentifier("1.3.6.1.1.1.1.22"));


  /**
   * Microsoft Server Gated Crypto (msSGC) see https://www.alvestrand.no/objectid/1.3.6.1.4.1.311.10.3.3.html
   */
  public static final KeyPurposeId id_kp_msSGC = new KeyPurposeId(
      new ASN1ObjectIdentifier("1.3.6.1.4.1.311.10.3.3"));

  /**
   * Netscape Server Gated Crypto (nsSGC) see https://www.alvestrand.no/objectid/2.16.840.1.113730.4.1.html
   */
  public static final KeyPurposeId id_kp_nsSGC = new KeyPurposeId(
      new ASN1ObjectIdentifier("2.16.840.1.113730.4.1"));
