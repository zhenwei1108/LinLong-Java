...
public class LMSPrivateKeyParameters
  ...
  public LMSPrivateKeyParameters(LMSigParameters lmsParameter, LMOtsParameters otsParameters, int q,
  ...
  private byte[] calcT(int r) {
    ...
    if (r >= twoToh) {
      ...
      //
      byte[] K = LM_OTS.lms_ots_generatePublicKey(this.getOtsParameters(), this.getI(),
          (r - twoToh), this.getMasterSecret());
  ...
  public boolean equals(Object o) {
    ...
    if (otsParameters != null ? !otsParameters.equals(that.otsParameters)
        : that.otsParameters != null) {
      return false;
    }
