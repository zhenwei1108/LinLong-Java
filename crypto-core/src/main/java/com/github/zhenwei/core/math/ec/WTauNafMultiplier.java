...
public class WTauNafMultiplier extends AbstractECMultiplier {
   ...
   * <code>k</code> using the reduced <code>&tau;</code>-adic NAF (RTNAF) method.
   *
   ...
   */
  private ECPoint.AbstractF2m multiplyWTnaf(ECPoint.AbstractF2m p, ZTauElement lambda, byte a,
      byte mu) {
  ...
  /**
   * Multiplies a {@link com.github.zhenwei.core.math.ec.ECPoint.AbstractF2m ECPoint.AbstractF2m} by
   * an element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using the window
   * <code>&tau;</code>-adic NAF (TNAF) method, given the WTNAF of <code>&lambda;</code>.
   *
   * @param p The ECPoint.AbstractF2m to multiply.
  ...
  private static ECPoint.AbstractF2m multiplyFromWTnaf(final ECPoint.AbstractF2m p, byte[] u) {
    ...
    WTauNafPreCompInfo preCompInfo = (WTauNafPreCompInfo) curve.precompute(p, PRECOMP_NAME,
        new PreCompCallback() {
