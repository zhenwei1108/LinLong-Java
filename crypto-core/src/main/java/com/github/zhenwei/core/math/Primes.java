...
public abstract class Primes {
  ...
  /**
   * Used to return the output from the {@linkplain Primes#enhancedMRProbablePrimeTest(BigInteger,
  ...
  /**
   * Used to return the output from the {@linkplain Primes#generateSTRandomPrime(Digest, int,
   * byte[]) Shawe-Taylor Random_Prime Routine}
   */
