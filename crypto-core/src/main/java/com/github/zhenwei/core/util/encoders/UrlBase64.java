...
/**
 * Convert binary data to and from UrlBase64 encoding.  This is identical to Base64 encoding, except
 * that the padding character is "." and the other non-alphanumeric characters are "-" and "_"
 * instead of "+" and "/".
 * <p>
 ...
 * use in URLs, since "/" can be interpreted as a path delimiter; "+" is the encoded form of a
 * space; and "=" is used to separate a name from the corresponding value in an URL parameter.
 */
public class UrlBase64 {
  ...
  /**
   * decode the URL safe base 64 encoded byte data writing it to the given output stream, whitespace
