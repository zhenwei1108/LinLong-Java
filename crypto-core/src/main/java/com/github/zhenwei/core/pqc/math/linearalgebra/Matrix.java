...
/**
 * This abstract class defines matrices. It holds the number of rows and the number of columns of
 * the matrix and defines some basic methods.
 */
public abstract class Matrix {
   ...
   * the number of rows of this matrix, the matrix is multiplied by each m-bit part of the vector.
   *
