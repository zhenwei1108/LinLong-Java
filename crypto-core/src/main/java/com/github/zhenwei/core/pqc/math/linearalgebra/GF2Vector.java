...
/**
 * This class implements the abstract class <tt>Vector</tt> for the case of vectors over the finite
 * field GF(2). <br> For the vector representation the array of type int[] is used, thus one element
 * of the array holds 32 elements of the vector.
 *
 * @see Vector
 */
public class GF2Vector
  ...
  /**
   * Construct a random GF2Vector of the given length with the specified number of non-zero
   * coefficients.
   *
   * @param length the length of the vector
  ...
  /**
   * Construct a GF2Vector of the given length and with elements from the given array. The array is
   * copied and unused bits are masked out.
   *
   * @param length the length of the vector
  ...
  /**
   * Construct a new {@link GF2Vector} of the given length and with the given element array. The
   * array is not changed and only a reference to the array is stored. No length checking is
   * performed either.
   *
   * @param v      the element array
   * @param length the length of the vector
  ...
  /**
   * Return a new vector consisting of the elements of this vector with the indices given by the set
   * <tt>setJ</tt>.
   *
   ...
   * @return a new {@link GF2Vector} consisting of the first <tt>k</tt> elements of this vector
   */
   ...
   *
   * @param k the number of elements to extract
   * @return a new {@link GF2Vector} consisting of the last <tt>k</tt> elements of this vector
   */
