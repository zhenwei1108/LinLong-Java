 ...
 * we have no way of representing this directly so we rely on byte arrays to carry these.
 */
public class DERUniversalString
   ...
   * @deprecated Use {@link ASN1UniversalString#getInstance(ASN1TaggedObject, boolean)} instead.
   */
  public static DERUniversalString getInstance(
