...
/**
 * Parameters for NaccacheStern public private key generation. For details on this cipher, please
 * see
 * <p>
...
public class NaccacheSternKeyGenerationParameters extends KeyGenerationParameters {
   ...
   * @param certainty      the probability that the generated primes are not really prime as
   *                       integer: 2^(-certainty) is then the probability
   * @param cntSmallPrimes How many small key factors are desired
   */
  public NaccacheSternKeyGenerationParameters(SecureRandom random, int strength, int certainty,
      int cntSmallPrimes) {
