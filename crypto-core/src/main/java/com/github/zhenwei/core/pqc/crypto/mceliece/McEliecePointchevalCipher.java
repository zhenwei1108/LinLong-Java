 ...
 * generic technique to make a CCA2-secure cryptosystem from any partially trapdoor one-way function
 * in the random oracle model. For details, see D. Engelbert, R. Overbeck, A. Schmidt, "A Summary of
 * McEliece-Type Cryptosystems and their Security", technical report.
...
public class McEliecePointchevalCipher
  ...
  public byte[] messageEncrypt(byte[] input) {
    ...
    byte[] c1 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) key,
        rPrime,
        z).getEncoded();
  ...
  public byte[] messageDecrypt(byte[] input)
    ...
    GF2Vector[] c1Dec = McElieceCCA2Primitives.decryptionPrimitive(
        (McElieceCCA2PrivateKeyParameters) key,
        c1Vec);
