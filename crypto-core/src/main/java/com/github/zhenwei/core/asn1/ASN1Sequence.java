 ...
 * encoding of one data value from each of the types listed in the ASN.1 definition of the sequence
 * type, in the order of their appearance in the definition, unless the type was referenced with the
 * keyword <b>OPTIONAL</b> or the keyword <b>DEFAULT</b>.
 * </p><p>
 * <b>8.9.3</b> The encoding of a data value may, but need not,
 * be present for a type which was referenced with the keyword
 * <b>OPTIONAL</b> or the keyword <b>DEFAULT</b>.
 * If present, it shall appear in the encoding at the point corresponding to the appearance of the
 * type in the ASN.1 definition.
 * </p><p>
 ...
 * one or more complete encodings of data values from the type listed in the ASN.1 definition.
 * <p>
 * <b>8.10.3</b> The order of the encodings of the data values shall be
 * the same as the order of the data values in the sequence-of value to be encoded.
 * </p>
...
public abstract class ASN1Sequence
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1Sequence.class,
      BERTags.SEQUENCE) {
...
//      else if (obj instanceof ASN1SequenceParser)
   ...
   * appears to have been explicitly tagged on reading but we were expecting it to be implicitly
...
//        return Arrays.hashCode(elements);
  ...
  /**
   * Change current SEQUENCE object to be encoded as {@link DERSequence}. This is part of
  ...
  /**
   * Change current SEQUENCE object to be encoded as {@link DLSequence}. This is part of Direct
   * Length form serialization.
   */
