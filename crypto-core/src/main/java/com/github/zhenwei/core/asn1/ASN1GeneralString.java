 ...
 * <p>
 * This is an 8-bit encoded ISO 646 (ASCII) character set with optional escapes to other character
 * sets.
 * </p>
 */
public abstract class ASN1GeneralString
  ...
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1GeneralString.class,
      BERTags.GENERAL_STRING) {
