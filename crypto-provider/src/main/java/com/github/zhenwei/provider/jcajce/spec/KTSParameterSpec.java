...
public class KTSParameterSpec
  ...
  public static final class Builder {
    ...
    public KTSParameterSpec build() {
      return new KTSParameterSpec(algorithmName, keySizeInBits, parameterSpec, kdfAlgorithm,
          otherInfo);
    }
  }
  ...
  /**
   * Return the algorithm parameter spec to be applied with the private key when the encapsulation
   * is decrypted.
   *
