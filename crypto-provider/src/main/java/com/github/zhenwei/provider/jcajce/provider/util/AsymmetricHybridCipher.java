...
/**
 * The AsymmetricHybridCipher class extends CipherSpiExt. NOTE: Some Ciphers are using Padding.
...
public abstract class AsymmetricHybridCipher
   ...
   * </p>
   *
   * @return the parameters used with this cipher, or <tt>null</tt> if this cipher does not use any
   * parameters.
   */
  ...
  /**
   * Initialize the cipher for encryption by forwarding it to {@link #initEncrypt(Key,
   ...
   *                                   cipher.
   * @throws InvalidParameterException if this cipher needs algorithm parameters for initialization
   *                                   and cannot generate parameters itself.
   */
  ...
  /**
   * Initialize this cipher for encryption by forwarding it to {@link #initEncrypt(Key,
   * AlgorithmParameterSpec, SecureRandom)}.
   * <p>
   * If this cipher requires any algorithm parameters that cannot be derived from the given key, the
   * underlying cipher implementation is supposed to generate the required parameters itself (using
  ...
  /**
   * Initialize the cipher for encryption by forwarding it to initEncrypt(Key, FlexiSecureRandom,
   ...
   *                                            for this cipher, or if this cipher is initialized
   *                                            with
   *                                            <tt>null</tt> parameters and cannot generate
   *                                            parameters
   *                                            itself.
   */
   ...
   * <p>
   * If this cipher requires any random bytes (e.g., for parameter generation), it will get them
   * from <tt>random</tt>.
   * </p><p>
  ...
  /**
   * Compute the output size of an update() or doFinal() operation of a hybrid asymmetric cipher in
   * encryption mode when given input of the specified length.
   *
   * @param inLen the length of the input
  ...
  /**
   * Compute the output size of an update() or doFinal() operation of a hybrid asymmetric cipher in
   * decryption mode when given input of the specified length.
   *
   * @param inLen the length of the input
   * @return the output size
   */
