...
public class X509LDAPCertStoreParameters
  ...
  public static class Builder {
    ...
    /**
     * @param userCertificateAttribute Attribute name(s) in the LDAP directory where end
     *                                 certificates are stored. Separated by space. Defaults to
     *                                 "userCertificate" if <code>null</code>.
     * @return the builder
    ...
    /**
     * @param certificateRevocationListAttribute Attribute name(s) in the LDAP directory where CRLs
     *                                           are stored. Separated by space. Defaults to
     *                                           "certificateRevocationList" if
     *                                           <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setCertificateRevocationListAttribute(
        String certificateRevocationListAttribute) {
    ...
    /**
     * @param deltaRevocationListAttribute Attribute name(s) in the LDAP directory where delta RLs
     *                                     are stored. Separated by space. Defaults to
     *                                     "deltaRevocationList" if <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param authorityRevocationListAttribute Attribute name(s) in the LDAP directory where CRLs
     *                                         for authorities are stored. Separated by space.
     *                                         Defaults to "authorityRevocationList" if
     *                                         <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param attributeCertificateAttributeAttribute Attribute name(s) in the LDAP directory where
     *                                               end attribute certificates are stored.
     *                                               Separated by space. Defaults to "attributeCertificateAttribute"
     *                                               if <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setAttributeCertificateAttributeAttribute(
        String attributeCertificateAttributeAttribute) {
    ...
    /**
     * @param attributeDescriptorCertificateAttribute Attribute name(s) in the LDAP directory where
     *                                                self signed attribute certificates for
     *                                                attribute authorities are stored. Separated by
     *                                                space. Defaults to "attributeDescriptorCertificate"
     *                                                if <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setAttributeDescriptorCertificateAttribute(
        String attributeDescriptorCertificateAttribute) {
    ...
    /**
     * @param attributeCertificateRevocationListAttribute Attribute name(s) in the LDAP directory
     *                                                    where CRLs for attribute certificates are
     *                                                    stored. Separated by space. Defaults to
     *                                                    "attributeCertificateRevocationList" if
     *                                                    <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param attributeAuthorityRevocationListAttribute Attribute name(s) in the LDAP directory
     *                                                  where RLs for attribute authority attribute
     *                                                  certificates are stored. Separated by space.
     *                                                  Defaults to "attributeAuthorityRevocationList"
     *                                                  if <code>null</code>.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setAttributeAuthorityRevocationListAttribute(
        String attributeAuthorityRevocationListAttribute) {
    ...
    /**
     * @param ldapUserCertificateAttributeName The attribute name(s) in the LDAP directory where to
     *                                         search for the attribute value of the specified
     *                                         <code>userCertificateSubjectAttributeName</code>.
     *                                         E.g. if
     *                                         "cn" is used to put information about the subject for
     *                                         end certificates, then specify "cn".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapCACertificateAttributeName The attribute name(s) in the LDAP directory where to
     *                                       search for the attribute value of the specified
     *                                       <code>cACertificateSubjectAttributeName</code>. E.g.
     *                                       if
     *                                       "ou" is used to put information about the subject for
     *                                       CA certificates, then specify "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapCrossCertificateAttributeName The attribute name(s) in the LDAP directory where to
     *                                          search for the attribute value of the specified
     *                                          <code>crossCertificateSubjectAttributeName</code>.
     *                                          E.g. if
     *                                          "o" is used to put information about the subject for
     *                                          cross certificates, then specify "o".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapCertificateRevocationListAttributeName The attribute name(s) in the LDAP directory
     *                                                   where to search for the attribute value of
     *                                                   the specified
     *                                                   <code>certificateRevocationListIssuerAttributeName</code>.
     *                                                   E.g. if "ou" is used to put information
     *                                                   about the issuer of CRLs, specify "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapDeltaRevocationListAttributeName The attribute name(s) in the LDAP directory where
     *                                             to search for the attribute value of the
     *                                             specified
     *                                             <code>deltaRevocationListIssuerAttributeName</code>.
     *                                             E.g.
     *                                             if "ou" is used to put information about the
     *                                             issuer of CRLs, specify "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setLdapDeltaRevocationListAttributeName(
        String ldapDeltaRevocationListAttributeName) {
    ...
    /**
     * @param ldapAuthorityRevocationListAttributeName The attribute name(s) in the LDAP directory
     *                                                 where to search for the attribute value of
     *                                                 the specified
     *                                                 <code>authorityRevocationListIssuerAttributeName</code>.
     *                                                 E.g. if "ou" is used to put information about
     *                                                 the issuer of CRLs, specify "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setLdapAuthorityRevocationListAttributeName(
        String ldapAuthorityRevocationListAttributeName) {
    ...
    /**
     * @param ldapAttributeCertificateAttributeAttributeName The attribute name(s) in the LDAP
     *                                                       directory where to search for the
     *                                                       attribute value of the specified
     *                                                       <code>attributeCertificateAttributeSubjectAttributeName</code>.
     *                                                       E.g. if "cn" is used to put information
     *                                                       about the subject of end attribute
     *                                                       certificates, specify "cn".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapAACertificateAttributeName The attribute name(s) in the LDAP directory where to
     *                                       search for the attribute value of the specified
     *                                       <code>aACertificateSubjectAttributeName</code>. E.g.
     *                                       if
     *                                       "ou" is used to put information about the subject of
     *                                       attribute authority attribute certificates, specify
     *                                       "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapAttributeDescriptorCertificateAttributeName The attribute name(s) in the LDAP
     *                                                        directory where to search for the
     *                                                        attribute value of the specified
     *                                                        <code>attributeDescriptorCertificateSubjectAttributeName</code>.
     *                                                        E.g. if "o" is used to put information
     *                                                        about the subject of self signed
     *                                                        attribute authority attribute
     *                                                        certificates, specify "o".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapAttributeCertificateRevocationListAttributeName The attribute name(s) in the LDAP
     *                                                            directory where to search for the
     *                                                            attribute value of the specified
     *                                                            <code>attributeCertificateRevocationListIssuerAttributeName</code>.
     *                                                            E.g. if "ou" is used to put
     *                                                            information about the issuer of
     *                                                            CRLs, specify "ou".
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param ldapAttributeAuthorityRevocationListAttributeName The attribute name(s) in the LDAP
     *                                                          directory where to search for the
     *                                                          attribute value of the specified
    ...
    /**
     * @param userCertificateSubjectAttributeName Attribute(s) in the subject of the certificate
     *                                            which is used to be searched in the
     *                                            <code>ldapUserCertificateAttributeName</code>.
     *                                            E.g. the
     *                                            "cn" attribute of the DN could be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setUserCertificateSubjectAttributeName(
    ...
    /**
     * @param cACertificateSubjectAttributeName Attribute(s) in the subject of the certificate which
     *                                          is used to be searched in the
     *                                          <code>ldapCACertificateAttributeName</code>. E.g.
     *                                          the "ou"
    ...
    /**
     * @param crossCertificateSubjectAttributeName Attribute(s) in the subject of the cross
     *                                             certificate which is used to be searched in the
     *                                             <code>ldapCrossCertificateAttributeName</code>.
     *                                             E.g. the
     *                                             "o" attribute of the DN may be appropriate.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setCrossCertificateSubjectAttributeName(
    ...
    /**
     * @param certificateRevocationListIssuerAttributeName Attribute(s) in the issuer of the CRL
     *                                                     which is used to be searched in the
     *                                                     <code>ldapCertificateRevocationListAttributeName</code>.
     *                                                     E.g. the "o" or "ou" attribute may be
     *                                                     used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param deltaRevocationListIssuerAttributeName Attribute(s) in the issuer of the CRL which is
     *                                               used to be searched in the
     *                                               <code>ldapDeltaRevocationListAttributeName</code>.
     *                                               E.g. the
     *                                               "o" or "ou" attribute may be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    public Builder setDeltaRevocationListIssuerAttributeName(
        String deltaRevocationListIssuerAttributeName) {
    ...
    /**
     * @param authorityRevocationListIssuerAttributeName Attribute(s) in the issuer of the CRL which
     *                                                   is used to be searched in the
     *                                                   <code>ldapAuthorityRevocationListAttributeName</code>.
     *                                                   E.g.
    ...
    /**
     * @param attributeCertificateAttributeSubjectAttributeName Attribute(s) in the subject of the
     *                                                          attribute certificate which is used
     *                                                          to be searched in the
     *                                                          <code>ldapAttributeCertificateAttributeAttributeName</code>.
     *                                                          E.g. the "cn" attribute of the DN
     *                                                          could be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param aACertificateSubjectAttributeName Attribute(s) in the subject of the attribute
     *                                          certificate which is used to be searched in the
     *                                          <code>ldapAACertificateAttributeName</code>. E.g.
     *                                          the "ou"
     *                                          attribute of the DN could be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
    ...
    /**
     * @param attributeDescriptorCertificateSubjectAttributeName Attribute(s) in the subject of the
     *                                                           attribute certificate which is used
     *                                                           to be searched in the
     *                                                           <code>ldapAttributeDescriptorCertificateAttributeName</code>.
     *                                                           E.g. the "o" attribute of the DN
     *                                                           could be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param attributeCertificateRevocationListIssuerAttributeName Attribute(s) in the issuer of
     *                                                              the CRL which is used to be
     *                                                              searched in the
     *                                                              <code>ldapAttributeCertificateRevocationListAttributeName</code>.
     *                                                              E.g. the "o" or "ou" attribute
     *                                                              may be used certificate is
    ...
    /**
     * @param attributeAuthorityRevocationListIssuerAttributeName Anttribute(s) in the issuer of the
     *                                                            CRL which is used to be searched
     *                                                            in the
     *                                                            <code>ldapAttributeAuthorityRevocationListAttributeName</code>.
     *                                                            E.g. the "o" or "ou" attribute may
     *                                                            be used.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
    ...
    /**
     * @param searchForSerialNumberIn If not <code>null</code> the serial number of the certificate
     *                                is searched in this LDAP attribute.
     * @return the builder
     * @throws IllegalArgumentException if a necessary parameter is <code>null</code>.
     */
  ...
  public boolean equal(Object o) {
    ...
    return checkField(ldapURL, params.ldapURL)
        ...
        params.attributeCertificateAttributeAttribute)
        && checkField(aACertificateAttribute, params.aACertificateAttribute)
        && checkField(attributeDescriptorCertificateAttribute,
        params.attributeDescriptorCertificateAttribute)
        ...
        && checkField(ldapDeltaRevocationListAttributeName,
        params.ldapDeltaRevocationListAttributeName)
        && checkField(ldapAuthorityRevocationListAttributeName,
        params.ldapAuthorityRevocationListAttributeName)
        ...
        && checkField(userCertificateSubjectAttributeName,
        params.userCertificateSubjectAttributeName)
        && checkField(cACertificateSubjectAttributeName, params.cACertificateSubjectAttributeName)
        && checkField(crossCertificateSubjectAttributeName,
        params.crossCertificateSubjectAttributeName)
        && checkField(certificateRevocationListIssuerAttributeName,
        params.certificateRevocationListIssuerAttributeName)
        && checkField(deltaRevocationListIssuerAttributeName,
