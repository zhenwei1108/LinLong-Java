...
public class ElGamal {
  ...
  private static final String PREFIX =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".elgamal.";
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      provider.addAlgorithm("AlgorithmParameterGenerator.ELGAMAL",
      ...
      registerOidAlgorithmParameterGenerator(provider, OIWObjectIdentifiers.elGamalAlgorithm,
          "ELGAMAL");
    }
  }
}