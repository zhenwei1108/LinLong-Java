 ...
 *
 * @see com.github.zhenwei.provider.x509.ExtendedPKIXParameters
 */
public class PKIXAttrCertPathValidatorSpi
  ...
  public CertPathValidatorResult engineValidate(CertPath certPath,
    ...
    CertPathValidatorResult result = RFC3281CertPathUtilities.processAttrCert2(certPath,
        paramsPKIX);
    ...
    RFC3281CertPathUtilities.processAttrCert7(attrCert, certPath, holderCertPath, paramsPKIX,
        attrCertCheckers);
    RFC3281CertPathUtilities.additionalChecks(attrCert, prohibitedACAttrbiutes,
