 ...
 *
 * @deprecated use com.github.zhenwei.pkix.cert.X509AttributeCertificateHolder
 */
public class X509V2AttributeCertificate
  ...
  public AttributeCertificateHolder getHolder() {
    return new AttributeCertificateHolder(
        (ASN1Sequence) cert.getAcinfo().getHolder().toASN1Primitive());
  }
  ...
  public void checkValidity(
    ...
    if (date.before(this.getNotBefore())) {
      throw new CertificateNotYetValidException(
          "certificate not valid till " + this.getNotBefore());
    }
  }
  ...
  public final void verify(
    ...
    signature = Signature.getInstance(cert.getSignatureAlgorithm().getAlgorithm().getId(),
        provider);
