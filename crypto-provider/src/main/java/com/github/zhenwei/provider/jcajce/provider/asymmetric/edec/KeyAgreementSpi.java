...
import com.github.zhenwei.core.crypto.agreement.X25519Agreement;
import com.github.zhenwei.core.crypto.agreement.X448Agreement;
import com.github.zhenwei.core.crypto.agreement.XDHUnifiedAgreement;
...
public class KeyAgreementSpi
  ...
  protected Key engineDoPhase(Key key, boolean lastPhase)
    ...
    if (dhuSpec != null) {
      agreement.calculateAgreement(new XDHUPublicParameters(pub,
              ((BCXDHPublicKey) dhuSpec.getOtherPartyEphemeralKey()).engineGetKeyParameters()), result,
          0);
    } else {
