...
import com.github.zhenwei.provider.jcajce.provider.asymmetric.dsa.DSAUtil;
import com.github.zhenwei.provider.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
...
public class DSA {
  ...
  private static final String PREFIX =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".dsa.";
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("AlgorithmParameterGenerator.DSA",
