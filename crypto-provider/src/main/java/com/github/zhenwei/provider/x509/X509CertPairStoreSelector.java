...
/**
 * This class is an <code>Selector</code> like implementation to select certificates pairs, which
 * are e.g. used for cross certificates. The set of criteria is given from two {@link
 * com.github.zhenwei.provider.x509.X509CertStoreSelector}s which must be both matched.
 *
