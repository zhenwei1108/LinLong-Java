 ...
 *
 * @deprecated Do not use this class directly - either use com.github.zhenwei.pkix.cert (bcpkix) or
 * CertificateFactory.
 */
  ...
  public X509CRLObject(
    ...
    try {
      ...
      if (c.getSignatureAlgorithm().getParameters() != null) {
        this.sigAlgParams = ((ASN1Encodable) c.getSignatureAlgorithm()
            .getParameters()).toASN1Primitive().getEncoded(ASN1Encoding.DER);
      } else {
