...
public class BaseMac
  ...
  private static final Class gcmSpecClass = ClassUtil.loadClass(BaseMac.class,
  ...
  protected void engineInit(
    ...
    if (params instanceof AEADParameterSpec) {
      ...
      param = new SkeinParameters.Builder(
          copyMap(((SkeinParameterSpec) params).getParameters())).setKey(keyParam.getKey()).build();
    } else if (params == null) {
      param = new KeyParameter(key.getEncoded());
