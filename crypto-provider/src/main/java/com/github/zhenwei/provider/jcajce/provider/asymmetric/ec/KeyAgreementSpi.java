...
import com.github.zhenwei.core.crypto.agreement.ECDHCBasicAgreement;
import com.github.zhenwei.core.crypto.agreement.ECDHCUnifiedAgreement;
import com.github.zhenwei.core.crypto.agreement.ECMQVBasicAgreement;
import com.github.zhenwei.core.crypto.agreement.kdf.ConcatenationKDFGenerator;
...
import com.github.zhenwei.core.crypto.params.MQVPrivateParameters;
import com.github.zhenwei.core.crypto.params.MQVPublicParameters;
...
import com.github.zhenwei.provider.jcajce.spec.DHUParameterSpec;
...
import com.github.zhenwei.provider.jce.interfaces.MQVPrivateKey;
import com.github.zhenwei.provider.jce.interfaces.MQVPublicKey;
...
/**
 * Diffie-Hellman key agreement using elliptic curve keys, ala IEEE P1363 both the simple one, and
 * the simple one with cofactors are supported.
 * <p>
...
public class KeyAgreementSpi
  ...
  protected void engineInit(
    ...
    if (params != null &&
        !(params instanceof MQVParameterSpec || params instanceof UserKeyingMaterialSpec
            || params instanceof DHUParameterSpec)) {
    ...
    if (agreement instanceof ECMQVBasicAgreement) {
      ...
      if (!(agreement instanceof ECDHCUnifiedAgreement)) {
        throw new InvalidAlgorithmParameterException(
            kaAlgorithm + " key agreement cannot be used with "
      ...
      ECDHUPrivateParameters localParams = new ECDHUPrivateParameters(staticPrivKey, ephemPrivKey,
          ephemPubKey);
      this.parameters = staticPrivKey.getParameters();
  ...
  public static class DHwithSHA1KDF
    ...
    public DHwithSHA1KDF() {
      super("ECDHwithSHA1KDF", new ECDHBasicAgreement(),
  ...
  public static class DHwithSHA224KDFAndSharedInfo
    ...
    public DHwithSHA224KDFAndSharedInfo() {
      super("ECDHwithSHA224KDF", new ECDHBasicAgreement(),
  ...
  public static class DHwithSHA256KDFAndSharedInfo
    ...
    public DHwithSHA256KDFAndSharedInfo() {
      super("ECDHwithSHA256KDF", new ECDHBasicAgreement(),
  ...
  public static class DHwithSHA384KDFAndSharedInfo
    ...
    public DHwithSHA384KDFAndSharedInfo() {
      super("ECDHwithSHA384KDF", new ECDHBasicAgreement(),
  ...
  public static class DHwithSHA512KDFAndSharedInfo
    ...
    public DHwithSHA512KDFAndSharedInfo() {
      super("ECDHwithSHA512KDF", new ECDHBasicAgreement(),
  ...
  public static class MQVwithSHA1KDFAndSharedInfo
    ...
    public MQVwithSHA1KDFAndSharedInfo() {
      super("ECMQVwithSHA1KDF", new ECMQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA1()));
    }
  }
  ...
  public static class DHUwithSHA1CKDF
    ...
    public DHUwithSHA1CKDF() {
      super("ECCDHUwithSHA1CKDF", new ECDHCUnifiedAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA1()));
    }
  }
  ...
  public static class DHUwithSHA224CKDF
    ...
    public DHUwithSHA224CKDF() {
      super("ECCDHUwithSHA224CKDF", new ECDHCUnifiedAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA224()));
    }
  }
  ...
  public static class DHUwithSHA256CKDF
    ...
    public DHUwithSHA256CKDF() {
      super("ECCDHUwithSHA256CKDF", new ECDHCUnifiedAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA256()));
    }
  }
  ...
  public static class DHUwithSHA384CKDF
    ...
    public DHUwithSHA384CKDF() {
      super("ECCDHUwithSHA384CKDF", new ECDHCUnifiedAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA384()));
    }
  }
  ...
  public static class DHUwithSHA512CKDF
    ...
    public DHUwithSHA512CKDF() {
      super("ECCDHUwithSHA512CKDF", new ECDHCUnifiedAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA512()));
    }
  }
  ...
  public static class DHUwithSHA1KDF
    ...
    public DHUwithSHA1KDF() {
      super("ECCDHUwithSHA1KDF", new ECDHCUnifiedAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA1()));
    }
  }
  ...
  public static class DHUwithSHA224KDF
    ...
    public DHUwithSHA224KDF() {
      super("ECCDHUwithSHA224KDF", new ECDHCUnifiedAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA224()));
    }
  }
  ...
  public static class DHUwithSHA256KDF
    ...
    public DHUwithSHA256KDF() {
      super("ECCDHUwithSHA256KDF", new ECDHCUnifiedAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA256()));
    }
  }
  ...
  public static class DHUwithSHA384KDF
    ...
    public DHUwithSHA384KDF() {
      super("ECCDHUwithSHA384KDF", new ECDHCUnifiedAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA384()));
    }
  }
  ...
  public static class DHUwithSHA512KDF
    ...
    public DHUwithSHA512KDF() {
      super("ECCDHUwithSHA512KDF", new ECDHCUnifiedAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA512()));
    }
  }
