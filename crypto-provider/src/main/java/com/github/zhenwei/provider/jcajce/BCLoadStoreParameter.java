...
public class BCLoadStoreParameter
  ...
  BCLoadStoreParameter(InputStream in, OutputStream out,
  ...
  public OutputStream getOutputStream() {
    if (out == null) {
      throw new UnsupportedOperationException(
          "parameter not configured for storage - no OutputStream");
    }
  ...
  public InputStream getInputStream() {
    if (out != null) {
      throw new UnsupportedOperationException(
          "parameter configured for storage OutputStream present");
    }
