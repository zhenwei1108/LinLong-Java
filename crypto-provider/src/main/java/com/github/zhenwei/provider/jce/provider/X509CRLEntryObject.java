...
import com.github.zhenwei.core.asn1.x509.X509Extension;
...
public class X509CRLEntryObject extends X509CRLEntry {
  ...
  /**
   * Constructor for CRLEntries of indirect CRLs. If <code>isIndirect</code> is <code>false</code>
   * {@link #getCertificateIssuer()} will always return <code>null</code>,
   * <code>previousCertificateIssuer</code> is ignored. If this <code>isIndirect</code> is specified
   * and this CRLEntry has no certificate issuer CRL entry extension
  ...
  /**
   * Will return true if any extensions are present and marked as critical as we currently don't
            ...
            try {
              if (oid.equals(X509Extension.reasonCode)) {
                ...
                buf.append("Certificate issuer: ")
                    .append(GeneralNames.getInstance(dIn.readObject())).append(nl);
              } else {
