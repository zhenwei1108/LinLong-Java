...
import com.github.zhenwei.core.crypto.engines.ElGamalEngine;
...
import com.github.zhenwei.provider.jce.interfaces.ElGamalKey;
...
public class CipherSpi
  ...
  private void initFromSpec(
    ...
    cipher = new OAEPEncoding(new ElGamalEngine(), digest,
  ...
  protected void engineInit(
    ...
    if (params instanceof OAEPParameterSpec) {
      ...
      cipher = new OAEPEncoding(new ElGamalEngine(), digest, mgfDigest,
