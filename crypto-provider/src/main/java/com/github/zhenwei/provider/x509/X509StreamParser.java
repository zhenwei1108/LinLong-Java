...
import com.github.zhenwei.provider.x509.util.StreamParser;
 ...
 * <p>
 * A X509StreamParser is used to read a collection of objects or a single object of a certain X.509
 * object structure. E.g. one X509StreamParser can read certificates, another one CRLs,
 * certification paths, attribute certificates and so on. The kind of object structure is specified
 * with the
 * <code>algorithm</code> parameter to the <code>getInstance</code> methods.
 * <p>
 * Implementations must implement the {@link com.github.zhenwei.provider.x509.X509StreamParserSpi}.
 */
public class X509StreamParser
    implements StreamParser {

  /**
   * Generates a StreamParser object that implements the specified type. If the default provider
   * package provides an implementation of the requested type, an instance of StreamParser
   * containing that implementation is returned. If the type is not available in the default
   * package, other packages are searched.
   *
   * @param type The name of the requested X.509 object type.
   * @return a StreamParser object for the specified type.
   * @throws NoSuchParserException if the requested type is not available in the default provider
