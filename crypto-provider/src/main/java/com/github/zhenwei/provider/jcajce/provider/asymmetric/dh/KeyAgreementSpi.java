...
import com.github.zhenwei.core.crypto.agreement.DHUnifiedAgreement;
import com.github.zhenwei.core.crypto.agreement.MQVBasicAgreement;
...
/**
 * Diffie-Hellman key agreement. There's actually a better way of doing this if you are using long
 * term public keys, see the light-weight version for details.
 */
public class KeyAgreementSpi
  ...
  protected Key engineDoPhase(
    ...
    if (unifiedAgreement != null) {
      ...
      DHPublicKeyParameters ephemKey = generatePublicKeyParameter(
          dheParameters.getOtherPartyEphemeralKey());
      ...
      DHPublicKeyParameters staticKey = generatePublicKeyParameter((PublicKey) key);
      DHPublicKeyParameters ephemKey = generatePublicKeyParameter(
          mqvParameters.getOtherPartyEphemeralKey());
      ...
      if (pubKey instanceof BCDHPublicKey) {
        ...
        if (params instanceof DHDomainParameterSpec) {
          return new DHPublicKeyParameters(pub.getY(),
              ((DHDomainParameterSpec) params).getDomainParameters());
        }
        return new DHPublicKeyParameters(pub.getY(),
            new DHParameters(params.getP(), params.getG(), null, params.getL()));
      }
  ...
  public static class DHUwithSHA1KDF
    ...
    public DHUwithSHA1KDF() {
      super("DHUwithSHA1KDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA224KDF
    ...
    public DHUwithSHA224KDF() {
      super("DHUwithSHA224KDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA256KDF
    ...
    public DHUwithSHA256KDF() {
      super("DHUwithSHA256KDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA384KDF
    ...
    public DHUwithSHA384KDF() {
      super("DHUwithSHA384KDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA512KDF
    ...
    public DHUwithSHA512KDF() {
      super("DHUwithSHA512KDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA1CKDF
    ...
    public DHUwithSHA1CKDF() {
      super("DHUwithSHA1CKDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA224CKDF
    ...
    public DHUwithSHA224CKDF() {
      super("DHUwithSHA224CKDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA256CKDF
    ...
    public DHUwithSHA256CKDF() {
      super("DHUwithSHA256CKDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA384CKDF
    ...
    public DHUwithSHA384CKDF() {
      super("DHUwithSHA384CKDF", new DHUnifiedAgreement(),
  ...
  public static class DHUwithSHA512CKDF
    ...
    public DHUwithSHA512CKDF() {
      super("DHUwithSHA512CKDF", new DHUnifiedAgreement(),
  ...
  public static class MQVwithSHA1KDF
    ...
    public MQVwithSHA1KDF() {
      super("MQVwithSHA1KDF", new MQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA1()));
    }
  }
  ...
  public static class MQVwithSHA224KDF
    ...
    public MQVwithSHA224KDF() {
      super("MQVwithSHA224KDF", new MQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA224()));
    }
  }
  ...
  public static class MQVwithSHA256KDF
    ...
    public MQVwithSHA256KDF() {
      super("MQVwithSHA256KDF", new MQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA256()));
    }
  }
  ...
  public static class MQVwithSHA384KDF
    ...
    public MQVwithSHA384KDF() {
      super("MQVwithSHA384KDF", new MQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA384()));
    }
  }
  ...
  public static class MQVwithSHA512KDF
    ...
    public MQVwithSHA512KDF() {
      super("MQVwithSHA512KDF", new MQVBasicAgreement(),
          new KDF2BytesGenerator(DigestFactory.createSHA512()));
    }
  }
  ...
  public static class MQVwithSHA1CKDF
    ...
    public MQVwithSHA1CKDF() {
      super("MQVwithSHA1CKDF", new MQVBasicAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA1()));
    }
  }
  ...
  public static class MQVwithSHA224CKDF
    ...
    public MQVwithSHA224CKDF() {
      super("MQVwithSHA224CKDF", new MQVBasicAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA224()));
    }
  }
  ...
  public static class MQVwithSHA256CKDF
    ...
    public MQVwithSHA256CKDF() {
      super("MQVwithSHA256CKDF", new MQVBasicAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA256()));
    }
  }
  ...
  public static class MQVwithSHA384CKDF
    ...
    public MQVwithSHA384CKDF() {
      super("MQVwithSHA384CKDF", new MQVBasicAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA384()));
    }
  }
  ...
  public static class MQVwithSHA512CKDF
    ...
    public MQVwithSHA512CKDF() {
      super("MQVwithSHA512CKDF", new MQVBasicAgreement(),
          new ConcatenationKDFGenerator(DigestFactory.createSHA512()));
    }
  }
}