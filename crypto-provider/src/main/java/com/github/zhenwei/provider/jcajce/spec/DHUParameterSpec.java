...
public class DHUParameterSpec
   ...
   */
  public DHUParameterSpec(PublicKey ephemeralPublicKey, PrivateKey ephemeralPrivateKey,
  ...
  /**
   * Base constructor for a Diffie-Hellman unified model using a key pair without user keying
   * material.
   *
   * @param ephemeralKeyPair       our ephemeral public and private key.
   * @param otherPartyEphemeralKey the ephemeral public key sent by the other party.
