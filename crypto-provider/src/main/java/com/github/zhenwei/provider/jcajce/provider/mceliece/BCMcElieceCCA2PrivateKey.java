...
/**
 * This class implements a McEliece CCA2 private key and is usually instantiated by the {@link
...
//    }
  ...
  public byte[] getEncoded() {
    PrivateKeyInfo pki;
    try {
      McElieceCCA2PrivateKey privateKey = new McElieceCCA2PrivateKey(getN(), getK(), getField(),
          getGoppaPoly(), getP(), Utils.getDigAlgId(params.getDigest()));
