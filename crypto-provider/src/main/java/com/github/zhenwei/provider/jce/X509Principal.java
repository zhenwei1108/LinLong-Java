 ...
 * </p>
 *
 * @see com.github.zhenwei.provider.jce.PrincipalUtil
...
public class X509Principal
  ...
  /**
   * constructor from a table of attributes and a vector giving the specific ordering required for
   * encoding or conversion to a string.
   * <p>
   * it's is assumed the table contains OID/String pairs.
   */
  public X509Principal(
  ...
  /**
   * Takes an X509 dir name as a string of the format "C=AU,ST=Victoria", or some such, converting
   * it into an ordered set of name attributes. If reverse is false the dir name will be encoded in
   * the order of the (name, value) pairs presented, otherwise the encoding will start with the last
   * (name, value) pair and work back.
   */
  public X509Principal(
      boolean reverse,
      String dirName) {
