...
public class BCDSAPublicKey
  ...
  public byte[] getEncoded() {
    if (dsaSpec == null) {
      return KeyUtil.getEncodedSubjectPublicKeyInfo(
          new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(y));
    }
  ...
  public String toString() {
    ...
    buf.append("DSA Public Key [").append(DSAUtil.generateKeyFingerprint(y, getParams()))
        .append("]").append(nl);
  ...
  private void readObject(
    ...
    if (p.equals(ZERO)) {
      ...
      this.dsaSpec = new DSAParameterSpec(p, (BigInteger) in.readObject(),
