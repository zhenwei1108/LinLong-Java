...
import com.github.zhenwei.core.asn1.x509.X509ExtensionsGenerator;
...
import com.github.zhenwei.provider.jce.provider.X509CRLObject;
 ...
 *
 * @deprecated use com.github.zhenwei.pkix.cert.X509v2CRLBuilder.
 */
public class X509V2CRLGenerator {
  ...
  /**
   * Reason being as indicated by CRLReason, i.e. CRLReason.keyCompromise or 0 if CRLReason is not
   * to be used
   **/
  ...
  /**
   * Add a CRL entry with an Invalidity Date extension as well as a CRLReason extension. Reason
   * being as indicated by CRLReason, i.e. CRLReason.keyCompromise or 0 if CRLReason is not to be
   * used
   **/
  public void addCRLEntry(BigInteger userCertificate, Date revocationDate, int reason,
      Date invalidityDate) {
   ...
   **/
  public void addCRLEntry(BigInteger userCertificate, Date revocationDate,
  ...
  public X509CRL generateX509CRL(
    ...
    try {
      return generateX509CRL(key, "WeGoo", null);
  ...
  /**
   * generate an X509 CRL, based on the current issuer and subject using the default provider "BC"
   * and an user defined SecureRandom object as source of randomness.
   *
  ...
  public X509CRL generateX509CRL(
      ...
      throws SecurityException, SignatureException, InvalidKeyException {
    try {
      return generateX509CRL(key, "WeGoo", random);
    } catch (NoSuchProviderException e) {
      throw new SecurityException("BC provider not installed!");
    }
  }
  ...
  public X509CRL generate(
    ...
    try {
      signature = X509Util.calculateSignature(sigOID, signatureAlgorithm, provider, key, random,
          tbsCrl);
    } catch (IOException e) {
      throw new ExtCRLException("cannot generate CRL encoding", e);
    }
