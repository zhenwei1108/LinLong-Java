...
import com.github.zhenwei.core.asn1.x509.TBSCertificateStructure;
 ...
 * <p>
 * Use this in preference to trying to recreate a principal from a String, not all DNs are what they
 * should be, so it's best to leave them encoded where they can be.
 */
