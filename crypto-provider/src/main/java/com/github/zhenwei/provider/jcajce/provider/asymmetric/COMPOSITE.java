...
public class COMPOSITE {
  ...
  private static final String PREFIX = "com.github.zhenwei.provider.jcajce.provider.asymmetric.COMPOSITE";

  private static final Map<String, String> compositeAttributes = new HashMap<String, String>();

  static {
    compositeAttributes.put("SupportedKeyClasses",
        "com.github.zhenwei.provider.jcajce.CompositePublicKey|com.github.zhenwei.provider.jcajce.CompositePrivateKey");
  ...
  private static class CompositeKeyInfoConverter
    ...
    public PublicKey generatePublic(SubjectPublicKeyInfo keyInfo)
      ...
      for (int i = 0; i != keySeq.size(); i++) {
        ...
        pubKeys[i] = provider.getKeyInfoConverter((pubInfo.getAlgorithm().getAlgorithm()))
            .generatePublic(pubInfo);
      }
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("KeyFactory." + MiscObjectIdentifiers.id_alg_composite,
          PREFIX + "$KeyFactory");
      provider.addAlgorithm("KeyFactory.OID." + MiscObjectIdentifiers.id_alg_composite,
          PREFIX + "$KeyFactory");
