...
import com.github.zhenwei.core.crypto.engines.TwofishEngine;
...
public final class Twofish {
  ...
  public static class Poly1305
    ...
    public Poly1305() {
      super(new com.github.zhenwei.core.crypto.macs.Poly1305(new TwofishEngine()));
    }
  }
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("SecretKeyFactory.PBEWITHSHAANDTWOFISH-CBC",
          PREFIX + "$PBEWithSHAKeyFactory");
