...
import com.github.zhenwei.provider.jce.provider.X509CertificateObject;
...
/**
 * This class contains a cross certificate pair. Cross certificates pairs may contain two cross
 * signed certificates from two CAs. A certificate from the other CA to this CA is contained in the
 * forward certificate, the certificate from this CA to the other CA is contained in the reverse
 * certificate.
 */
