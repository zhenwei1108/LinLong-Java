...
public class BCDSTU4145PublicKey
  ...
  private void populateFromPubKeyInfo(SubjectPublicKeyInfo info) {
    ...
    if (seq.getObjectAt(0) instanceof ASN1Integer) {
      ...
      spec = new com.github.zhenwei.provider.jce.spec.ECParameterSpec(x9Params.getCurve(),
          x9Params.getG(), x9Params.getN(), x9Params.getH(), x9Params.getSeed());
    } else {
  ...
  public byte[] getEncoded() {
    ...
    if (dstuParams != null) {
      ...
      if (ecSpec instanceof ECNamedCurveSpec) {
        params = new DSTU4145Params(
            new ASN1ObjectIdentifier(((ECNamedCurveSpec) ecSpec).getName()));
    ...
    try {
      info = new SubjectPublicKeyInfo(
          new AlgorithmIdentifier(UAObjectIdentifiers.dstu4145be, params),
