...
public class GOST3410ParameterSpec
   ...
   * @param digestParamSet    the object identifier for the digest algorithm to be associated with
   *                          parameters.
   */
   ...
   */
  public GOST3410ParameterSpec(ASN1ObjectIdentifier publicKeyParamSet,
      ASN1ObjectIdentifier digestParamSet, ASN1ObjectIdentifier encryptionParamSet) {
