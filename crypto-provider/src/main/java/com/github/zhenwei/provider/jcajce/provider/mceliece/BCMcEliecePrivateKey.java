...
/**
 * This class implements a McEliece private key and is usually instantiated by the {@link
 * McElieceKeyPairGenerator} or {@link McElieceKeyFactorySpi}.
 */
...
//    }
  ...
  public byte[] getEncoded() {
    McEliecePrivateKey privateKey = new McEliecePrivateKey(params.getN(), params.getK(),
        params.getField(), params.getGoppaPoly(), params.getP1(), params.getP2(), params.getSInv());
    PrivateKeyInfo pki;
    try {
