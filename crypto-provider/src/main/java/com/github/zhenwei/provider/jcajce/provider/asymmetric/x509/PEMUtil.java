...
class PEMUtil {
  ...
  /**
   * Boundary class. Keeps track of the required header/footer pair for the current PEM object.
   */
  ...
  /**
   * Returns a {@link Boundaries} object representing the passed in boundary string.
   *
   * @param line the boundary string
   * @return the {@link Boundaries} object corresponding to the given boundary string or
   * <code>null</code> if the passed in string is not a valid
   * boundary.
   */
