...
import com.github.zhenwei.core.pqc.crypto.qtesla.QTESLASigner;
...
public class SignatureSpi
  ...
  static public class PI
    ...
    public PI() {
      super(QTESLASecurityCategory.getName(QTESLASecurityCategory.PROVABLY_SECURE_I),
          new NullDigest(), new QTESLASigner());
    }
  }
  ...
  static public class PIII
    ...
    public PIII() {
      super(QTESLASecurityCategory.getName(QTESLASecurityCategory.PROVABLY_SECURE_III),
          new NullDigest(), new QTESLASigner());
    }
  }
}