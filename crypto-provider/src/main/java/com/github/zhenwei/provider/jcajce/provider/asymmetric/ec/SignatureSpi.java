...
import com.github.zhenwei.core.crypto.signers.ECNRSigner;
import com.github.zhenwei.core.crypto.signers.HMacDSAKCalculator;
import com.github.zhenwei.core.crypto.signers.PlainDSAEncoding;
...
import com.github.zhenwei.provider.jcajce.provider.asymmetric.util.DSABase;
...
public class SignatureSpi
  ...
  static public class ecDetDSA
    ...
    public ecDetDSA() {
      super(DigestFactory.createSHA1(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA1())),
  ...
  static public class ecDetDSA224
    ...
    public ecDetDSA224() {
      super(DigestFactory.createSHA224(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA224())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSA256
    ...
    public ecDetDSA256() {
      super(DigestFactory.createSHA256(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA256())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSA384
    ...
    public ecDetDSA384() {
      super(DigestFactory.createSHA384(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA384())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSA512
    ...
    public ecDetDSA512() {
      super(DigestFactory.createSHA512(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA512())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSASha3_224
    ...
    public ecDetDSASha3_224() {
      super(DigestFactory.createSHA3_224(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA3_224())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSASha3_256
    ...
    public ecDetDSASha3_256() {
      super(DigestFactory.createSHA3_256(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA3_256())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSASha3_384
    ...
    public ecDetDSASha3_384() {
      super(DigestFactory.createSHA3_384(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA3_384())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDetDSASha3_512
    ...
    public ecDetDSASha3_512() {
      super(DigestFactory.createSHA3_512(),
          new ECDSASigner(new HMacDSAKCalculator(DigestFactory.createSHA3_512())),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDSAShake128
    ...
    public ecDSAShake128() {
      ...
      super(new SHAKEDigest(128), new ECDSASigner(new HMacDSAKCalculator(new SHAKEDigest(128))),
          StandardDSAEncoding.INSTANCE);
    }
  }
  ...
  static public class ecDSAShake256
    ...
    public ecDSAShake256() {
      // RFC 8702 specifies deterministic DSA
      super(new SHAKEDigest(256), new ECDSASigner(new HMacDSAKCalculator(new SHAKEDigest(256))),
          StandardDSAEncoding.INSTANCE);
    }
  }
