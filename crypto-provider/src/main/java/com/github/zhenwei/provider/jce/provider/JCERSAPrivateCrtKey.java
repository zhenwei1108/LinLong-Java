...
public class JCERSAPrivateCrtKey
  ...
  /**
   * construct a private key from it's com.github.zhenwei.core.crypto equivalent.
   *
  ...
  JCERSAPrivateCrtKey(
      PrivateKeyInfo info)
      throws IOException {
    this(com.github.zhenwei.core.asn1.pkcs.RSAPrivateKey.getInstance(info.parsePrivateKey()));
  }
  ...
  public byte[] getEncoded() {
    return KeyUtil.getEncodedPrivateKeyInfo(
        ...
        new RSAPrivateKey(getModulus(), getPublicExponent(), getPrivateExponent(), getPrimeP(),
