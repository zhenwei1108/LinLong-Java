 ...
 * <ul>
 * <li>MAC generation, by providing a {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setKey(byte[]) key}.</li>
 * <li>Randomised hashing, by providing a {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setNonce(byte[]) nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setPublicKey(byte[]) public key} with the message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setKeyIdentifier(byte[]) key identifier}.</li>
 * <li>Personalised hashing, by providing a
 * {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(Date, String, String) recommended format} or
 * {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(byte[]) arbitrary} personalisation string.</li>
 * </ul>
 *
 * @see com.github.zhenwei.core.crypto.digests.SkeinEngine
 * @see com.github.zhenwei.core.crypto.digests.SkeinDigest
 * @see com.github.zhenwei.core.crypto.macs.SkeinMac
 */
public class SkeinParameterSpec
  ...
  /**
   * A builder for {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec}.
   */
  public static class Builder {
    ...
    /**
     * Sets a parameters to apply to the Skein hash function.<br> Parameter types must be in the
     * range 0,5..62, and cannot use the value {@value com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
     * (reserved for message body).
     * <p>
     * Parameters with type &lt; {@value com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
     * are processed before the message content, parameters with type &gt; {@value
     * com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} are processed
     * after the message and prior to output.
     * </p>
     *
    ...
    public Builder set(int type, byte[] value) {
      ...
      if ((type != PARAM_TYPE_KEY)
          && (type <= PARAM_TYPE_CONFIG || type >= PARAM_TYPE_OUTPUT
    ...
    /**
     * Sets the {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY}
     * parameter.
     */
    ...
    /**
     * Sets the {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_PERSONALISATION}
     * parameter.
     */
    ...
    /**
     * Implements the recommended personalisation format for Skein defined in Section 4.11 of the
     * Skein 1.3 specification.
     * <p>
     * The format is <code>YYYYMMDD email@address distinguisher</code>, encoded to a byte sequence
    ...
    /**
     * Implements the recommended personalisation format for Skein defined in Section 4.11 of the
     * Skein 1.3 specification. You may need to use this method if the default locale doesn't use a
     * Gregorian calender so that the GeneralizedTime produced is compatible implementations.
     * <p>
     * The format is <code>YYYYMMDD email@address distinguisher</code>, encoded to a byte sequence
     * using UTF-8 encoding.
     *
     ...
     * @return the current builder instance.
     */
    public Builder setPersonalisation(Date date, Locale dateLocale, String emailAddress,
    ...
    /**
     * Sets the {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY_IDENTIFIER}
     * parameter.
     *
     * @return the current builder instance.
     */
    ...
    /**
     * Sets the {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_NONCE}
     * parameter.
     *
     * @return the current builder instance.
     */
    ...
    /**
     * Constructs a new {@link com.github.zhenwei.provider.jcajce.spec.SkeinParameterSpec} instance
     * with the parameters provided to this builder.
     */
