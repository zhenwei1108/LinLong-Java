...
public class XMSSKeyPairGeneratorSpi
  ...
  public KeyPair generateKeyPair() {
    ...
    return new KeyPair(new BCXMSSPublicKey(treeDigest, pub),
        new BCXMSSPrivateKey(treeDigest, priv));
  }
}