...
public class PKIXExtendedParameters
   ...
   * certificates were valid at the signing time. Both are indirectly chosen with the {@link
  ...
  public static class Builder {
    ...
    public Builder(PKIXExtendedParameters baseParameters) {
      ...
      this.namedCRLStoreMap = new HashMap<GeneralName, PKIXCRLStore>(
          baseParameters.namedCRLStoreMap);
     ...
     *
     * @param trustAnchors a set of trustAnchors, one of which a particular end-entity and it's
     *                     associated CRLs must be based on.
     * @return the current builder.
     */
  ...
  private PKIXExtendedParameters(Builder builder) {
    ...
    this.namedCertificateStoreMap = Collections.unmodifiableMap(
        new HashMap<GeneralName, PKIXCertStore>(builder.namedCertificateStoreMap));
    this.extraCRLStores = Collections.unmodifiableList(builder.extraCRLStores);
    this.namedCRLStoreMap = Collections.unmodifiableMap(
        new HashMap<GeneralName, PKIXCRLStore>(builder.namedCRLStoreMap));
  ...
  /**
   * Returns the time at which to check the validity of the certification path. If {@code null}, the
  ...
  /**
   * Returns the required constraints on the target certificate. The constraints are returned as an
   * instance of
