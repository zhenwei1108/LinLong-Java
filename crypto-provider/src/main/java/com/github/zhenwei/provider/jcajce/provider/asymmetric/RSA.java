...
import com.github.zhenwei.provider.jcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA {
  ...
  private static final String PREFIX =
      "com.github.zhenwei.provider.jcajce.provider.asymmetric" + ".rsa.";
  ...
  public static class Mappings
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm("Cipher", PKCSObjectIdentifiers.rsaEncryption,
          PREFIX + "CipherSpi$PKCS1v1_5Padding");
      provider.addAlgorithm("Cipher", X509ObjectIdentifiers.id_ea_rsa,
          PREFIX + "CipherSpi$PKCS1v1_5Padding");
      ...
      provider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_RSAES_OAEP,
          PREFIX + "CipherSpi$OAEPPadding");
      ...
      addPSSSignature(provider, "SHA512(224)", "MGF1",
          PREFIX + "PSSSignatureSpi$SHA512_224withRSA");
      addPSSSignature(provider, "SHA512(256)", "MGF1",
          PREFIX + "PSSSignatureSpi$SHA512_256withRSA");
      ...
      addPSSSignature(provider, "SHAKE128", PREFIX + "PSSSignatureSpi$SHAKE128WithRSAPSS",
          CMSObjectIdentifiers.id_RSASSA_PSS_SHAKE128);
      addPSSSignature(provider, "SHAKE256", PREFIX + "PSSSignatureSpi$SHAKE256WithRSAPSS",
          CMSObjectIdentifiers.id_RSASSA_PSS_SHAKE256);

      addPSSSignature(provider, "SHA224", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA224withRSAandSHAKE128");
      addPSSSignature(provider, "SHA256", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA256withRSAandSHAKE128");
      addPSSSignature(provider, "SHA384", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA384withRSAandSHAKE128");
      addPSSSignature(provider, "SHA512", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA512withRSAandSHAKE128");
      addPSSSignature(provider, "SHA512(224)", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA512_224withRSAandSHAKE128");
      addPSSSignature(provider, "SHA512(256)", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA512_256withRSAandSHAKE128");

      addPSSSignature(provider, "SHA224", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA224withRSAandSHAKE256");
      addPSSSignature(provider, "SHA256", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA256withRSAandSHAKE256");
      addPSSSignature(provider, "SHA384", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA384withRSAandSHAKE256");
      addPSSSignature(provider, "SHA512", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA512withRSAandSHAKE256");
      addPSSSignature(provider, "SHA512(224)", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA512_224withRSAandSHAKE256");
      addPSSSignature(provider, "SHA512(256)", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA512_256withRSAandSHAKE256");

      addPSSSignature(provider, "SHA3-224", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA3_224withRSAandSHAKE128");
      addPSSSignature(provider, "SHA3-256", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA3_256withRSAandSHAKE128");
      addPSSSignature(provider, "SHA3-384", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA3_384withRSAandSHAKE128");
      addPSSSignature(provider, "SHA3-512", "SHAKE128",
          PREFIX + "PSSSignatureSpi$SHA3_512withRSAandSHAKE128");

      addPSSSignature(provider, "SHA3-224", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA3_224withRSAandSHAKE256");
      addPSSSignature(provider, "SHA3-256", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA3_256withRSAandSHAKE256");
      addPSSSignature(provider, "SHA3-384", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA3_384withRSAandSHAKE256");
      addPSSSignature(provider, "SHA3-512", "SHAKE256",
          PREFIX + "PSSSignatureSpi$SHA3_512withRSAandSHAKE256");
      ...
      if (provider.hasAlgorithm("MessageDigest", "SHA1")) {
        ...
        addPSSSignature(provider, "SHA1", "SHAKE128",
            PREFIX + "PSSSignatureSpi$SHA1withRSAandSHAKE128");
        addPSSSignature(provider, "SHA1", "SHAKE256",
            PREFIX + "PSSSignatureSpi$SHA1withRSAandSHAKE256");
        ...
        provider.addAlgorithm("Alg.Alias.Signature." + OIWObjectIdentifiers.sha1WithRSA,
            "SHA1WITHRSA");
        provider.addAlgorithm("Alg.Alias.Signature.OID." + OIWObjectIdentifiers.sha1WithRSA,
            "SHA1WITHRSA");
      ...
      addISO9796Signature(provider, "SHA512(224)",
          PREFIX + "ISOSignatureSpi$SHA512_224WithRSAEncryption");
      addISO9796Signature(provider, "SHA512(256)",
          PREFIX + "ISOSignatureSpi$SHA512_256WithRSAEncryption");
      ...
      addX931Signature(provider, "SHA512(224)",
          PREFIX + "X931SignatureSpi$SHA512_224WithRSAEncryption");
      addX931Signature(provider, "SHA512(256)",
          PREFIX + "X931SignatureSpi$SHA512_256WithRSAEncryption");
      ...
      if (provider.hasAlgorithm("MessageDigest", "RIPEMD128")) {
        ...
        addX931Signature(provider, "RMD128",
            PREFIX + "X931SignatureSpi$RIPEMD128WithRSAEncryption");
        addX931Signature(provider, "RIPEMD128",
            PREFIX + "X931SignatureSpi$RIPEMD128WithRSAEncryption");
      }
      ...
      if (provider.hasAlgorithm("MessageDigest", "RIPEMD160")) {
        ...
        provider.addAlgorithm("Alg.Alias.Signature.RIPEMD160WithRSA/ISO9796-2",
        ...
        addX931Signature(provider, "RMD160",
            PREFIX + "X931SignatureSpi$RIPEMD160WithRSAEncryption");
        addX931Signature(provider, "RIPEMD160",
            PREFIX + "X931SignatureSpi$RIPEMD160WithRSAEncryption");
      }
      ...
      if (provider.hasAlgorithm("MessageDigest", "WHIRLPOOL")) {
        addISO9796Signature(provider, "Whirlpool",
            PREFIX + "ISOSignatureSpi$WhirlpoolWithRSAEncryption");
        addISO9796Signature(provider, "WHIRLPOOL",
            PREFIX + "ISOSignatureSpi$WhirlpoolWithRSAEncryption");
        addX931Signature(provider, "Whirlpool",
            PREFIX + "X931SignatureSpi$WhirlpoolWithRSAEncryption");
        addX931Signature(provider, "WHIRLPOOL",
            PREFIX + "X931SignatureSpi$WhirlpoolWithRSAEncryption");
      }
    }
    ...
    private void addISO9796Signature(
        ...
        String digest,
        String className) {
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "withRSA/ISO9796-2",
    ...
    private void addPSSSignature(
      ...
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "WithRSA/PSS", digest + "WITHRSAPSS");
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "withRSASSA-PSS",
          digest + "WITHRSAPSS");
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "WithRSASSA-PSS",
          digest + "WITHRSAPSS");
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "WITHRSASSA-PSS",
    ...
    private void addX931Signature(
        ...
        String digest,
        String className) {
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "withRSA/X9.31",
          digest + "WITHRSA/X9.31");
      provider.addAlgorithm("Alg.Alias.Signature." + digest + "WithRSA/X9.31",
          digest + "WITHRSA/X9.31");
