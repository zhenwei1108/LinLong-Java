 ...
 * the keystore.
 *
 * @deprecated This class does not support configuration on creation, use BCFKSLoadStoreParameter
 * for best results.
 */
public class BCFKSStoreParameter
  ...
  public BCFKSStoreParameter(OutputStream out, PBKDFConfig storeConfig,
